...
/* renamed from: io.bidmachine.AdResponse */
class AdResponse {
    ...
    /* renamed from: ad */
    private final C1611Ad f12774ad;
    ...
    public AdResponse(AdRequestParameters adRequestParameters2, List<NetworkAdUnit> list, Response response, Response.Seatbid seatbid, Response.Seatbid.Bid bid, C1611Ad ad, NetworkAdapter networkAdapter) {
        ...
        this.auctionResult = new AuctionResultImpl(adRequestParameters2.getAdsType(), seatbid, bid, ad, networkAdapter, findAdExtension);
    ...
    public synchronized void loadAdObject(ContextProvider contextProvider, AdRequest adRequest, BidMachineAd bidMachineAd, AdProcessCallback adProcessCallback) {
        ...
        if (!this.adCallbackComposite.isLoading.getAndSet(true)) {
            ...
            if (isExpired()) {
                ...
                try {
                    NetworkAdapter findNetworkAdapter = adRequest.getAdsType().findNetworkAdapter(this.f12774ad);
                    ...
                    AdObjectParams createAdObjectParams = adRequest.getAdsType().createAdObjectParams(this.f12774ad);
    ...
    public Value createBidCacheExtensionValue() {
        Struct.Builder putFields = Struct.newBuilder().putFields("price", Value.newBuilder().setNumberValue(this.auctionResult.getPrice()).build()).putFields("exp", Value.newBuilder().setNumberValue((double) calculateExpirationLeftMs()).build()).putFields("request_id", Value.newBuilder().setStringValue(this.responseId).build()).putFields("bid_id", Value.newBuilder().setStringValue(this.bidId).build());
    ...
    private AdExtension findAdExtension(C1611Ad ad) {
        ...
        while (i < extProtoCount) {
            try {
                ...
                if (extProto.mo4690is(AdExtension.class)) {
    ...
    /* renamed from: io.bidmachine.AdResponse$AdProcessCallbackComposite */
    ...
    /* renamed from: io.bidmachine.AdResponse$ExpiredRunnable */
