...
import p150io.bidmachine.protobuf.AdCachePlacementControl;

/* renamed from: io.bidmachine.AdResponseManager */
class AdResponseManager {
    ...
    public void store(p150io.bidmachine.AdResponse r15) {
        /*
            r14 = this;
        ...
        L_0x0007:
            ...
            p150io.bidmachine.core.Logger.log((java.lang.String) r0, (java.lang.String) r1)
        ...
        L_0x0029:
            ...
            io.bidmachine.AdResponse r8 = (p150io.bidmachine.AdResponse) r8     // Catch:{ all -> 0x00b3 }
        ...
        L_0x0040:
            ...
            io.bidmachine.AdResponseStatus r10 = p150io.bidmachine.AdResponseStatus.Idle     // Catch:{ all -> 0x00b3 }
        ...
        L_0x005a:
            io.bidmachine.AdResponseStatus r9 = r8.getStatus()     // Catch:{ all -> 0x00b3 }
            io.bidmachine.AdResponseStatus r10 = p150io.bidmachine.AdResponseStatus.Busy     // Catch:{ all -> 0x00b3 }
        ...
        L_0x0068:
            ...
            io.bidmachine.AdResponseStatus r8 = p150io.bidmachine.AdResponseStatus.Busy     // Catch:{ all -> 0x00b3 }
            if (r3 != r8) goto L_0x008c
            if (r6 == 0) goto L_0x008c
            int r3 = r14.getBusyLimitForAdsType(r1)     // Catch:{ all -> 0x00b3 }
            if (r4 < r3) goto L_0x008c
            io.bidmachine.AdResponseStatus r3 = p150io.bidmachine.AdResponseStatus.Idle     // Catch:{ all -> 0x00b3 }
        ...
        L_0x00b3:
            ...
            throw r15
        */
        throw new UnsupportedOperationException("Method not decompiled: p150io.bidmachine.AdResponseManager.store(io.bidmachine.AdResponse):void");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public p150io.bidmachine.AdResponse receive(p150io.bidmachine.AdRequestParameters r15) {
        /*
            r14 = this;
            java.lang.Object r0 = r14.lock
            monitor-enter(r0)
        ...
        L_0x0012:
            ...
            io.bidmachine.AdResponse r8 = (p150io.bidmachine.AdResponse) r8     // Catch:{ all -> 0x00a0 }
        ...
        L_0x002f:
            ...
            io.bidmachine.AdResponseStatus r10 = p150io.bidmachine.AdResponseStatus.Idle     // Catch:{ all -> 0x00a0 }
        ...
        L_0x0047:
            io.bidmachine.AdResponseStatus r9 = r8.getStatus()     // Catch:{ all -> 0x00a0 }
            io.bidmachine.AdResponseStatus r10 = p150io.bidmachine.AdResponseStatus.Busy     // Catch:{ all -> 0x00a0 }
        ...
        L_0x0054:
            ...
            io.bidmachine.AdResponseStatus r8 = p150io.bidmachine.AdResponseStatus.Idle     // Catch:{ all -> 0x00a0 }
        ...
        L_0x0071:
            ...
            io.bidmachine.AdResponseStatus r15 = p150io.bidmachine.AdResponseStatus.Busy     // Catch:{ all -> 0x00a0 }
            ...
            p150io.bidmachine.core.Logger.log((java.lang.String) r15, (java.lang.String) r1)     // Catch:{ all -> 0x00a0 }
        ...
        L_0x00a0:
            ...
            throw r15
        */
        throw new UnsupportedOperationException("Method not decompiled: p150io.bidmachine.AdResponseManager.receive(io.bidmachine.AdRequestParameters):io.bidmachine.AdResponse");
    }
