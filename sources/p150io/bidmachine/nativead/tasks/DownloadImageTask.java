...
/* renamed from: io.bidmachine.nativead.tasks.DownloadImageTask */
public class DownloadImageTask implements Runnable {
    ...
    /* renamed from: io.bidmachine.nativead.tasks.DownloadImageTask$OnCacheImageListener */
    ...
    /* renamed from: io.bidmachine.nativead.tasks.DownloadImageTask$Builder */
    ...
    private void downloadImage(android.content.Context r9, java.lang.String r10) {
        /*
            ...
            java.lang.String r4 = p150io.bidmachine.core.Utils.generateFileName(r10)
            r1.<init>(r3, r4)
        ...
        L_0x0046:
            ...
            java.io.InputStream r10 = p150io.bidmachine.nativead.tasks.ConnectionUtils.getInputStream(r10, r3)     // Catch:{ all -> 0x00ba }
        ...
        L_0x0065:
            ...
            p150io.bidmachine.core.Utils.flush(r3)
            p150io.bidmachine.core.Utils.close(r3)
            p150io.bidmachine.core.Utils.close(r10)
            return
        L_0x0080:
            ...
            goto L_0x00aa
        L_0x008d:
            int r9 = p150io.bidmachine.nativead.utils.ImageHelper.calculateReqWidth(r9)     // Catch:{ all -> 0x00b4 }
            boolean r1 = r8.checkAspectRatio     // Catch:{ all -> 0x00b4 }
            int r1 = p150io.bidmachine.nativead.utils.ImageHelper.calculateReqHeight(r9, r1)     // Catch:{ all -> 0x00b4 }
            int r9 = p150io.bidmachine.nativead.utils.ImageHelper.calculateInSamplesSize(r0, r9, r1)     // Catch:{ all -> 0x00b4 }
        ...
        L_0x00ba:
            ...
            r3 = r2
        L_0x00bc:
            p150io.bidmachine.core.Logger.log((java.lang.Throwable) r9)     // Catch:{ all -> 0x00cc }
            r8.sendFail()     // Catch:{ all -> 0x00cc }
            p150io.bidmachine.core.Utils.flush(r3)
            p150io.bidmachine.core.Utils.close(r3)
            p150io.bidmachine.core.Utils.close(r2)
        L_0x00cb:
            return
        L_0x00cc:
            r9 = move-exception
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: p150io.bidmachine.nativead.tasks.DownloadImageTask.downloadImage(android.content.Context, java.lang.String):void");
    }
