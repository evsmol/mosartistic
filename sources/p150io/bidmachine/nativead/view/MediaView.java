...
import p150io.bidmachine.nativead.NativeAdObject;
import p150io.bidmachine.nativead.NativeData;
import p150io.bidmachine.nativead.NativeInteractor;
import p150io.bidmachine.nativead.NativeMediaPrivateData;
import p150io.bidmachine.nativead.tasks.DownloadVastVideoTask;
import p150io.bidmachine.nativead.tasks.DownloadVideoTask;
import p150io.bidmachine.nativead.utils.ImageHelper;
import p150io.bidmachine.nativead.utils.NativeNetworkExecutor;
import p150io.bidmachine.nativead.view.VideoPlayerActivity;

/* renamed from: io.bidmachine.nativead.view.MediaView */
public class MediaView extends RelativeLayout implements MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener, TextureView.SurfaceTextureListener, VideoPlayerActivity.VideoPlayerActivityListener {
    ...
    static /* synthetic */ class C53358 {
        ...
        static {
            /*
                io.bidmachine.nativead.view.NativeState[] r0 = p150io.bidmachine.nativead.view.NativeState.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$io$bidmachine$nativead$view$NativeState = r0
                io.bidmachine.nativead.view.NativeState r1 = p150io.bidmachine.nativead.view.NativeState.Image     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$io$bidmachine$nativead$view$NativeState     // Catch:{ NoSuchFieldError -> 0x001d }
                io.bidmachine.nativead.view.NativeState r1 = p150io.bidmachine.nativead.view.NativeState.Loading     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = $SwitchMap$io$bidmachine$nativead$view$NativeState     // Catch:{ NoSuchFieldError -> 0x0028 }
                io.bidmachine.nativead.view.NativeState r1 = p150io.bidmachine.nativead.view.NativeState.Playing     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                int[] r0 = $SwitchMap$io$bidmachine$nativead$view$NativeState     // Catch:{ NoSuchFieldError -> 0x0033 }
                io.bidmachine.nativead.view.NativeState r1 = p150io.bidmachine.nativead.view.NativeState.Paused     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p150io.bidmachine.nativead.view.MediaView.C53358.<clinit>():void");
        }
    }
    ...
    public void updateViewState(NativeState nativeState) {
        ...
        int i = C53358.$SwitchMap$io$bidmachine$nativead$view$NativeState[nativeState.ordinal()];
        if (i == 1) {
        ...
        if (this.hasVideo) {
            ...
            timer.schedule(new TimerTask() {
                /* JADX WARNING: Code restructure failed: missing block: B:37:?, code lost:
                    p150io.bidmachine.core.Utils.onUiThread(new p150io.bidmachine.nativead.view.MediaView.C53297.C53334(r5));
                 */
                ...
                public void run() {
                    /*
                        r5 = this;
                        io.bidmachine.nativead.view.MediaView r0 = p150io.bidmachine.nativead.view.MediaView.this     // Catch:{ all -> 0x011e }
                        ...
                        p150io.bidmachine.core.Utils.onUiThread(r0)     // Catch:{ all -> 0x011e }
                        return
                    L_0x0011:
                        io.bidmachine.nativead.view.MediaView r0 = p150io.bidmachine.nativead.view.MediaView.this     // Catch:{ all -> 0x011e }
                        ...
                        goto L_0x0126
                    L_0x0023:
                        io.bidmachine.nativead.view.MediaView r0 = p150io.bidmachine.nativead.view.MediaView.this     // Catch:{ IllegalStateException -> 0x0115 }
                        ...
                        io.bidmachine.nativead.view.MediaView r0 = p150io.bidmachine.nativead.view.MediaView.this     // Catch:{ IllegalStateException -> 0x0115 }
                        io.bidmachine.nativead.view.MediaView r1 = p150io.bidmachine.nativead.view.MediaView.this     // Catch:{ IllegalStateException -> 0x0115 }
                    ...
                    L_0x0056:
                        ...
                        p150io.bidmachine.core.Logger.log((java.lang.String) r0)     // Catch:{ IllegalStateException -> 0x0115 }
                        io.bidmachine.nativead.view.MediaView r0 = p150io.bidmachine.nativead.view.MediaView.this     // Catch:{ IllegalStateException -> 0x0115 }
                    ...
                    L_0x0102:
                        io.bidmachine.nativead.view.MediaView r0 = p150io.bidmachine.nativead.view.MediaView.this     // Catch:{ IllegalStateException -> 0x0115 }
                        p150io.bidmachine.nativead.view.MediaView.access$1608(r0)     // Catch:{ IllegalStateException -> 0x0115 }
                    L_0x0107:
                        ...
                        p150io.bidmachine.core.Utils.onUiThread(r0)     // Catch:{ IllegalStateException -> 0x0115 }
                        goto L_0x0126
                    L_0x0115:
                    ...
                    L_0x011e:
                        ...
                        r0.<init>()
                        p150io.bidmachine.core.Utils.onUiThread(r0)
                    L_0x0126:
                        return
                    */
                    throw new UnsupportedOperationException("Method not decompiled: p150io.bidmachine.nativead.view.MediaView.C53297.run():void");
                }
            }, 0, (long) 500);
        }
    }
