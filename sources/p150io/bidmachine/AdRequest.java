...
import p150io.bidmachine.AdResponseLoader;
...
import p150io.bidmachine.models.RequestParams;
import p150io.bidmachine.protobuf.RequestExtension;
...
/* renamed from: io.bidmachine.AdRequest */
public abstract class AdRequest<SelfType extends AdRequest, AdRequestParametersType extends AdRequestParameters, UnifiedAdRequestParamsType extends UnifiedAdRequestParams> {
    ...
    /* renamed from: id */
    private final String f12773id = UUID.randomUUID().toString();
    ...
    /* access modifiers changed from: private */
    public final TrackingObject trackingObject = new SimpleTrackingObject(this.f12773id) {
    ...
    /* renamed from: io.bidmachine.AdRequest$AdRequestListener */
    ...
    /* renamed from: io.bidmachine.AdRequest$InternalAdRequestListener */
    ...
    protected AdRequest(AdRequestParametersType adrequestparameterstype) {
        ...
        this.adResponseLoader = new AdResponseLoader(this.f12773id);
    ...
    public void notifyMediationLoss(String str, Double d) {
        BMError bMError;
        if (isCompleted()) {
            log(String.format("notifyMediationLoss (winnerNetworkName - %s, winnerNetworkPrice - %s)", new Object[]{str, d}));
            if (isDestroyed()) {
                bMError = BMError.RequestDestroyed;
            } else {
                bMError = isExpired() ? BMError.RequestExpired : null;
            ...
            if (d != null) {
                hashMap.put(Constants.URL_MACROS_AUCTION_PRICE, d);
            }
    ...
    public int obtainTimeOutMs() {
        /*
            r3 = this;
            io.bidmachine.BidMachineImpl r0 = p150io.bidmachine.BidMachineImpl.get()
        ...
        L_0x001c:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p150io.bidmachine.AdRequest.obtainTimeOutMs():int");
    }
    ...
    /* renamed from: io.bidmachine.AdRequest$AdRequestBuilderImpl */
