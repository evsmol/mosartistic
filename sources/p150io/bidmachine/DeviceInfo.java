...
/* renamed from: io.bidmachine.DeviceInfo */
public class DeviceInfo {
    ...
    public final String osName = OS_NAME;
    ...
    public Long getTotalDiskSpaceInMB() {
        ...
        try {
            ...
            Long valueOf = Long.valueOf((blockSize * blockCount) / C8850d.f22423fc);
    ...
    public Long getAvailableDiskSpaceInMB() {
        ...
        try {
            ...
            return Long.valueOf((blockSize * availableBlocks) / C8850d.f22423fc);
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    private java.lang.String getKernelVersionThroughUName() {
        ...
        L_0x005a:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p150io.bidmachine.DeviceInfo.getKernelVersionThroughUName():java.lang.String");
    }
}
