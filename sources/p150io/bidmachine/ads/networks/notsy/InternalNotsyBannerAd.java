...
/* renamed from: io.bidmachine.ads.networks.notsy.InternalNotsyBannerAd */
class InternalNotsyBannerAd extends InternalNotsyAd {
    ...
    public void loadAd(Context context, InternalLoadListener internalLoadListener) throws Throwable {
        ...
        this.adView.setAdListener(new Listener(this, internalLoadListener, (C52531) null));
        int i = C52531.$SwitchMap$io$bidmachine$AdsFormat[getAdsFormat().ordinal()];
        if (i == 1) {
    ...
    /* renamed from: io.bidmachine.ads.networks.notsy.InternalNotsyBannerAd$1 */
    static /* synthetic */ class C52531 {
        ...
        static {
            /*
                ...
                io.bidmachine.AdsFormat r1 = p150io.bidmachine.AdsFormat.Banner_300x250     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$io$bidmachine$AdsFormat     // Catch:{ NoSuchFieldError -> 0x001d }
                io.bidmachine.AdsFormat r1 = p150io.bidmachine.AdsFormat.Banner_728x90     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p150io.bidmachine.ads.networks.notsy.InternalNotsyBannerAd.C52531.<clinit>():void");
        }
    }
    ...
    /* renamed from: io.bidmachine.ads.networks.notsy.InternalNotsyBannerAd$Listener */
    private static final class Listener extends AdListener {
        ...
        /* synthetic */ Listener(InternalNotsyAd internalNotsyAd2, InternalLoadListener internalLoadListener, C52531 r3) {
