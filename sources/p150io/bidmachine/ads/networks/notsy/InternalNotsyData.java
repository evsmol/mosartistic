...
/* renamed from: io.bidmachine.ads.networks.notsy.InternalNotsyData */
class InternalNotsyData {
    private final String adUnitId;
    private final float price;
    private final float score;

    InternalNotsyData(String str, float f, float f2) {
        this.adUnitId = str;
        this.score = f;
        this.price = f2;
    }
    ...
    /* renamed from: io.bidmachine.ads.networks.notsy.InternalNotsyData$Factory */
