...
/* renamed from: io.bidmachine.ads.networks.criteo.CriteoAdUnitStorage */
class CriteoAdUnitStorage {
            ...
            if (!(adsFormat == null || (list = (List) next.getValue()) == null)) {
                for (Map map : list) {
                    ...
                    if (!TextUtils.isEmpty(str)) {
                        switch (C52301.$SwitchMap$io$bidmachine$AdsFormat[adsFormat.ordinal()]) {
                            case 1:
                            case 2:
                                obj = new BannerAdUnit(str, new AdSize(320, 50));
                                break;
                            case 3:
                                obj = new BannerAdUnit(str, new AdSize(C5643c.COLLECT_MODE_FINANCE, IronSourceConstants.INTERSTITIAL_DAILY_CAPPED));
                                break;
                            case 4:
    ...
    /* renamed from: io.bidmachine.ads.networks.criteo.CriteoAdUnitStorage$1 */
    static /* synthetic */ class C52301 {
        ...
        static {
            ...
            L_0x001d:
                ...
                io.bidmachine.AdsFormat r1 = p150io.bidmachine.AdsFormat.Banner_300x250     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                int[] r0 = $SwitchMap$io$bidmachine$AdsFormat     // Catch:{ NoSuchFieldError -> 0x0033 }
                io.bidmachine.AdsFormat r1 = p150io.bidmachine.AdsFormat.Banner_728x90     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p150io.bidmachine.ads.networks.criteo.CriteoAdUnitStorage.C52301.<clinit>():void");
        }
    }
