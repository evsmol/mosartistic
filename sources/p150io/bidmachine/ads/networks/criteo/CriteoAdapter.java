...
/* renamed from: io.bidmachine.ads.networks.criteo.CriteoAdapter */
class CriteoAdapter extends HeaderBiddingAdapter {
    static final /* synthetic */ boolean $assertionsDisabled = false;

    CriteoAdapter() {
        super(BuildConfig.ADAPTER_NAME, BuildConfig.ADAPTER_SDK_VERSION_NAME, BuildConfig.ADAPTER_VERSION_NAME, 16, new AdsType[]{AdsType.Banner, AdsType.Interstitial});
    }
    ...
    /* renamed from: io.bidmachine.ads.networks.criteo.CriteoAdapter$1 */
    static /* synthetic */ class C52311 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p150io.bidmachine.ads.networks.criteo.CriteoAdapter.C52311.<clinit>():void");
        }
    }

    static BMError mapError(CriteoErrorCode criteoErrorCode) {
        int i = C52311.$SwitchMap$com$criteo$publisher$CriteoErrorCode[criteoErrorCode.ordinal()];
        if (i == 1) {
