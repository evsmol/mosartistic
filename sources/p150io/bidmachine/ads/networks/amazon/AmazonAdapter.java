...
import p150io.bidmachine.banner.BannerAdRequestParameters;
...
/* renamed from: io.bidmachine.ads.networks.amazon.AmazonAdapter */
class AmazonAdapter extends HeaderBiddingAdapter {
    ...
    /* renamed from: io.bidmachine.ads.networks.amazon.AmazonAdapter$AmazonLoader */
    private static abstract class AmazonLoader {
        ...
        /* synthetic */ AmazonLoader(HeaderBiddingCollectParamsCallback headerBiddingCollectParamsCallback, C52191 r2) {
    ...
    /* renamed from: io.bidmachine.ads.networks.amazon.AmazonAdapter$1 */
    static /* synthetic */ class C52191 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p150io.bidmachine.ads.networks.amazon.AmazonAdapter.C52191.<clinit>():void");
        }
    }

    /* access modifiers changed from: private */
    public static BMError mapError(AdError adError) {
        int i = C52191.$SwitchMap$com$amazon$device$ads$AdError$ErrorCode[adError.getCode().ordinal()];
        if (i == 1) {
