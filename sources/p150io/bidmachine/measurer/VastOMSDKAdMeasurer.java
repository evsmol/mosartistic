package p150io.bidmachine.measurer;
...
/* renamed from: io.bidmachine.measurer.VastOMSDKAdMeasurer */
public class VastOMSDKAdMeasurer extends OMSDKAdMeasurer<View> implements VastAdMeasurer, VastPlaybackListener {
    ...
    public void onVideoStarted(final float f, final float f2) {
        Utils.onUiThread(new Runnable() {
            public void run() {
                try {
                    if (VastOMSDKAdMeasurer.this.mediaEvents != null) {
                        VastOMSDKAdMeasurer.this.mediaEvents.start(f, f2);
                    }
    ...
    public void onVideoVolumeChanged(final float f) {
        Utils.onUiThread(new Runnable() {
            public void run() {
                try {
                    if (VastOMSDKAdMeasurer.this.mediaEvents != null) {
                        VastOMSDKAdMeasurer.this.mediaEvents.volumeChange(f);
                    }
