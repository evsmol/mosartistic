...
/* renamed from: io.bidmachine.BidMachineFetcher */
public class BidMachineFetcher {
    ...
    static /* synthetic */ class C51872 {
        ...
        static {
            /*
                io.bidmachine.CreativeFormat[] r0 = p150io.bidmachine.CreativeFormat.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$io$bidmachine$CreativeFormat = r0
                io.bidmachine.CreativeFormat r1 = p150io.bidmachine.CreativeFormat.Banner     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$io$bidmachine$CreativeFormat     // Catch:{ NoSuchFieldError -> 0x001d }
                io.bidmachine.CreativeFormat r1 = p150io.bidmachine.CreativeFormat.Video     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = $SwitchMap$io$bidmachine$CreativeFormat     // Catch:{ NoSuchFieldError -> 0x0028 }
                io.bidmachine.CreativeFormat r1 = p150io.bidmachine.CreativeFormat.Native     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p150io.bidmachine.BidMachineFetcher.C51872.<clinit>():void");
        }
    }
    ...
    static String identifyAdType(CreativeFormat creativeFormat) {
        ...
        int i = C51872.$SwitchMap$io$bidmachine$CreativeFormat[creativeFormat.ordinal()];
        if (i == 1) {
