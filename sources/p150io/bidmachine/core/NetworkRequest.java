...
/* renamed from: io.bidmachine.core.NetworkRequest */
public abstract class NetworkRequest<RequestDataType, RequestResultType, ErrorResultType> {
    ...
    /* renamed from: io.bidmachine.core.NetworkRequest$Callback */
    ...
    /* renamed from: io.bidmachine.core.NetworkRequest$CancelCallback */
    public interface CancelCallback {
        void onCanceled();
    }

    /* renamed from: io.bidmachine.core.NetworkRequest$RequestDataBinder */
    ...
    /* renamed from: io.bidmachine.core.NetworkRequest$RequestDataEncoder */
    ...
    /* renamed from: io.bidmachine.core.NetworkRequest$State */
    public enum State {
        Idle,
        Running,
        Success,
    ...
    /* renamed from: io.bidmachine.core.NetworkRequest$Method */
    public enum Method {
        Get("GET"),
        Post("POST");
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:94:0x013c, code lost:
        r0 = p150io.bidmachine.core.NetworkRequest.State.Fail;
     */
    ...
    public void process() {
        /*
            r9 = this;
            io.bidmachine.core.NetworkRequest$State r0 = p150io.bidmachine.core.NetworkRequest.State.Running
            r9.currentState = r0
            r0 = 0
        ...
        L_0x002d:
            ...
            p150io.bidmachine.core.Utils.flush(r2)     // Catch:{ all -> 0x0114 }
            p150io.bidmachine.core.Utils.close(r2)     // Catch:{ all -> 0x0114 }
            goto L_0x0066
        L_0x005b:
            r3 = move-exception
            goto L_0x005f
        ...
        L_0x0066:
            ...
            p150io.bidmachine.core.Utils.flush(r0)     // Catch:{ all -> 0x0114 }
            p150io.bidmachine.core.Utils.close(r0)     // Catch:{ all -> 0x0114 }
            p150io.bidmachine.core.Utils.close(r0)     // Catch:{ all -> 0x0114 }
        ...
        L_0x0082:
            ...
            io.bidmachine.core.NetworkRequest$State r0 = p150io.bidmachine.core.NetworkRequest.State.Success
            goto L_0x0093
        L_0x0091:
            io.bidmachine.core.NetworkRequest$State r0 = p150io.bidmachine.core.NetworkRequest.State.Fail
        L_0x0093:
            r9.currentState = r0
        L_0x0095:
            return
        ...
        L_0x00e0:
            p150io.bidmachine.core.Utils.flush(r4)     // Catch:{ all -> 0x0114 }
            p150io.bidmachine.core.Utils.close(r4)     // Catch:{ all -> 0x0114 }
            p150io.bidmachine.core.Utils.close(r2)     // Catch:{ all -> 0x0114 }
            boolean r2 = r1 instanceof java.net.HttpURLConnection
        ...
        L_0x010a:
            p150io.bidmachine.core.Utils.flush(r4)     // Catch:{ all -> 0x0114 }
            p150io.bidmachine.core.Utils.close(r4)     // Catch:{ all -> 0x0114 }
            p150io.bidmachine.core.Utils.close(r3)     // Catch:{ all -> 0x0114 }
        ...
        L_0x0119:
            ...
            r2 = r0
        L_0x011b:
            p150io.bidmachine.core.Logger.log((java.lang.Throwable) r1)     // Catch:{ all -> 0x0141 }
        ...
        L_0x015e:
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p150io.bidmachine.core.NetworkRequest.process():void");
    }
    ...
    /* renamed from: io.bidmachine.core.NetworkRequest$ProtobufDataBinder */
    ...
    /* renamed from: io.bidmachine.core.NetworkRequest$JsonDataBinder */
    ...
    /* renamed from: io.bidmachine.core.NetworkRequest$SimpleJsonObjectDataBinder */
    ...
    /* renamed from: io.bidmachine.core.NetworkRequest$SimpleJsonArrayDataBinder */
    ...
    /* renamed from: io.bidmachine.core.NetworkRequest$Base64RequestDataEncoder */
    ...
    /* renamed from: io.bidmachine.core.NetworkRequest$GZIPRequestDataEncoder */
    ...
    /* renamed from: io.bidmachine.core.NetworkRequest$NetworkRequestRunner */
