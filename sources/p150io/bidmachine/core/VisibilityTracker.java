...
/* renamed from: io.bidmachine.core.VisibilityTracker */
public class VisibilityTracker {
    private static final int NO_TRACK = -1;
    /* access modifiers changed from: private */
    public static final ArrayList<TrackingHolder> holders = new ArrayList<>();

    /* renamed from: io.bidmachine.core.VisibilityTracker$VisibilityChangeCallback */
    ...
    /* renamed from: io.bidmachine.core.VisibilityTracker$TrackingHolder */
    private static class TrackingHolder {
        ...
        TrackingHolder(View view, long j, float f, boolean z, VisibilityChangeCallback visibilityChangeCallback) {
        ...
        public boolean isOnTop(View view, float f, boolean z) {
            ...
            try {
                ...
                if (!viewGroup.getGlobalVisibleRect(rect)) {
                    ...
                    if (width2 < f) {
                        Logger.log(String.format("Show wasn't tracked: ad view not completely visible (%s / %s) - %s", new Object[]{Float.valueOf(width2), Float.valueOf(f), viewGroup}));
                        return false;
                    }
                        ...
                        for (int indexOfChild = viewGroup3.indexOfChild(viewGroup) + 1; indexOfChild < viewGroup3.getChildCount(); indexOfChild++) {
                            ...
                            if (childAt.getVisibility() == 0) {
                                ...
                                if (Rect.intersects(rect, viewRectangle)) {
                                    ...
                                    Logger.log(String.format("Show wasn't tracked: ad view is overlapped by another visible view (%s), visible percent: %s / %s", new Object[]{childAt, Float.valueOf(viewNotOverlappedAreaPercent), Float.valueOf(f)}));
    ...
    public static void startTracking(View view, long j, float f, boolean z, VisibilityChangeCallback visibilityChangeCallback) {
        synchronized (holders) {
            stopTracking(view);
            TrackingHolder trackingHolder = new TrackingHolder(view, j, f, z, visibilityChangeCallback);
