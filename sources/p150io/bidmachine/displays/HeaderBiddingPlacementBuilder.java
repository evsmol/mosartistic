...
import p150io.bidmachine.BidMachineEvents;
...
import p150io.bidmachine.NetworkRegistry;
import p150io.bidmachine.ProtoExtConstants;
import p150io.bidmachine.SimpleTrackingObject;
import p150io.bidmachine.TrackEventInfo;
import p150io.bidmachine.TrackEventType;
import p150io.bidmachine.TrackingObject;
...
/* renamed from: io.bidmachine.displays.HeaderBiddingPlacementBuilder */
class HeaderBiddingPlacementBuilder<UnifiedAdRequestParamsType extends UnifiedAdRequestParams> {
    ...
    private HeaderBiddingAd obtainHeaderBiddingAd(List<Any> list) {
        for (Any next : list) {
            if (next.mo4690is(HeaderBiddingAd.class)) {
                try {
    ...
    /* renamed from: io.bidmachine.displays.HeaderBiddingPlacementBuilder$AdUnitPreloadTask */
