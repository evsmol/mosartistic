...
/* renamed from: io.bidmachine.protobuf.InitProto */
public final class InitProto {
    ...
    /* renamed from: internal_static_bidmachine_protobuf_AdCachePlacementControl_descriptor */
    static final Descriptors.Descriptor f12878x961f92e5;

    /* renamed from: internal_static_bidmachine_protobuf_AdCachePlacementControl_fieldAccessorTable */
    static final GeneratedMessageV3.FieldAccessorTable f12879xd3140463;

    /* renamed from: internal_static_bidmachine_protobuf_AdNetwork_AdUnit_CustomParamsEntry_descriptor */
    static final Descriptors.Descriptor f12880xb5890629;

    /* renamed from: internal_static_bidmachine_protobuf_AdNetwork_AdUnit_CustomParamsEntry_fieldAccessorTable */
    static final GeneratedMessageV3.FieldAccessorTable f12881x9987f3a7;
    ...
    static final GeneratedMessageV3.FieldAccessorTable f12882xdeef64a3;

    /* renamed from: internal_static_bidmachine_protobuf_AdNetwork_CustomParamsEntry_descriptor */
    static final Descriptors.Descriptor f12883x7f725455;

    /* renamed from: internal_static_bidmachine_protobuf_AdNetwork_CustomParamsEntry_fieldAccessorTable */
    static final GeneratedMessageV3.FieldAccessorTable f12884xc00655d3;
    ...
    static final GeneratedMessageV3.FieldAccessorTable f12885x8589c2fb;

    /* renamed from: internal_static_bidmachine_protobuf_InitResponse_AdCachePlacementControlEntry_descriptor */
    static final Descriptors.Descriptor f12886x388e9533;

    /* renamed from: internal_static_bidmachine_protobuf_InitResponse_AdCachePlacementControlEntry_fieldAccessorTable */
    static final GeneratedMessageV3.FieldAccessorTable f12887x4c3ad8b1;
    ...
    static final GeneratedMessageV3.FieldAccessorTable f12888xc91df30d;

    /* renamed from: internal_static_bidmachine_protobuf_SdkAnalyticConfig_MetricConfig_descriptor */
    static final Descriptors.Descriptor f12889x47f70d78;

    /* renamed from: internal_static_bidmachine_protobuf_SdkAnalyticConfig_MetricConfig_fieldAccessorTable */
    static final GeneratedMessageV3.FieldAccessorTable f12890x7e1d3bf6;
    static final Descriptors.Descriptor internal_static_bidmachine_protobuf_SdkAnalyticConfig_descriptor;

    /* renamed from: internal_static_bidmachine_protobuf_SdkAnalyticConfig_fieldAccessorTable */
    static final GeneratedMessageV3.FieldAccessorTable f12891x2841491;

    /* renamed from: internal_static_bidmachine_protobuf_SdkAnalyticContext_descriptor */
    static final Descriptors.Descriptor f12892xbfd0a858;

    /* renamed from: internal_static_bidmachine_protobuf_SdkAnalyticContext_fieldAccessorTable */
    static final GeneratedMessageV3.FieldAccessorTable f12893xf39df6d6;
    ...
    static {
        ...
        f12885x8589c2fb = new GeneratedMessageV3.FieldAccessorTable(descriptor2, new String[]{"SellerId", "Bundle", "Os", "Osv", "Geo", "Sdk", "Sdkver", "Ifa", "Ifv", "BmIfv", "DeviceType", "Contype", "AppVer", "SessionId", "Ext"});
        ...
        f12883x7f725455 = descriptor4;
        f12884xc00655d3 = new GeneratedMessageV3.FieldAccessorTable(descriptor4, new String[]{"Key", "Value"});
        ...
        f12882xdeef64a3 = new GeneratedMessageV3.FieldAccessorTable(descriptor5, new String[]{"AdFormat", "CustomParams"});
        Descriptors.Descriptor descriptor6 = internal_static_bidmachine_protobuf_AdNetwork_AdUnit_descriptor.getNestedTypes().get(0);
        f12880xb5890629 = descriptor6;
        f12881x9987f3a7 = new GeneratedMessageV3.FieldAccessorTable(descriptor6, new String[]{"Key", "Value"});
        Descriptors.Descriptor descriptor7 = getDescriptor().getMessageTypes().get(2);
        f12878x961f92e5 = descriptor7;
        f12879xd3140463 = new GeneratedMessageV3.FieldAccessorTable(descriptor7, new String[]{"MaxCacheSize", "MaxRetainCount", "MaxAge"});
        ...
        f12891x2841491 = new GeneratedMessageV3.FieldAccessorTable(descriptor8, new String[]{"Url", "Context", "Interval", "Count", "MetricConfigs"});
        Descriptors.Descriptor descriptor9 = internal_static_bidmachine_protobuf_SdkAnalyticConfig_descriptor.getNestedTypes().get(0);
        f12889x47f70d78 = descriptor9;
        f12890x7e1d3bf6 = new GeneratedMessageV3.FieldAccessorTable(descriptor9, new String[]{"Name", "Dimensions", "Metrics"});
        ...
        f12888xc91df30d = new GeneratedMessageV3.FieldAccessorTable(descriptor10, new String[]{"Endpoint", "Event", "SessionResetAfter", "AdNetworks", "AdNetworksLoadingTimeout", "AdCacheControl", "AdCacheMaxAge", "AdCachePlacementControl", "AdRequestTmax", "SdkAnalyticConfig"});
        Descriptors.Descriptor descriptor11 = internal_static_bidmachine_protobuf_InitResponse_descriptor.getNestedTypes().get(0);
        f12886x388e9533 = descriptor11;
        f12887x4c3ad8b1 = new GeneratedMessageV3.FieldAccessorTable(descriptor11, new String[]{"Key", "Value"});
        Descriptors.Descriptor descriptor12 = getDescriptor().getMessageTypes().get(5);
        f12892xbfd0a858 = descriptor12;
        f12893xf39df6d6 = new GeneratedMessageV3.FieldAccessorTable(descriptor12, new String[]{"SellerId", "Bundle", "Os", "Osv", "Geo", "Sdk", "Sdkver", "Ifa", "Ifv", "BmIfv", "DeviceType", "Contype", "AppVer", "SessionId", "Dcid", "Ext"});
