...
/* renamed from: io.bidmachine.protobuf.ExtensionsProto */
public final class ExtensionsProto {
    ...
    static final GeneratedMessageV3.FieldAccessorTable f12871x1b41ebde;
    ...
    static final GeneratedMessageV3.FieldAccessorTable f12872xf3936840;
    ...
    static final GeneratedMessageV3.FieldAccessorTable f12873x1b553c91;
    ...
    static final GeneratedMessageV3.FieldAccessorTable f12877x533b76ae;
    ...
    static {
        ...
        f12877x533b76ae = new GeneratedMessageV3.FieldAccessorTable(descriptor2, new String[]{"SellerId", "SellerData", "HeaderBiddingType", "Ifv", "BmIfv", "SessionId"});
        Descriptors.Descriptor descriptor3 = internal_static_bidmachine_protobuf_RequestExtension_descriptor.getNestedTypes().get(0);
        f12875x1ef2da26 = descriptor3;
        f12876x79107aa4 = new GeneratedMessageV3.FieldAccessorTable(descriptor3, new String[]{"Key", "Value"});
        Descriptors.Descriptor descriptor4 = getDescriptor().getMessageTypes().get(1);
        internal_static_bidmachine_protobuf_AdExtension_descriptor = descriptor4;
        f12871x1b41ebde = new GeneratedMessageV3.FieldAccessorTable(descriptor4, new String[]{"Preload", "LoadSkipoffset", "Skipoffset", "CompanionSkipoffset", "UseNativeClose", "R1", "R2", "R1Delay", "Countdown", "CloseButton", "Progress", "ProgressDuration", "IgnoresSafeAreaLayoutGuide", "StoreUrl", "ViewabilityTimeThreshold", "ViewabilityPixelThreshold", "ViewabilityDurationThreshold", "ViewabilityIgnoreWindowFocus", "Event", "CustomParams", "AdCacheControl", "AdCacheMaxAge", "AdMarkupLoadingTimeout", "UseEmbeddedBrowser", "PreloadAd", "CreativeLoadingMethod", "PlaceholderTimeout"});
        Descriptors.Descriptor descriptor5 = internal_static_bidmachine_protobuf_AdExtension_descriptor.getNestedTypes().get(0);
        f12867x19fc4d2a = descriptor5;
        f12868x6a08a9a8 = new GeneratedMessageV3.FieldAccessorTable(descriptor5, new String[]{"Content", "Fill", "FontStyle", "Height", "Hideafter", "Margin", "Opacity", "Outlined", "Padding", "Shadow", "Stroke", "StrokeWidth", "Style", "Visible", "Width", "X", "Y"});
        Descriptors.Descriptor descriptor6 = internal_static_bidmachine_protobuf_AdExtension_descriptor.getNestedTypes().get(1);
        f12869x1e53ffa4 = descriptor6;
        f12870x652b4222 = new GeneratedMessageV3.FieldAccessorTable(descriptor6, new String[]{"Key", "Value"});
        ...
        f12872xf3936840 = new GeneratedMessageV3.FieldAccessorTable(descriptor7, new String[]{"InstallTime", "Uptime"});
        ...
        f12873x1b553c91 = new GeneratedMessageV3.FieldAccessorTable(descriptor8, new String[]{"Battery", "Rooted"});
        ...
        f12874x806ff90b = new GeneratedMessageV3.FieldAccessorTable(descriptor9, new String[]{"UsPrivacy"});
        ...
        internal_static_bidmachine_protobuf_Session_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor10, new String[]{"Id", "Uptime"});
