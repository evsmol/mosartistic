...
/* renamed from: io.bidmachine.protobuf.AdExtension */
public final class AdExtension extends GeneratedMessageV3 implements AdExtensionOrBuilder {
    ...
    /* access modifiers changed from: private */
    public List<C1611Ad.Event> event_;
    /* access modifiers changed from: private */
    ...
    /* renamed from: io.bidmachine.protobuf.AdExtension$ControlAssetOrBuilder */
                ...
                try {
                    ...
                    switch (readTag) {
                        ...
                        case 58:
                            ...
                            this.event_.add(codedInputStream.readMessage(C1611Ad.Event.parser(), extensionRegistryLite));
                            break;
                        case 66:
                            if (!z2 || !true) {
    ...
    public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return ExtensionsProto.f12871x1b41ebde.ensureFieldAccessorsInitialized(AdExtension.class, Builder.class);
    }

    /* renamed from: io.bidmachine.protobuf.AdExtension$ControlAsset */
    public static final class ControlAsset extends GeneratedMessageV3 implements ControlAssetOrBuilder {
        ...
        /* renamed from: x_ */
        public volatile Object f12844x_;
        /* access modifiers changed from: private */

        /* renamed from: y_ */
        public volatile Object f12845y_;
                    ...
                    try {
                        ...
                        switch (readTag) {
                            ...
                            case 120:
                                ...
                                break;
                            case 130:
                                this.f12844x_ = codedInputStream.readStringRequireUtf8();
                                break;
                            case 138:
                                this.f12845y_ = codedInputStream.readStringRequireUtf8();
                                break;
                            case 149:
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return ExtensionsProto.f12867x19fc4d2a;
        }

        /* access modifiers changed from: protected */
        public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return ExtensionsProto.f12868x6a08a9a8.ensureFieldAccessorsInitialized(ControlAsset.class, Builder.class);
        }
        ...
        public String getX() {
            Object obj = this.f12844x_;
            if (obj instanceof String) {
                return (String) obj;
            }
            String stringUtf8 = ((ByteString) obj).toStringUtf8();
            this.f12844x_ = stringUtf8;
            return stringUtf8;
        }
        ...
        public ByteString getXBytes() {
            ...
            ByteString copyFromUtf8 = ByteString.copyFromUtf8((String) obj);
            this.f12844x_ = copyFromUtf8;
            return copyFromUtf8;
        }

        public String getY() {
            Object obj = this.f12845y_;
            if (obj instanceof String) {
                return (String) obj;
            }
            String stringUtf8 = ((ByteString) obj).toStringUtf8();
            this.f12845y_ = stringUtf8;
            return stringUtf8;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!getXBytes().isEmpty()) {
                GeneratedMessageV3.writeString(codedOutputStream, 16, this.f12844x_);
            }
            if (!getYBytes().isEmpty()) {
                GeneratedMessageV3.writeString(codedOutputStream, 17, this.f12845y_);
            }
        ...
        public int getSerializedSize() {
            ...
            if (!getXBytes().isEmpty()) {
                i2 += GeneratedMessageV3.computeStringSize(16, this.f12844x_);
            }
            if (!getYBytes().isEmpty()) {
                i2 += GeneratedMessageV3.computeStringSize(17, this.f12845y_);
            }
            float f2 = this.strokeWidth_;
            if (f2 != 0.0f) {
                i2 += CodedOutputStream.computeFloatSize(18, f2);
            }
        ...
        /* renamed from: io.bidmachine.protobuf.AdExtension$ControlAsset$Builder */
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements ControlAssetOrBuilder {
            ...
            /* renamed from: x_ */
            private Object f12846x_;

            /* renamed from: y_ */
            private Object f12847y_;
            ...
            public ControlAsset buildPartial() {
                ...
                Object unused16 = controlAsset.f12844x_ = this.f12846x_;
                Object unused17 = controlAsset.f12845y_ = this.f12847y_;
                onBuilt();
                return controlAsset;
            }
            ...
            public Builder mergeFrom(ControlAsset controlAsset) {
                ...
                if (!controlAsset.getX().isEmpty()) {
                    this.f12846x_ = controlAsset.f12844x_;
                    onChanged();
                }
                if (!controlAsset.getY().isEmpty()) {
                    this.f12847y_ = controlAsset.f12845y_;
                    onChanged();
                }
            ...
            public p150io.bidmachine.protobuf.AdExtension.ControlAsset.Builder mergeFrom(com.explorestack.protobuf.CodedInputStream r3, com.explorestack.protobuf.ExtensionRegistryLite r4) throws java.io.IOException {
                /*
                    r2 = this;
                    r0 = 0
                    com.explorestack.protobuf.Parser r1 = p150io.bidmachine.protobuf.AdExtension.ControlAsset.PARSER     // Catch:{ InvalidProtocolBufferException -> 0x0013 }
                    ...
                    io.bidmachine.protobuf.AdExtension$ControlAsset r3 = (p150io.bidmachine.protobuf.AdExtension.ControlAsset) r3     // Catch:{ InvalidProtocolBufferException -> 0x0013 }
                    if (r3 == 0) goto L_0x0010
                    r2.mergeFrom((p150io.bidmachine.protobuf.AdExtension.ControlAsset) r3)
                L_0x0010:
                    return r2
                L_0x0011:
                    r3 = move-exception
                ...
                L_0x0013:
                    ...
                    io.bidmachine.protobuf.AdExtension$ControlAsset r4 = (p150io.bidmachine.protobuf.AdExtension.ControlAsset) r4     // Catch:{ all -> 0x0011 }
                ...
                L_0x0021:
                    ...
                    r2.mergeFrom((p150io.bidmachine.protobuf.AdExtension.ControlAsset) r0)
                L_0x0026:
                    throw r3
                */
                throw new UnsupportedOperationException("Method not decompiled: p150io.bidmachine.protobuf.AdExtension.ControlAsset.Builder.mergeFrom(com.explorestack.protobuf.CodedInputStream, com.explorestack.protobuf.ExtensionRegistryLite):io.bidmachine.protobuf.AdExtension$ControlAsset$Builder");
            }
            ...
            public String getX() {
                Object obj = this.f12846x_;
                if (obj instanceof String) {
                    return (String) obj;
                }
                String stringUtf8 = ((ByteString) obj).toStringUtf8();
                this.f12846x_ = stringUtf8;
                return stringUtf8;
            }
            ...
            public Builder clearX() {
                this.f12846x_ = ControlAsset.getDefaultInstance().getX();
                onChanged();
                return this;
            }
            ...
            public String getY() {
                Object obj = this.f12847y_;
                if (obj instanceof String) {
                    return (String) obj;
                }
                String stringUtf8 = ((ByteString) obj).toStringUtf8();
                this.f12847y_ = stringUtf8;
                return stringUtf8;
            }
            ...
            public Builder clearY() {
                this.f12847y_ = ControlAsset.getDefaultInstance().getY();
                onChanged();
                return this;
            }
    ...
    public List<C1611Ad.Event> getEventList() {
        return this.event_;
    }

    public List<? extends C1611Ad.EventOrBuilder> getEventOrBuilderList() {
        return this.event_;
    }
    ...
    public C1611Ad.Event getEvent(int i) {
        return this.event_.get(i);
    }

    public C1611Ad.EventOrBuilder getEventOrBuilder(int i) {
        return this.event_.get(i);
    }

    /* renamed from: io.bidmachine.protobuf.AdExtension$CustomParamsDefaultEntryHolder */
    private static final class CustomParamsDefaultEntryHolder {
        static final MapEntry<String, String> defaultEntry = MapEntry.newDefaultInstance(ExtensionsProto.f12869x1e53ffa4, WireFormat.FieldType.STRING, "", WireFormat.FieldType.STRING, "");
    ...
    /* renamed from: io.bidmachine.protobuf.AdExtension$Builder */
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements AdExtensionOrBuilder {
        ...
        private RepeatedFieldBuilderV3<C1611Ad.Event, C1611Ad.Event.Builder, C1611Ad.EventOrBuilder> eventBuilder_;
        private List<C1611Ad.Event> event_;
        ...
        public Builder clear() {
            ...
            RepeatedFieldBuilderV3<C1611Ad.Event, C1611Ad.Event.Builder, C1611Ad.EventOrBuilder> repeatedFieldBuilderV3 = this.eventBuilder_;
        ...
        public Builder mergeFrom(AdExtension adExtension) {
            ...
            if (this.eventBuilder_ == null) {
                ...
                if (this.eventBuilder_.isEmpty()) {
                    ...
                    RepeatedFieldBuilderV3<C1611Ad.Event, C1611Ad.Event.Builder, C1611Ad.EventOrBuilder> repeatedFieldBuilderV3 = null;
        ...
        /* JADX WARNING: Removed duplicated region for block: B:16:0x0023  */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public p150io.bidmachine.protobuf.AdExtension.Builder mergeFrom(com.explorestack.protobuf.CodedInputStream r3, com.explorestack.protobuf.ExtensionRegistryLite r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.explorestack.protobuf.Parser r1 = p150io.bidmachine.protobuf.AdExtension.PARSER     // Catch:{ InvalidProtocolBufferException -> 0x0013 }
                java.lang.Object r3 = r1.parsePartialFrom((com.explorestack.protobuf.CodedInputStream) r3, (com.explorestack.protobuf.ExtensionRegistryLite) r4)     // Catch:{ InvalidProtocolBufferException -> 0x0013 }
                io.bidmachine.protobuf.AdExtension r3 = (p150io.bidmachine.protobuf.AdExtension) r3     // Catch:{ InvalidProtocolBufferException -> 0x0013 }
                if (r3 == 0) goto L_0x0010
                r2.mergeFrom((p150io.bidmachine.protobuf.AdExtension) r3)
            L_0x0010:
                return r2
            L_0x0011:
                r3 = move-exception
            ...
            L_0x0013:
                r3 = move-exception
                com.explorestack.protobuf.MessageLite r4 = r3.getUnfinishedMessage()     // Catch:{ all -> 0x0011 }
                io.bidmachine.protobuf.AdExtension r4 = (p150io.bidmachine.protobuf.AdExtension) r4     // Catch:{ all -> 0x0011 }
                java.io.IOException r3 = r3.unwrapIOException()     // Catch:{ all -> 0x001f }
                throw r3     // Catch:{ all -> 0x001f }
            L_0x001f:
                r3 = move-exception
            ...
            L_0x0021:
                if (r0 == 0) goto L_0x0026
                r2.mergeFrom((p150io.bidmachine.protobuf.AdExtension) r0)
            L_0x0026:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: p150io.bidmachine.protobuf.AdExtension.Builder.mergeFrom(com.explorestack.protobuf.CodedInputStream, com.explorestack.protobuf.ExtensionRegistryLite):io.bidmachine.protobuf.AdExtension$Builder");
        }
        ...
        public Builder setEvent(int i, C1611Ad.Event event) {
            RepeatedFieldBuilderV3<C1611Ad.Event, C1611Ad.Event.Builder, C1611Ad.EventOrBuilder> repeatedFieldBuilderV3 = this.eventBuilder_;
            if (repeatedFieldBuilderV3 != null) {
        ...
        public Builder setEvent(int i, C1611Ad.Event.Builder builder) {
            RepeatedFieldBuilderV3<C1611Ad.Event, C1611Ad.Event.Builder, C1611Ad.EventOrBuilder> repeatedFieldBuilderV3 = this.eventBuilder_;
            if (repeatedFieldBuilderV3 == null) {
                ensureEventIsMutable();
        ...
        public Builder addEvent(C1611Ad.Event event) {
            RepeatedFieldBuilderV3<C1611Ad.Event, C1611Ad.Event.Builder, C1611Ad.EventOrBuilder> repeatedFieldBuilderV3 = this.eventBuilder_;
            if (repeatedFieldBuilderV3 != null) {
        ...
        public Builder addEvent(int i, C1611Ad.Event event) {
            RepeatedFieldBuilderV3<C1611Ad.Event, C1611Ad.Event.Builder, C1611Ad.EventOrBuilder> repeatedFieldBuilderV3 = this.eventBuilder_;
            if (repeatedFieldBuilderV3 != null) {
        ...
        public Builder addEvent(C1611Ad.Event.Builder builder) {
            RepeatedFieldBuilderV3<C1611Ad.Event, C1611Ad.Event.Builder, C1611Ad.EventOrBuilder> repeatedFieldBuilderV3 = this.eventBuilder_;
            if (repeatedFieldBuilderV3 == null) {
                ensureEventIsMutable();
        ...
        public Builder addEvent(int i, C1611Ad.Event.Builder builder) {
            RepeatedFieldBuilderV3<C1611Ad.Event, C1611Ad.Event.Builder, C1611Ad.EventOrBuilder> repeatedFieldBuilderV3 = this.eventBuilder_;
            if (repeatedFieldBuilderV3 == null) {
                ensureEventIsMutable();
        ...
        public Builder addAllEvent(Iterable<? extends C1611Ad.Event> iterable) {
            RepeatedFieldBuilderV3<C1611Ad.Event, C1611Ad.Event.Builder, C1611Ad.EventOrBuilder> repeatedFieldBuilderV3 = this.eventBuilder_;
            if (repeatedFieldBuilderV3 == null) {
                ensureEventIsMutable();
        ...
        public C1611Ad.Event.Builder getEventBuilder(int i) {
        ...
        public C1611Ad.Event.Builder addEventBuilder() {
            return getEventFieldBuilder().addBuilder(C1611Ad.Event.getDefaultInstance());
        }

        public C1611Ad.Event.Builder addEventBuilder(int i) {
            return getEventFieldBuilder().addBuilder(i, C1611Ad.Event.getDefaultInstance());
        }

        public List<C1611Ad.Event.Builder> getEventBuilderList() {
            return getEventFieldBuilder().getBuilderList();
        }

        private RepeatedFieldBuilderV3<C1611Ad.Event, C1611Ad.Event.Builder, C1611Ad.EventOrBuilder> getEventFieldBuilder() {
            if (this.eventBuilder_ == null) {
                List<C1611Ad.Event> list = this.event_;
                boolean z = true;
                if ((this.bitField0_ & 1) == 0) {
                    z = false;
                }
