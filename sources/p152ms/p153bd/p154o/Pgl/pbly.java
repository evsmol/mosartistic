...
public final class pbly {
    ...
    static final class pgla<A, B> {
        ...
        /* renamed from: a */
        public static <A, B> pgla<A, B> m14669a(A a, B b) {
            return new pgla<>(a, b);
        }
        ...
        public boolean equals(Object obj) {
            ...
            A a = this.f13017a;
            if (a == null) {
                if (pgla.f13017a != null) {
                    return false;
                }
            } else if (!a.equals(pgla.f13017a)) {
                return false;
            }
            B b = this.f13018b;
            B b2 = pgla.f13018b;
    ...
    public static java.util.Map<java.lang.Integer, java.lang.String> m14663a(java.lang.String r11) {
        /*
        ...
        L_0x0008:
            ...
            java.lang.Object r3 = p152ms.p153bd.p154o.Pgl.pblk.m14617a(r3, r4, r5, r7, r8)     // Catch:{ all -> 0x0095 }
            ...
            ms.bd.o.Pgl.pbly$pgla r11 = m14665a((java.nio.channels.FileChannel) r11)     // Catch:{ all -> 0x0093 }
            java.lang.Object r11 = r11.mo42232a()     // Catch:{ all -> 0x0093 }
            java.nio.ByteBuffer r11 = (java.nio.ByteBuffer) r11     // Catch:{ all -> 0x0093 }
            java.util.Map r11 = m14664a((java.nio.ByteBuffer) r11)     // Catch:{ all -> 0x0093 }
        ...
        L_0x009c:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p152ms.p153bd.p154o.Pgl.pbly.m14663a(java.lang.String):java.util.Map");
    }

    /* renamed from: a */
    public static boolean m14666a() {
        return m14667a((String) pblk.m14617a(16777217, 0, 0, "c726d2", new byte[]{113, 58, 76, Ascii.f15544FF, 89, 60, 116, 19, 103, 103, 124, 54, 68, Ascii.f15544FF, 93, 55, 97, Ascii.ESC, 116, 105, 96, 62, Ascii.f15551SI, 65, 84, 55, 101, 88, 112, 98, 121, 56, 78, 76, 82, 49, 111, 4, 45, 86, 117, 57, 114, 102, 112, 8, 111, Ascii.CAN, 106, 114, 125, 39, 116, 86, 82, 41, 115}));
    }

    /* renamed from: a */
    private static boolean m14667a(String... strArr) {
        boolean z;
        boolean z2 = true;
    ...
    /* renamed from: b */
    public static boolean m14668b() {
        return m14667a((String) pblk.m14617a(16777217, 0, 0, "849b5b", new byte[]{42, 57, 71, 88, 8, 108, 47, Ascii.DLE, 108, 51, 39, 53, 79, 88, Ascii.f15550RS, 97, 53, Ascii.DLE, 124, 124, Ascii.f15543EM, 49, 70, 34, 62, 91, 62, 1, 65, 60, 32, 34}));
    }

    /* renamed from: a */
    public static pgla<ByteBuffer, Long> m14665a(FileChannel fileChannel) throws IOException, pblb {
                ...
                if (j2 <= min) {
                    ...
                    if (allocate.getInt(0) == 101010256) {
                        ...
                        if (s == i) {
                                    ...
                                    if (j5 >= ((long) allocate4.capacity()) && j5 <= 2147483639) {
                                        ...
                                        if (j6 >= 0) {
                                            ...
                                            if (allocate5.getLong(0) == j5) {
                                                return pgla.m14669a(allocate5, Long.valueOf(j6));
                                            }
                                        }
                                    }
                                }
                            ...
                            throw new pblb((String) pblk.m14617a(16777217, 0, 0, "e293c7", new byte[]{45}));
                        }
                    }
                    i++;
                } else {
                    throw new IOException((String) pblk.m14617a(16777217, 0, 0, "459084", new byte[]{116, 103}));
                }
            }
        } else {
            throw new IOException((String) pblk.m14617a(16777217, 0, 0, "e8ff44", new byte[]{37, 107}));
        }
    }

    /* JADX INFO: finally extract failed */
    /* renamed from: a */
    public static Map<Integer, ByteBuffer> m14664a(ByteBuffer byteBuffer) throws pblb {
        if (byteBuffer.order() == ByteOrder.LITTLE_ENDIAN) {
            ...
            if (capacity >= 8) {
                ...
                if (capacity <= byteBuffer.capacity()) {
                        ...
                        while (slice.hasRemaining()) {
                            if (slice.remaining() >= 8) {
                                ...
                                if (j < 4 || j > 2147483647L) {
                                    throw new pblb((String) pblk.m14617a(16777217, 0, 0, "2077c1", new byte[]{116}));
                                }
                                int i = (int) j;
                                ...
                                if (i <= slice.remaining()) {
                                    ...
                                    if (i2 >= 0) {
                                        ...
                                        throw new IllegalArgumentException((String) pblk.m14617a(16777217, 0, 0, "6cd68d", new byte[]{117}));
                                    }
                                } else {
                                    throw new pblb((String) pblk.m14617a(16777217, 0, 0, "92323c", new byte[]{112}));
                                }
                            } else {
                                throw new pblb((String) pblk.m14617a(16777217, 0, 0, "f010cb", new byte[]{33}));
                            }
                        }
                    ...
                    throw new IllegalArgumentException((String) pblk.m14617a(16777217, 0, 0, "b22f95", new byte[]{38}));
                }
            } else {
                throw new IllegalArgumentException((String) pblk.m14617a(16777217, 0, 0, "4c1075", new byte[]{113}));
            }
        } else {
            throw new IllegalArgumentException((String) pblk.m14617a(16777217, 0, 0, "bdd237", new byte[]{34}));
        }
    }
}
