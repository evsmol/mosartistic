...
public final class WorkSpec {
    ...
    public WorkSpec(WorkSpec workSpec) {
        this.f13098id = workSpec.f13098id;
    ...
    public int hashCode() {
        int hashCode = ((((this.f13098id.hashCode() * 31) + this.state.hashCode()) * 31) + this.workerClassName.hashCode()) * 31;
        String str = this.inputMergerClassName;
    ...
    public String toString() {
        return "{WorkSpec: " + this.f13098id + "}";
    }

    public static class IdAndState {

        /* renamed from: id */
        public String f13099id;
        ...
        public boolean equals(Object obj) {
            ...
            return this.f13099id.equals(idAndState.f13099id);
        }

        public int hashCode() {
            return (this.f13099id.hashCode() * 31) + this.state.hashCode();
        }
    }
}
