...
import androidx.core.p161os.BuildCompat;
...
class SystemJobInfoConverter {
    ...
    public JobInfo convert(WorkSpec workSpec, int i) {
        ...
        persistableBundle.putString("EXTRA_WORK_SPEC_ID", workSpec.f13098id);
    ...
    static /* synthetic */ class C61081 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.work.impl.background.systemjob.SystemJobInfoConverter.C61081.<clinit>():void");
        }
    }

    static int convertNetworkType(NetworkType networkType) {
        int i = C61081.$SwitchMap$androidx$work$NetworkType[networkType.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
