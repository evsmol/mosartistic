...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public void setState(TransitionState transitionState) {
        if (transitionState != TransitionState.FINISHED || this.mCurrentState != -1) {
            ...
            int i = C59105.f13080xabc7e4ac[transitionState2.ordinal()];
            if (i == 1 || i == 2) {
    ...
    static /* synthetic */ class C59105 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f13080xabc7e4ac     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f13080xabc7e4ac     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f13080xabc7e4ac     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.motion.widget.MotionLayout.C59105.<clinit>():void");
        }
    }
    ...
    private static class MyTracker implements MotionTracker {
        ...
        /* renamed from: me */
        private static MyTracker f13081me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f13081me.tracker = VelocityTracker.obtain();
            return f13081me;
        }
    ...
    class DecelerateInterpolator extends MotionInterpolator {
        ...
        public float getInterpolation(float f) {
            ...
            if (f4 > 0.0f) {
                ...
                this.this$0.mLastVelocity = this.initalV - (this.maxA * f);
