...
public class PriorityGoalRow extends ArrayRow {
    ...
    public SolverVariable getPivotCandidate(LinearSystem linearSystem, boolean[] zArr) {
        ...
        for (int i2 = 0; i2 < this.numGoals; i2++) {
            ...
            if (!zArr[solverVariable.f13055id]) {
    ...
    private final void addToGoal(SolverVariable solverVariable) {
        ...
        int i4 = i3 + 1;
        this.numGoals = i4;
        if (i4 > 1 && solverVariableArr3[i4 - 1].f13055id > solverVariable.f13055id) {
            int i5 = 0;
            while (true) {
                i = this.numGoals;
                if (i5 >= i) {
            ...
            Arrays.sort(this.sortArray, 0, i, new Comparator<SolverVariable>() {
                public int compare(SolverVariable solverVariable, SolverVariable solverVariable2) {
                    return solverVariable.f13055id - solverVariable2.f13055id;
                }
            });
