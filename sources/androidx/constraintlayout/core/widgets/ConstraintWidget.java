...
public class ConstraintWidget {
    ...
    /* renamed from: mX */
    protected int f13068mX;

    /* renamed from: mY */
    protected int f13069mY;
    ...
    public String toString() {
        ...
        sb.append(str2);
        sb.append("(");
        sb.append(this.f13068mX);
        sb.append(", ");
        sb.append(this.f13069mY);
        sb.append(") - (");
    ...
    public int getX() {
        ...
        if (constraintWidget == null || !(constraintWidget instanceof ConstraintWidgetContainer)) {
            return this.f13068mX;
        }
        return ((ConstraintWidgetContainer) constraintWidget).mPaddingLeft + this.f13068mX;
    }

    public int getY() {
        ConstraintWidget constraintWidget = this.mParent;
        if (constraintWidget == null || !(constraintWidget instanceof ConstraintWidgetContainer)) {
            return this.f13069mY;
        }
        return ((ConstraintWidgetContainer) constraintWidget).mPaddingTop + this.f13069mY;
    }
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type type) {
        switch (C59011.f13070x6930e354[type.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    private void applyConstraints(androidx.constraintlayout.core.LinearSystem r36, boolean r37, boolean r38, boolean r39, boolean r40, androidx.constraintlayout.core.SolverVariable r41, androidx.constraintlayout.core.SolverVariable r42, androidx.constraintlayout.core.widgets.ConstraintWidget.DimensionBehaviour r43, boolean r44, androidx.constraintlayout.core.widgets.ConstraintAnchor r45, androidx.constraintlayout.core.widgets.ConstraintAnchor r46, int r47, int r48, int r49, int r50, float r51, boolean r52, boolean r53, boolean r54, boolean r55, boolean r56, int r57, int r58, int r59, int r60, float r61, boolean r62) {
        ...
        L_0x0064:
            r20 = r57
        L_0x0066:
            int[] r21 = androidx.constraintlayout.core.widgets.ConstraintWidget.C59011.f13071x6d00e4a2
            int r22 = r43.ordinal()
            r5 = r21[r22]
            r2 = 2
            r14 = 1
    ...
    static /* synthetic */ class C59011 {
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f13071x6d00e4a2     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                r2 = 3
                int[] r3 = f13071x6d00e4a2     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                r3 = 4
                int[] r4 = f13071x6d00e4a2     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0044:
                int[] r1 = f13070x6930e354     // Catch:{ NoSuchFieldError -> 0x004e }
            ...
            L_0x004e:
                int[] r0 = f13070x6930e354     // Catch:{ NoSuchFieldError -> 0x0058 }
            ...
            L_0x0058:
                int[] r0 = f13070x6930e354     // Catch:{ NoSuchFieldError -> 0x0062 }
            ...
            L_0x0062:
                int[] r0 = f13070x6930e354     // Catch:{ NoSuchFieldError -> 0x006d }
            ...
            L_0x006d:
                int[] r0 = f13070x6930e354     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f13070x6930e354     // Catch:{ NoSuchFieldError -> 0x0083 }
            ...
            L_0x0083:
                int[] r0 = f13070x6930e354     // Catch:{ NoSuchFieldError -> 0x008f }
            ...
            L_0x008f:
                int[] r0 = f13070x6930e354     // Catch:{ NoSuchFieldError -> 0x009b }
            ...
            L_0x009b:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.widgets.ConstraintWidget.C59011.<clinit>():void");
        }
    }
    ...
    public void copy(ConstraintWidget constraintWidget, HashMap<ConstraintWidget, ConstraintWidget> hashMap) {
        ...
        this.f13068mX = constraintWidget.f13068mX;
        this.f13069mY = constraintWidget.f13069mY;
    ...
    public void getSceneString(StringBuilder sb) {
        ...
        sb.append("\n");
        sb.append("    actualLeft:" + this.f13068mX);
        sb.append("\n");
        sb.append("    actualTop:" + this.f13069mY);
        sb.append("\n");
