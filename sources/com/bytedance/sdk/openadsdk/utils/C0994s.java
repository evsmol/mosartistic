...
public class C0994s {
    ...
    /* renamed from: a */
    private static String f3329a;

    /* renamed from: c */
    public static boolean m4606c() {
        return false;
    }
    ...
    public static java.lang.String m4602a(java.lang.String r7) {
        /*
        ...
        L_0x008e:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.sdk.openadsdk.utils.C0994s.m4602a(java.lang.String):java.lang.String");
    }

    /* renamed from: a */
    public static boolean m4603a() {
        if (C10638l.m31240c() && C0503h.m2281d().mo1618s() && C0503h.m2281d().mo1619t()) {
            return true;
        }
        return false;
    }
    ...
    /* renamed from: b */
    public static String m4605b(String str) {
        try {
            if (!m4603a()) {
                return str;
            }
            String u = C0503h.m2281d().mo1620u();
            if (TextUtils.isEmpty(u)) {
                return str;
            }
            Log.d("TestHelperUtils", "AnyDoorId=" + u);
            return Uri.parse(str).buildUpon().appendQueryParameter(m4604b(), u).appendQueryParameter("aid", "5001121").toString();
    ...
    /* renamed from: b */
    public static String m4604b() {
        if (TextUtils.isEmpty(f3329a)) {
            f3329a = new String(Base64.decode("ZGV2aWNlX2lk", 0));
        }
        return f3329a;
    }
}
