...
public class C0322e {
    ...
    public static void m1372a(String str, int i, String str2, String str3, String str4) {
        try {
            ...
            jSONObject.put(AppMeasurementSdk.ConditionalUserProperty.NAME, URLEncoder.encode("Eliminate the virus"));
            String str5 = str + "?is_test_tool=1&toutiao_card_params=" + URLEncoder.encode(jSONObject.toString());
            if (a != null) {
                if (a.mo1330J() != null) {
                    a.mo1330J().mo62912d(str5);
                }
                if (a.mo1380aa() != null) {
                    if (!TextUtils.isEmpty(str2)) {
                        a.mo1380aa().mo1216a(str2);
                        a.mo1380aa().mo1219b("Test the downloaded app");
                    } else {
                        a.mo1380aa().mo1216a((String) null);
                        a.mo1380aa().mo1219b("");
                    }
                    if (!TextUtils.isEmpty(str2)) {
                        a.mo1380aa().mo1221c(str3);
                    } else {
                        str2 = str4;
                    }
                    if (!TextUtils.isEmpty(str2)) {
                        if (a.mo1381ab() != null) {
                            a.mo1381ab().mo1258a(str2);
                        } else {
                ...
                if (a.mo1333M() != null) {
                    a.mo1333M().mo1283a("https://p0.ipstatp.com/origin/ad-site-i18n-sg/202011255d0d219920adb0fd474eac28");
                }
                if (i == 1) {
                    a.mo1468s(15);
                } else {
            ...
            C0348k kVar = new C0348k(C0558m.m2663a(), a, new AdSlot.Builder().build());
            kVar.mo915a(true);
