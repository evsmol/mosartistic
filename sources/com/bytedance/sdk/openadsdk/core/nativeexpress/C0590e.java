...
public class C0590e extends C0405a {
    public C0590e(Context context, C0477n nVar, String str, int i) {
    ...
    public C0455g mo1097a(float f, float f2, float f3, float f4, SparseArray<C0408c.C0409a> sparseArray, long j, long j2, View view, View view2, String str, float f5, int i, float f6, int i2, JSONObject jSONObject) {
        ...
        if (a == null || a.length != 2) {
            ...
            if (this.f1348r == 0) {
                ...
                float f13 = (float) i3;
                f8 = (C1002v.m4731b(this.f1332b, f3) + f12) - 0.5f;
                f7 = (C1002v.m4731b(this.f1332b, f4) + f13) - 0.5f;
                f9 = (b2 + f13) - 0.5f;
                f10 = (b + f12) - 0.5f;
            } else {
                f10 = f;
        ...
        if (this.f1333c != null) {
            ...
            if (this.f1348r == 0) {
                iArr[0] = ((int) C1002v.m4731b(this.f1332b, (float) this.f1333c.f1557g)) + i4;
        ...
        this.f1348r = 0;
        return new C0455g.C0457a().mo1254f(f10).mo1252e(f9).mo1249d(f11).mo1246c(f7).mo1244b(j4).mo1236a(j3).mo1245b(a).mo1240a(iArr).mo1248c(C1002v.m4743c(view)).mo1251d(iArr2).mo1250d(this.f1367y).mo1253e(this.f1368z).mo1255f(this.f1355A).mo1243b(C0503h.m2281d().mo1591b() ? 1 : 2).mo1237a(sparseArray).mo1238a(str).mo1234a(f5).mo1247c(i).mo1242b(f6).mo1235a(i2).mo1239a(jSONObject).mo1241a();
    }

    /* renamed from: a */
    public void mo1959a(C0460j jVar) {
        this.f1333c = jVar;
    }
}
