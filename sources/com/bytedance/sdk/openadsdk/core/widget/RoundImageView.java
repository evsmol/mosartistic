...
public class RoundImageView extends ImageView {
            ...
            if (drawable.getClass() != NinePatchDrawable.class) {
                ...
                if (bitmap3 != null) {
                    ...
                    if (bitmap2 == null) {
                        ...
                        canvas.drawBitmap(bitmap2, (float) ((this.f2728a / 2) - i3), (float) ((this.f2729b / 2) - i3), (Paint) null);
                    }
                }
            }
        }
    ...
    /* renamed from: a */
    private Bitmap m3706a(Bitmap bitmap, int i) {
        Bitmap bitmap2;
        int i2 = i * 2;
