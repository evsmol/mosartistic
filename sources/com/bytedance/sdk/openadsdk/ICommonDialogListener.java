...
public interface ICommonDialogListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICommonDialogListener {
        ...
        private static class C10664a implements ICommonDialogListener {

            /* renamed from: a */
            public static ICommonDialogListener f26627a;

            /* renamed from: b */
            private IBinder f26628b;

            C10664a(IBinder iBinder) {
                this.f26628b = iBinder;
            }
            ...
            public void onDialogBtnYes() throws RemoteException {
                ...
                try {
                    ...
                    if (this.f26628b.transact(1, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
            ...
            public void onDialogBtnNo() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.ICommonDialogListener");
                    if (this.f26628b.transact(2, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void onDialogCancel() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.ICommonDialogListener");
                    if (this.f26628b.transact(3, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
        ...
        public static boolean setDefaultImpl(ICommonDialogListener iCommonDialogListener) {
            if (C10664a.f26627a != null || iCommonDialogListener == null) {
                return false;
            }
            C10664a.f26627a = iCommonDialogListener;
            return true;
        }

        public static ICommonDialogListener getDefaultImpl() {
            return C10664a.f26627a;
        }
    }
}
