...
/* renamed from: com.applovin.exoplayer2.k.u */
public final class C7698u {

    /* renamed from: a */
    private static final Pattern f18169a = Pattern.compile("bytes (\\d+)-(\\d+)/(?:\\d+|\\*)");

    /* renamed from: b */
    private static final Pattern f18170b = Pattern.compile("bytes (?:(?:\\d+-\\d+)|\\*)/(\\d+)");

    /* renamed from: a */
    public static long m22048a(String str) {
        if (TextUtils.isEmpty(str)) {
            return -1;
        }
        Matcher matcher = f18170b.matcher(str);
        if (matcher.matches()) {
            return Long.parseLong((String) C7717a.m22120b(matcher.group(1)));
        }
        return -1;
    }
    ...
    public static long m22049a(java.lang.String r9, java.lang.String r10) {
        /*
        ...
        L_0x000f:
            ...
            com.applovin.exoplayer2.p221l.C7755q.m22363d(r2, r0)
        L_0x0026:
            r3 = -1
        L_0x0028:
            boolean r0 = android.text.TextUtils.isEmpty(r10)
            if (r0 != 0) goto L_0x00a4
            java.util.regex.Pattern r0 = f18169a
            java.util.regex.Matcher r0 = r0.matcher(r10)
            boolean r5 = r0.matches()
            if (r5 == 0) goto L_0x00a4
            r5 = 2
            java.lang.String r5 = r0.group(r5)     // Catch:{ NumberFormatException -> 0x008d }
            java.lang.Object r5 = com.applovin.exoplayer2.p221l.C7717a.m22120b(r5)     // Catch:{ NumberFormatException -> 0x008d }
            ...
            java.lang.Object r0 = com.applovin.exoplayer2.p221l.C7717a.m22120b(r0)     // Catch:{ NumberFormatException -> 0x008d }
        ...
        L_0x0064:
            ...
            com.applovin.exoplayer2.p221l.C7755q.m22361c(r2, r9)     // Catch:{ NumberFormatException -> 0x008d }
        ...
        L_0x008d:
            ...
            com.applovin.exoplayer2.p221l.C7755q.m22363d(r2, r9)
        L_0x00a4:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.applovin.exoplayer2.p220k.C7698u.m22049a(java.lang.String, java.lang.String):long");
    }

    /* renamed from: a */
    public static String m22050a(long j, long j2) {
        if (j == 0 && j2 == -1) {
            return null;
        }
