...
/* renamed from: com.applovin.exoplayer2.l.l */
public final class C7743l {
    /* renamed from: a */
    public static int m22310a(Uri uri) {
    ...
    public static int m22311a(java.lang.String r17) {
        /*
            r0 = -1
            if (r17 != 0) goto L_0x0004
            return r0
        L_0x0004:
            java.lang.String r1 = com.applovin.exoplayer2.p221l.C7759u.m22384f(r17)
            int r2 = r1.hashCode()
            r3 = 14
            r4 = 13
            r5 = 12
        ...
        L_0x0148:
            return r16
        */
        throw new UnsupportedOperationException("Method not decompiled: com.applovin.exoplayer2.p221l.C7743l.m22311a(java.lang.String):int");
    }

    /* renamed from: a */
    public static int m22312a(Map<String, List<String>> map) {
        List list = map.get("Content-Type");
        return m22311a((list == null || list.isEmpty()) ? null : (String) list.get(0));
    }
}
