...
public class C8614n {
    /* renamed from: a */
    public static String m26192a(String str, String str2) {
        return m26195a(str, str2, new byte[]{-83, -98, -53, -112, -29, -118, 55, 117, 59, 8, -12, -15, 73, 110, -67, 57, 117, 4, -26, 97, 66, -12, 125, 91, -119, -103, -30, 114, 123, 54, 51, -77});
    }

    /* renamed from: a */
    public static String m26193a(String str, String str2, long j) {
        return m26194a(str, str2, j, new byte[]{-83, -98, -53, -112, -29, -118, 55, 117, 59, 8, -12, -15, 73, 110, -67, 57, 117, 4, -26, 97, 66, -12, 125, 91, -119, -103, -30, 114, 123, 54, 51, -77});
    }

    /* renamed from: a */
    private static String m26194a(String str, String str2, long j, byte[] bArr) {
        String str3 = str;
        String str4 = str2;
        byte[] bArr2 = bArr;
        if (str4 == null) {
            ...
            if (bArr2.length < 32) {
                ...
                try {
                    ...
                    byte[] a = m26198a(substring2, bArr2);
                    ...
                    String b = m26200b(byteArrayOutputStream.toByteArray());
                    String a2 = m26196a(bArr);
    ...
    /* renamed from: a */
    private static String m26195a(String str, String str2, byte[] bArr) {
        String str3 = str;
        String str4 = str2;
        byte[] bArr2 = bArr;
        if (str4 == null) {
            ...
            if (bArr2.length < 32) {
                ...
                try {
                    ...
                    String str5 = split[1];
                    String str6 = split[2];
                    byte[] a = m26197a(split[3]);
                    if (!str4.endsWith(str6)) {
                        return null;
                    }
                    if (!m26196a(bArr).equals(str5)) {
                        return null;
                    }
                    byte[] a2 = m26198a(str4.substring(0, 32), bArr2);
    ...
    /* renamed from: a */
    private static String m26196a(byte[] bArr) {
        try {
    ...
    /* renamed from: a */
    private static byte[] m26197a(String str) {
        return Base64.decode(m26199b(str), 0);
    }

    /* renamed from: a */
    private static byte[] m26198a(String str, byte[] bArr) {
        try {
    ...
    /* renamed from: b */
    private static String m26199b(String str) {
        return str.replace('-', '+').replace('_', '/').replace('*', '=');
    }

    /* renamed from: b */
    private static String m26200b(byte[] bArr) throws UnsupportedEncodingException {
        return m26201c(Base64.encode(bArr, 2));
    }

    /* renamed from: c */
    private static String m26201c(byte[] bArr) throws UnsupportedEncodingException {
