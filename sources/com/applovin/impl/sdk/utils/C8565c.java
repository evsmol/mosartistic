...
public class C8565c {
    /* renamed from: a */
    public static MaxAdFormat m26060a(Context context) {
        return (AppLovinSdkUtils.isTablet(context) || AppLovinSdkUtils.isTv(context)) ? MaxAdFormat.LEADER : MaxAdFormat.BANNER;
    }

    /* renamed from: a */
    public static AppLovinAdSize m26061a(AttributeSet attributeSet) {
    ...
    /* renamed from: a */
    public static String m26062a(Context context, AttributeSet attributeSet, String str, String str2) {
    ...
    /* renamed from: a */
    public static void m26063a(ViewGroup viewGroup, View view) {
        if (viewGroup != null) {
    ...
    /* renamed from: a */
    public static boolean m26064a(View view) {
    ...
    /* renamed from: b */
    public static boolean m26065b(AttributeSet attributeSet) {
