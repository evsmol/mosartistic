...
public class CollectionUtils {
    ...
    /* renamed from: a */
    private static boolean f21619a;
    ...
    public static <K, V> Map<K, V> map(int i) {
        return (!C8571h.m26085c() || !f21619a) ? i == -1 ? new HashMap() : new HashMap(i) : i == -1 ? new ArrayMap() : new ArrayMap(i);
    }
    ...
    public static String toJsonString(Map<String, Object> map, String str) {
        try {
            ...
            C8626v.m26254c("CollectionUtils", "Failed to convert map '" + map + "' to JSON string.", e);
            return str;
        }
    }
}
