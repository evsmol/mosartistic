...
public class StringUtils {
    ...
    /* renamed from: a */
    private static final char[] f21620a = "0123456789abcdef".toCharArray();

    /* renamed from: a */
    private static String m26053a(String str, Integer num) {
    ...
    public static String encodeUriString(String str, C8490n nVar) {
        if (TextUtils.isEmpty(str)) {
            return "";
        }
        if (((Boolean) nVar.mo57342a(C8380b.f20933eZ)).booleanValue()) {
    ...
    public static String toHexString(byte[] bArr) {
        if (bArr != null) {
            ...
            for (int i = 0; i < bArr.length; i++) {
                ...
                cArr[i2 + 1] = cArr2[bArr[i] & Ascii.f15551SI];
            }
