...
import com.applovin.impl.sdk.p251a.C8314a;
...
public abstract class AppLovinAdBase implements C8314a, ArrayDirectDownloadAd {
    ...
    protected AppLovinAdBase(JSONObject jSONObject, JSONObject jSONObject2, C8490n nVar) {
        if (jSONObject == null) {
    ...
    public String getPrimaryKey() {
        return getStringFromAdObject(C8843d.f22400ec, "NA");
    }
