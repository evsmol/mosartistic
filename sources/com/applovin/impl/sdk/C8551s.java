...
public class C8551s {
    ...
    /* renamed from: a */
    private final String f21598a = "FileManagerOld";

    /* renamed from: b */
    private final C8490n f21599b;

    /* renamed from: c */
    private final C8626v f21600c;

    /* renamed from: d */
    private final Object f21601d = new Object();

    C8551s(C8490n nVar) {
        this.f21599b = nVar;
        this.f21600c = nVar.mo57320D();
    }

    /* renamed from: a */
    private File m26022a(Context context) {
        return new File(context.getFilesDir(), "al");
    }

    /* renamed from: a */
    private boolean m26023a(File file, String str, List<String> list, boolean z, C8393e eVar) {
        if (file == null || !file.exists() || file.isDirectory()) {
            ByteArrayOutputStream a = mo57664a(str, list, z, eVar);
            if (!(eVar == null || a == null)) {
                eVar.mo57142a((long) a.size());
            }
            return mo57668a(a, file);
        }
        if (C8626v.m26252a()) {
            C8626v vVar = this.f21600c;
            vVar.mo57818b("FileManagerOld", "File exists for " + str);
        }
        if (eVar == null) {
            return true;
        }
    ...
    private boolean m26024b(java.io.ByteArrayOutputStream r6, java.io.File r7) {
        /*
            r5 = this;
            boolean r0 = com.applovin.impl.sdk.C8626v.m26252a()
            if (r0 == 0) goto L_0x0022
            com.applovin.impl.sdk.v r0 = r5.f21600c
        ...
        L_0x0022:
            r0 = 0
            r1 = 0
            java.lang.Object r2 = r5.f21601d
            monitor-enter(r2)
            ...
            r1 = 1
            com.applovin.impl.sdk.n r6 = r5.f21599b     // Catch:{ all -> 0x0036 }
        ...
        L_0x003e:
            r6 = move-exception
        L_0x003f:
            boolean r7 = com.applovin.impl.sdk.C8626v.m26252a()     // Catch:{ all -> 0x0069 }
            if (r7 == 0) goto L_0x004e
            com.applovin.impl.sdk.v r7 = r5.f21600c     // Catch:{ all -> 0x0069 }
            java.lang.String r3 = "FileManagerOld"
            java.lang.String r4 = "Unknown failure to write file."
            r7.mo57819b(r3, r4, r6)     // Catch:{ all -> 0x0069 }
        L_0x004e:
            com.applovin.impl.sdk.n r6 = r5.f21599b     // Catch:{ all -> 0x0036 }
        L_0x0050:
        ...
        L_0x0069:
            r6 = move-exception
            com.applovin.impl.sdk.n r7 = r5.f21599b     // Catch:{ all -> 0x0036 }
        ...
        L_0x0070:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.applovin.impl.sdk.C8551s.m26024b(java.io.ByteArrayOutputStream, java.io.File):boolean");
    }

    /* JADX WARNING: Can't wrap try/catch for region: R(3:14|15|16) */
    /* JADX WARNING: Code restructure failed: missing block: B:17:?, code lost:
        com.applovin.impl.sdk.utils.Utils.close(r3, r8.f21599b);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:19:?, code lost:
        com.applovin.impl.sdk.utils.Utils.close(r2, r8.f21599b);
     */
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public java.io.ByteArrayOutputStream mo57663a(java.io.File r9) {
        /*
            r8 = this;
            r0 = 0
        ...
        L_0x0004:
            ...
            com.applovin.impl.sdk.v r1 = r8.f21600c
            ...
            r1.mo57818b(r2, r3)
        L_0x0026:
            java.lang.Object r1 = r8.f21601d
            monitor-enter(r1)
        ...
        L_0x0037:
            ...
            goto L_0x0037
        L_0x0042:
            com.applovin.impl.sdk.n r4 = r8.f21599b     // Catch:{ FileNotFoundException -> 0x0059, IOException -> 0x0057, all -> 0x0055 }
            com.applovin.impl.sdk.utils.Utils.close(r3, r4)     // Catch:{ FileNotFoundException -> 0x0059, IOException -> 0x0057, all -> 0x0055 }
            com.applovin.impl.sdk.n r9 = r8.f21599b     // Catch:{ all -> 0x00cf }
        ...
        L_0x005b:
            ...
            r2 = r0
        L_0x005d:
            boolean r3 = com.applovin.impl.sdk.C8626v.m26252a()     // Catch:{ all -> 0x00c8 }
            if (r3 == 0) goto L_0x006c
            com.applovin.impl.sdk.v r3 = r8.f21600c     // Catch:{ all -> 0x00c8 }
            java.lang.String r4 = "FileManagerOld"
            java.lang.String r5 = "Unknown failure to read file."
            r3.mo57819b(r4, r5, r9)     // Catch:{ all -> 0x00c8 }
        L_0x006c:
            com.applovin.impl.sdk.n r9 = r8.f21599b     // Catch:{ all -> 0x00cf }
            com.applovin.impl.sdk.utils.Utils.close(r2, r9)     // Catch:{ all -> 0x00cf }
            monitor-exit(r1)     // Catch:{ all -> 0x00cf }
        ...
        L_0x0073:
            ...
            r2 = r0
        L_0x0075:
            boolean r4 = com.applovin.impl.sdk.C8626v.m26252a()     // Catch:{ all -> 0x00c8 }
            if (r4 == 0) goto L_0x009a
            com.applovin.impl.sdk.v r4 = r8.f21600c     // Catch:{ all -> 0x00c8 }
            ...
            r4.mo57818b(r5, r9)     // Catch:{ all -> 0x00c8 }
        L_0x009a:
            com.applovin.impl.sdk.n r9 = r8.f21599b     // Catch:{ all -> 0x00cf }
            com.applovin.impl.sdk.utils.Utils.close(r2, r9)     // Catch:{ all -> 0x00cf }
            monitor-exit(r1)     // Catch:{ all -> 0x00cf }
        ...
        L_0x00a3:
            ...
            r3.mo57820c(r4, r9)     // Catch:{ all -> 0x00c8 }
        L_0x00c1:
            com.applovin.impl.sdk.n r9 = r8.f21599b     // Catch:{ all -> 0x00cf }
            com.applovin.impl.sdk.utils.Utils.close(r2, r9)     // Catch:{ all -> 0x00cf }
            monitor-exit(r1)     // Catch:{ all -> 0x00cf }
        ...
        L_0x00c8:
            r9 = move-exception
            com.applovin.impl.sdk.n r0 = r8.f21599b     // Catch:{ all -> 0x00cf }
        ...
        L_0x00cf:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.applovin.impl.sdk.C8551s.mo57663a(java.io.File):java.io.ByteArrayOutputStream");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:?, code lost:
        com.applovin.impl.sdk.utils.Utils.close(r9, r7.f21599b);
        r2 = r2;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:44:0x00ef, code lost:
        if (com.applovin.impl.sdk.C8626v.m26252a() == false) goto L_0x0107;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:45:0x00f1, code lost:
        r7.f21600c.mo57818b("FileManagerOld", "Loaded resource at " + r8);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:46:0x0107, code lost:
        com.applovin.impl.sdk.utils.Utils.close(r2, r7.f21599b);
        com.applovin.impl.sdk.utils.Utils.close(r9, r7.f21599b);
        com.applovin.impl.sdk.utils.Utils.disconnect(r10, r7.f21599b);
     */
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public java.io.ByteArrayOutputStream mo57664a(java.lang.String r8, java.util.List<java.lang.String> r9, boolean r10, com.applovin.impl.sdk.p255d.C8393e r11) {
        /*
            r7 = this;
            ...
            com.applovin.impl.sdk.v r9 = r7.f21600c
        ...
        L_0x0027:
            return r1
        L_0x0028:
            com.applovin.impl.sdk.n r9 = r7.f21599b
            com.applovin.impl.sdk.c.b<java.lang.Boolean> r10 = com.applovin.impl.sdk.p254c.C8380b.f20827cX
            ...
            com.applovin.impl.sdk.v r10 = r7.f21600c
        ...
        L_0x0074:
            ...
            com.applovin.impl.sdk.n r2 = r7.f21599b     // Catch:{ IOException -> 0x0121, all -> 0x011f }
            com.applovin.impl.sdk.c.b<java.lang.Integer> r3 = com.applovin.impl.sdk.p254c.C8380b.f20825cV     // Catch:{ IOException -> 0x0121, all -> 0x011f }
            java.lang.Object r2 = r2.mo57342a(r3)     // Catch:{ IOException -> 0x0121, all -> 0x011f }
            ...
            com.applovin.impl.sdk.n r2 = r7.f21599b     // Catch:{ IOException -> 0x0121, all -> 0x011f }
            com.applovin.impl.sdk.c.b<java.lang.Integer> r3 = com.applovin.impl.sdk.p254c.C8380b.f20826cW     // Catch:{ IOException -> 0x0121, all -> 0x011f }
            java.lang.Object r2 = r2.mo57342a(r3)     // Catch:{ IOException -> 0x0121, all -> 0x011f }
            java.lang.Integer r2 = (java.lang.Integer) r2     // Catch:{ IOException -> 0x0121, all -> 0x011f }
            int r2 = r2.intValue()     // Catch:{ IOException -> 0x0121, all -> 0x011f }
            ...
            r11.mo57141a((int) r2)     // Catch:{ IOException -> 0x0121, all -> 0x011f }
        ...
        L_0x00cc:
            ...
            goto L_0x00cc
        L_0x00d6:
            com.applovin.impl.sdk.n r3 = r7.f21599b     // Catch:{ IOException -> 0x0117 }
            com.applovin.impl.sdk.utils.Utils.close(r9, r3)     // Catch:{ IOException -> 0x0117 }
        L_0x00db:
            com.applovin.impl.sdk.n r8 = r7.f21599b
        ...
        L_0x00e0:
            ...
            return r1
        L_0x00eb:
            boolean r3 = com.applovin.impl.sdk.C8626v.m26252a()     // Catch:{ IOException -> 0x0117 }
            if (r3 == 0) goto L_0x0107
            com.applovin.impl.sdk.v r3 = r7.f21600c     // Catch:{ IOException -> 0x0117 }
            ...
            r3.mo57818b(r0, r4)     // Catch:{ IOException -> 0x0117 }
        L_0x0107:
            com.applovin.impl.sdk.n r8 = r7.f21599b
            com.applovin.impl.sdk.utils.Utils.close(r2, r8)
            com.applovin.impl.sdk.n r8 = r7.f21599b
        ...
        L_0x0131:
            r2 = r10
        L_0x0132:
            boolean r4 = com.applovin.impl.sdk.C8626v.m26252a()     // Catch:{ all -> 0x0152 }
            if (r4 == 0) goto L_0x014e
            com.applovin.impl.sdk.v r4 = r7.f21600c     // Catch:{ all -> 0x0152 }
            ...
            r4.mo57819b(r0, r8, r3)     // Catch:{ all -> 0x0152 }
        L_0x014e:
            r11.mo57143a((java.lang.Exception) r3)     // Catch:{ all -> 0x0152 }
            goto L_0x00db
        L_0x0152:
            r8 = move-exception
            r1 = r2
        L_0x0154:
            com.applovin.impl.sdk.n r11 = r7.f21599b
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.applovin.impl.sdk.C8551s.mo57664a(java.lang.String, java.util.List, boolean, com.applovin.impl.sdk.d.e):java.io.ByteArrayOutputStream");
    }

    /* renamed from: a */
    public File mo57665a(String str, Context context) {
        File file;
        if (!StringUtils.isValidString(str)) {
            if (C8626v.m26252a()) {
                this.f21600c.mo57818b("FileManagerOld", "Nothing to look up, skipping...");
            }
            return null;
        }
        if (C8626v.m26252a()) {
            C8626v vVar = this.f21600c;
            vVar.mo57818b("FileManagerOld", "Looking up cached resource: " + str);
        }
        if (str.contains("icon")) {
            str = str.replace("/", "_").replace(".", "_");
        }
        synchronized (this.f21601d) {
            File a = m26022a(context);
            file = new File(a, str);
            try {
                a.mkdirs();
            } catch (Throwable th) {
                if (C8626v.m26252a()) {
                    C8626v vVar2 = this.f21600c;
                    vVar2.mo57819b("FileManagerOld", "Unable to make cache directory at " + a, th);
                }
                return null;
            }
        }
    ...
    /* renamed from: a */
    public String mo57666a(Context context, String str, String str2, List<String> list, boolean z, boolean z2, C8393e eVar) {
        return mo57667a(context, str, str2, list, z, z2, false, eVar);
    }

    /* renamed from: a */
    public String mo57667a(Context context, String str, String str2, List<String> list, boolean z, boolean z2, boolean z3, C8393e eVar) {
        if (!StringUtils.isValidString(str)) {
            if (C8626v.m26252a()) {
                this.f21600c.mo57818b("FileManagerOld", "Nothing to cache, skipping...");
            }
            return null;
        }
        Uri parse = Uri.parse(str);
        String fileName = ((Boolean) this.f21599b.mo57342a(C8380b.f20964fe)).booleanValue() ? Utils.getFileName(parse) : parse.getLastPathSegment();
        if (z2) {
            fileName = StringUtils.encodeUriString(fileName, this.f21599b);
        }
        ...
        File a = mo57665a(str4, context);
        if (!m26023a(a, str, list, z, eVar)) {
            return null;
        }
        if (C8626v.m26252a()) {
            C8626v vVar = this.f21600c;
            vVar.mo57818b("FileManagerOld", "Caching succeeded for file " + str4);
        }
        return z3 ? Uri.fromFile(a).toString() : str4;
    }

    /* renamed from: a */
    public boolean mo57668a(ByteArrayOutputStream byteArrayOutputStream, File file) {
        if (file == null) {
            return false;
        }
        if (C8626v.m26252a()) {
            C8626v vVar = this.f21600c;
            vVar.mo57818b("FileManagerOld", "Caching " + file.getAbsolutePath() + APSSharedUtil.TRUNCATE_SEPARATOR);
        }
        if (byteArrayOutputStream == null || byteArrayOutputStream.size() <= 0) {
            if (C8626v.m26252a()) {
                C8626v vVar2 = this.f21600c;
                vVar2.mo57821d("FileManagerOld", "No data for " + file.getAbsolutePath());
            }
            return false;
        } else if (!m26024b(byteArrayOutputStream, file)) {
            if (C8626v.m26252a()) {
                C8626v vVar3 = this.f21600c;
                vVar3.mo57822e("FileManagerOld", "Unable to cache " + file.getAbsolutePath());
            }
            return false;
        } else if (!C8626v.m26252a()) {
            return true;
        } else {
            C8626v vVar4 = this.f21600c;
            vVar4.mo57818b("FileManagerOld", "Caching completed for " + file);
            return true;
        }
    }

    /* renamed from: a */
    public boolean mo57669a(File file, String str, List<String> list, C8393e eVar) {
        return m26023a(file, str, list, true, eVar);
    }

    /* renamed from: b */
    public boolean mo57670b(String str, Context context) {
        boolean z;
        synchronized (this.f21601d) {
            File a = mo57665a(str, context);
