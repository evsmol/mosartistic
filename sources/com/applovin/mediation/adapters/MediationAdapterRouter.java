...
public abstract class MediationAdapterRouter {
    ...
    protected MediationAdapterRouter() {
        if (AppLovinMediationProvider.MAX.equalsIgnoreCase(C8490n.f21321a.mo57405u())) {
            this.mSdk = C8490n.f21321a;
        } else {
            C8626v.m26258i(this.mTag, "Invalid mediation provider detected. Please set AppLovin SDK mediation provider to MAX via AppLovinSdk.getInstance(context).setMediationProvider( AppLovinMediationProvider.MAX )");
        }
    }
    ...
    public void log(String str) {
        C8490n nVar = this.mSdk;
        if (nVar != null) {
            nVar.mo57320D();
            if (C8626v.m26252a()) {
                this.mSdk.mo57320D().mo57820c(this.mTag, str);
            }
        }
    }
    ...
    public void log(String str, Throwable th) {
        ...
        if (nVar != null) {
            nVar.mo57320D();
            if (C8626v.m26252a()) {
                this.mSdk.mo57320D().mo57819b(this.mTag, str, th);
            }
        }
    }
