...
public class AppLovinAdapterNativeAd extends MaxNativeAd {
    ...
    public boolean prepareForInteraction(List<View> list, ViewGroup viewGroup) {
        ...
        if (appLovinNativeAdImpl == null) {
            this.parentAdapter.mo57874e("Failed to register native ad views: native ad is null");
            return false;
        }
        AppLovinMediationAdapter appLovinMediationAdapter = this.parentAdapter;
        appLovinMediationAdapter.mo57873d("Preparing views for interaction: " + list + " with container: " + viewGroup);
    ...
    public void prepareViewForInteraction(MaxNativeAdView maxNativeAdView) {
        AppLovinNativeAdImpl appLovinNativeAdImpl = (AppLovinNativeAdImpl) this.parentAdapter.loadedNativeAd;
        if (appLovinNativeAdImpl == null) {
            this.parentAdapter.mo57874e("Failed to register native ad view for interaction. Native ad is null");
            return;
        }
        AppLovinMediationAdapter appLovinMediationAdapter = this.parentAdapter;
        appLovinMediationAdapter.mo57873d("Preparing view for interaction: " + maxNativeAdView);
        ...
        if (StringUtils.isValidString(getTitle()) && maxNativeAdView.getTitleTextView() != null) {
            ...
            appLovinMediationAdapter2.mo57873d("Adding title TextView: " + maxNativeAdView.getTitleTextView());
        ...
        if (StringUtils.isValidString(getAdvertiser()) && maxNativeAdView.getAdvertiserTextView() != null) {
            ...
            appLovinMediationAdapter3.mo57873d("Adding advertiser TextView: " + maxNativeAdView.getAdvertiserTextView());
        ...
        if (StringUtils.isValidString(getBody()) && maxNativeAdView.getBodyTextView() != null) {
            ...
            appLovinMediationAdapter4.mo57873d("Adding body TextView: " + maxNativeAdView.getBodyTextView());
        ...
        if (StringUtils.isValidString(getCallToAction()) && maxNativeAdView.getCallToActionButton() != null) {
            ...
            appLovinMediationAdapter5.mo57873d("Adding CTA button: " + maxNativeAdView.getCallToActionButton());
            AppLovinMediationAdapter appLovinMediationAdapter6 = this.parentAdapter;
            appLovinMediationAdapter6.mo57873d("CTA button is clickable: " + maxNativeAdView.getCallToActionButton().isClickable());
            AppLovinMediationAdapter appLovinMediationAdapter7 = this.parentAdapter;
            appLovinMediationAdapter7.mo57873d("CTA button is enabled: " + maxNativeAdView.getCallToActionButton().isEnabled());
            AppLovinMediationAdapter appLovinMediationAdapter8 = this.parentAdapter;
            appLovinMediationAdapter8.mo57873d("CTA button has onClickListeners: " + maxNativeAdView.getCallToActionButton().hasOnClickListeners());
            arrayList.add(maxNativeAdView.getCallToActionButton());
        }
        if (!(getIcon() == null || maxNativeAdView.getIconImageView() == null)) {
            AppLovinMediationAdapter appLovinMediationAdapter9 = this.parentAdapter;
            appLovinMediationAdapter9.mo57873d("Adding icon image view: " + maxNativeAdView.getIconImageView());
