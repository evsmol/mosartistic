...
public final class OSInfluenceDataRepository {
    ...
    public final OSInfluenceType getNotificationCachedInfluenceType() {
        OSSharedPreferences oSSharedPreferences = this.preferences;
        return OSInfluenceType.Companion.fromString(oSSharedPreferences.getString(oSSharedPreferences.getPreferencesName(), "PREFS_OS_OUTCOMES_CURRENT_SESSION", OSInfluenceType.UNATTRIBUTED.toString()));
    }
    ...
    public final OSInfluenceType getIamCachedInfluenceType() {
        ...
        OSSharedPreferences oSSharedPreferences = this.preferences;
        return OSInfluenceType.Companion.fromString(oSSharedPreferences.getString(oSSharedPreferences.getPreferencesName(), "PREFS_OS_OUTCOMES_CURRENT_IAM_INFLUENCE", oSInfluenceType));
    }
