    ...
    public final JSONArray getLastReceivedIds() {
        ...
        try {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (currentTimeMillis - jSONObject.getLong(C8850d.f22432fl) <= indirectAttributionWindow) {
    ...
    public final void saveLastId(String str) {
        ...
        if (str != null) {
            if (!(str.length() == 0)) {
                ...
                try {
                    lastChannelObjectsReceivedByNewId.put(new JSONObject().put(getIdTag(), str).put(C8850d.f22432fl, this.timeProvider.getCurrentTimeMillis()));
