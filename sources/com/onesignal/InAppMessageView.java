...
class InAppMessageView {
    ...
    static /* synthetic */ class C50129 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.onesignal.InAppMessageView.C50129.<clinit>():void");
        }
    }
    ...
    private RelativeLayout.LayoutParams createParentRelativeLayoutParams() {
        ...
        int i = C50129.$SwitchMap$com$onesignal$WebViewManager$Position[this.displayLocation.ordinal()];
        if (i == 1) {
    ...
    public DraggableRelativeLayout.Params createDraggableLayoutParams(int i, WebViewManager.Position position, boolean z) {
        ...
        int i2 = C50129.$SwitchMap$com$onesignal$WebViewManager$Position[position.ordinal()];
        int i3 = 1;
        if (i2 == 1) {
    ...
    public void createPopupWindow(android.widget.RelativeLayout r5) {
        ...
        L_0x0011:
            ...
            int[] r5 = com.onesignal.InAppMessageView.C50129.$SwitchMap$com$onesignal$WebViewManager$Position
    ...
    public void animateInAppMessage(WebViewManager.Position position, View view, View view2) {
        ...
        int i = C50129.$SwitchMap$com$onesignal$WebViewManager$Position[position.ordinal()];
        if (i == 1) {
