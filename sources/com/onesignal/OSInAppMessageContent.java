...
public class OSInAppMessageContent {
    ...
    public OSInAppMessageContent(JSONObject jSONObject) {
        ...
        this.useWidthMargin = !(optJSONObject != null ? optJSONObject.optBoolean("remove_width_margin", false) : z);
