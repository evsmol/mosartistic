...
class GenerateNotification {
    ...
    private static Intent getNewBaseDismissIntent(int i) {
        return new Intent(currentContext, notificationDismissedClass).putExtra("androidNotificationId", i).putExtra("dismissed", true);
    }
    ...
    private static Notification createGenericPendingIntentsForNotif(NotificationCompat.Builder builder, IntentGeneratorForAttachingToNotifications intentGeneratorForAttachingToNotifications, JSONObject jSONObject, int i) {
        ...
        builder.setContentIntent(intentGeneratorForAttachingToNotifications.getNewActionPendingIntent(secureRandom.nextInt(), intentGeneratorForAttachingToNotifications.getNewBaseIntent(i).putExtra("onesignalData", jSONObject.toString())));
    ...
    private static void createGenericPendingIntentsForGroup(NotificationCompat.Builder builder, IntentGeneratorForAttachingToNotifications intentGeneratorForAttachingToNotifications, JSONObject jSONObject, String str, int i) {
        SecureRandom secureRandom = new SecureRandom();
        builder.setContentIntent(intentGeneratorForAttachingToNotifications.getNewActionPendingIntent(secureRandom.nextInt(), intentGeneratorForAttachingToNotifications.getNewBaseIntent(i).putExtra("onesignalData", jSONObject.toString()).putExtra("grp", str)));
    ...
    private static void createSummaryNotification(OSNotificationGenerationJob oSNotificationGenerationJob, OneSignalNotificationBuilder oneSignalNotificationBuilder) {
        ...
        try {
            ...
            try {
                ...
                Cursor query = instance.query("notification", strArr, str, strArr2, (String) null, (String) null, "_id DESC");
                try {
                    str2 = "";
                    if (query.moveToFirst()) {
                        ...
                        while (true) {
                            ...
                            if (query.getInt(query.getColumnIndex(str10)) == 1) {
                                ...
                                if (str11 == null) {
                                    str11 = query.getString(query.getColumnIndex("full_data"));
                                }
                            }
                            str7 = str11;
                            if (!query.moveToNext()) {
    ...
    private static Intent createBaseSummaryIntent(int i, IntentGeneratorForAttachingToNotifications intentGeneratorForAttachingToNotifications, JSONObject jSONObject, String str) {
        return intentGeneratorForAttachingToNotifications.getNewBaseIntent(i).putExtra("onesignalData", jSONObject.toString()).putExtra("summary", str);
    }
