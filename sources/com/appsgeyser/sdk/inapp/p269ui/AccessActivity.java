package com.appsgeyser.sdk.inapp.p269ui;
...
import com.appsgeyser.sdk.inapp.p269ui.AccessActivity;
import com.google.android.material.snackbar.Snackbar;
import p156rx.functions.Action1;

/* renamed from: com.appsgeyser.sdk.inapp.ui.AccessActivity */
        ...
        PurchaseController.getInstance().purchaseAccess(this, new PurchaseController.PurchaseListener() {
            public void onSuccessPurchase() {
                AccessActivity.this.runOnUiThread(new Runnable() {
                    public final void run() {
                        AccessActivity.C100411.this.lambda$onSuccessPurchase$0$AccessActivity$1();
                    }
                });
            }
            ...
            public void onErrorPurchase(String str) {
                AccessActivity.this.runOnUiThread(new Runnable() {
                    public final void run() {
                        AccessActivity.C100411.this.lambda$onErrorPurchase$1$AccessActivity$1();
                    }
                });
            }
