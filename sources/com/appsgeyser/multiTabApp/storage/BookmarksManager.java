...
public class BookmarksManager extends SQLiteOpenHelper {
    ...
    public BookmarksManager(String str, Context context) {
        ...
        this.BOOKMARKS_TABLE_CREATE = "CREATE TABLE " + this.BOOKMARKS_TABLE_NAME + " (" + "id" + " integer primary key autoincrement, " + AppMeasurementSdk.ConditionalUserProperty.NAME + " TEXT, " + "url" + " TEXT);";
        this._name = str;
    }
