...
import com.appsgeyser.multiTabApp.p268ui.dialog.SimpleDialogs;
import com.appsgeyser.multiTabApp.p268ui.menu.MenuItemsHolder;
import com.appsgeyser.multiTabApp.p268ui.navigationdrawerwidget.NavigationDrawerWidget;
import com.appsgeyser.multiTabApp.p268ui.navigationwidget.INavigationWidget;
import com.appsgeyser.multiTabApp.p268ui.navigationwidget.NavigationWidget;
import com.appsgeyser.multiTabApp.p268ui.navigationwidget.TopNavigationWidget;
    ...
    public /* synthetic */ void lambda$onPostCreate$2$MainNavigationActivity(Status status) {
        runOnUiThread(new Runnable(status) {
            ...
            public final void run() {
                MainNavigationActivity.this.lambda$null$1$MainNavigationActivity(this.f$1);
            }
        });
    }

    public /* synthetic */ void lambda$null$1$MainNavigationActivity(Status status) {
