...
public class SuggestionsHandler extends DefaultHandler {
    ...
    private final String XML_ATTRIBUTE_DATA = C8849c.DATA;
    ...
    public void startElement(String str, String str2, String str3, Attributes attributes) throws SAXException {
        ...
        if (this.results.size() < this.capacity && str3 != null && attributes != null && str3.equals("suggestion") && (value = attributes.getValue(C8849c.DATA)) != null) {
