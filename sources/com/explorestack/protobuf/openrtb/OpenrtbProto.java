...
public final class OpenrtbProto {
    ...
    static final GeneratedMessageV3.FieldAccessorTable f4835xb3401854;
    ...
    static {
        ...
        f4819x8296282d = new GeneratedMessageV3.FieldAccessorTable(descriptor2, new String[]{"Ver", "Domainspec", "Domainver", "Request", LogConstants.EVENT_RESPONSE, "Payload"});
        Descriptors.Descriptor descriptor3 = getDescriptor().getMessageTypes().get(1);
        internal_static_bidmachine_protobuf_openrtb_Request_descriptor = descriptor3;
        f4828x197a58d4 = new GeneratedMessageV3.FieldAccessorTable(descriptor3, new String[]{"Id", "Test", "Tmax", "At", "Cur", "Seat", "Wseat", "Cdata", "Source", "Item", "Package", "Context", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor4 = internal_static_bidmachine_protobuf_openrtb_Request_descriptor.getNestedTypes().get(0);
        f4826x2fe25b2c = descriptor4;
        f4827x208995aa = new GeneratedMessageV3.FieldAccessorTable(descriptor4, new String[]{"Tid", "Ds", "Dsgver", "Digest", "Cert", "Pchain", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor5 = internal_static_bidmachine_protobuf_openrtb_Request_descriptor.getNestedTypes().get(1);
        f4824x6653af74 = descriptor5;
        f4825x7da621f2 = new GeneratedMessageV3.FieldAccessorTable(descriptor5, new String[]{"Id", "Qty", "Seq", "Flr", "Flrcur", "Exp", "Dt", "Dlvy", "Metric", "Deal", "Private", "Spec", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor6 = f4824x6653af74.getNestedTypes().get(0);
        f4822xdecf8999 = descriptor6;
        f4823xff8c0717 = new GeneratedMessageV3.FieldAccessorTable(descriptor6, new String[]{"Type", "Value", "Vendor", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor7 = f4824x6653af74.getNestedTypes().get(1);
        f4820x3226081d = descriptor7;
        f4821xbecdc19b = new GeneratedMessageV3.FieldAccessorTable(descriptor7, new String[]{"Id", "Flr", "Flrcur", "At", "Wseat", "Wadomain", "Ext", "ExtProto"});
        ...
        f4835xb3401854 = new GeneratedMessageV3.FieldAccessorTable(descriptor8, new String[]{"Id", "Bidid", "Nbr", "Cur", "Cdata", "Seatbid", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor9 = internal_static_bidmachine_protobuf_openrtb_Response_descriptor.getNestedTypes().get(0);
        f4833xcd91b6bd = descriptor9;
        f4834xed70d03b = new GeneratedMessageV3.FieldAccessorTable(descriptor9, new String[]{"Seat", "Package", "Bid", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor10 = f4833xcd91b6bd.getNestedTypes().get(0);
        f4831xabe1f45f = descriptor10;
        f4832x9d824bdd = new GeneratedMessageV3.FieldAccessorTable(descriptor10, new String[]{"Id", "Item", "Price", "Deal", "Cid", "Tactic", "Purl", "Burl", "Lurl", "Exp", "Mid", "Macro", "Media", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor11 = f4831xabe1f45f.getNestedTypes().get(0);
        f4829x46766d2 = descriptor11;
        f4830xb5339b50 = new GeneratedMessageV3.FieldAccessorTable(descriptor11, new String[]{"Key", "Value", "Ext", "ExtProto"});
