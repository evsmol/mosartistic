...
final class ArrayDecoders {
    ...
    static int decodeVarint32(int i, byte[] bArr, int i2, Registers registers) {
        ...
        byte b2 = bArr[i4];
        if (b2 >= 0) {
            registers.int1 = i5 | (b2 << Ascii.f15552SO);
            return i6;
        }
        int i7 = i5 | ((b2 & Ascii.DEL) << Ascii.f15552SO);
        int i8 = i6 + 1;
        byte b3 = bArr[i6];
        if (b3 >= 0) {
        ...
        byte b4 = bArr[i8];
        if (b4 >= 0) {
            registers.int1 = i9 | (b4 << Ascii.f15545FS);
            return i10;
        }
        int i11 = i9 | ((b4 & Ascii.DEL) << Ascii.f15545FS);
        while (true) {
            int i12 = i10 + 1;
            if (bArr[i10] < 0) {
                i10 = i12;
    ...
    static int decodeExtension(int r7, byte[] r8, int r9, int r10, com.explorestack.protobuf.GeneratedMessageLite.ExtendableMessage<?, ?> r11, com.explorestack.protobuf.GeneratedMessageLite.GeneratedExtension<?, ?> r12, com.explorestack.protobuf.UnknownFieldSchema<com.explorestack.protobuf.UnknownFieldSetLite, com.explorestack.protobuf.UnknownFieldSetLite> r13, com.explorestack.protobuf.ArrayDecoders.Registers r14) throws java.io.IOException {
        /*
            ...
            if (r1 == 0) goto L_0x00fb
            int[] r10 = com.explorestack.protobuf.ArrayDecoders.C14841.$SwitchMap$com$google$protobuf$WireFormat$FieldType
        ...
        L_0x0129:
            ...
            goto L_0x0201
        L_0x0131:
            int[] r11 = com.explorestack.protobuf.ArrayDecoders.C14841.$SwitchMap$com$google$protobuf$WireFormat$FieldType
        ...
        L_0x0201:
            ...
            goto L_0x0233
        L_0x020d:
            int[] r7 = com.explorestack.protobuf.ArrayDecoders.C14841.$SwitchMap$com$google$protobuf$WireFormat$FieldType
    ...
    static /* synthetic */ class C14841 {
        ...
        static {
            ...
            L_0x00d8:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.explorestack.protobuf.ArrayDecoders.C14841.<clinit>():void");
        }
    }
