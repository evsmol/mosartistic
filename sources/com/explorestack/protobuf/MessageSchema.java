...
final class MessageSchema<T> implements Schema<T> {
    ...
    static <T> MessageSchema<T> newSchemaForMessageInfo(StructuralMessageInfo structuralMessageInfo, NewInstanceSchema newInstanceSchema2, ListFieldSchema listFieldSchema2, UnknownFieldSchema<?, ?> unknownFieldSchema2, ExtensionSchema<?> extensionSchema2, MapFieldSchema mapFieldSchema2) {
        ...
        for (FieldInfo fieldInfo : fields) {
            if (fieldInfo.getType() == FieldType.MAP) {
                i4++;
            } else if (fieldInfo.getType().mo6581id() >= 18 && fieldInfo.getType().mo6581id() <= 49) {
                i5++;
            }
        }
        int[] iArr2 = null;
        ...
        while (i6 < fields.length) {
            ...
            if (fieldInfo2.getType() == FieldType.MAP) {
                iArr3[i9] = i7;
                i9++;
            } else if (fieldInfo2.getType().mo6581id() >= 18 && fieldInfo2.getType().mo6581id() <= 49) {
                i3 = i7;
    ...
    static /* synthetic */ class C15711 {
        ...
        static {
            ...
            L_0x00cc:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.explorestack.protobuf.MessageSchema.C15711.<clinit>():void");
        }
    }
    ...
    private int decodeMapEntryValue(byte[] r2, int r3, int r4, com.explorestack.protobuf.WireFormat.FieldType r5, java.lang.Class<?> r6, com.explorestack.protobuf.ArrayDecoders.Registers r7) throws java.io.IOException {
        /*
            r1 = this;
            int[] r0 = com.explorestack.protobuf.MessageSchema.C15711.$SwitchMap$com$google$protobuf$WireFormat$FieldType
            int r5 = r5.ordinal()
            r5 = r0[r5]
            switch(r5) {
