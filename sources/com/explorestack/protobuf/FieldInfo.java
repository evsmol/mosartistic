...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    static /* synthetic */ class C15471 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.explorestack.protobuf.FieldInfo.C15471.<clinit>():void");
        }
    }

    public Class<?> getMessageFieldClass() {
        int i = C15471.$SwitchMap$com$google$protobuf$FieldType[this.type.ordinal()];
        if (i == 1 || i == 2) {
    ...
    public static Builder newBuilder() {
        return new Builder((C15471) null);
    }
