...
public class C1473a {
    /* renamed from: a */
    public static VastTag m6612a(InputStream inputStream) {
        if (inputStream != null) {
            ...
            if (next != 1) {
                while (next != 3 && next != 1) {
                    if (newPullParser.getEventType() == 2 && VastXmlTag.m6590a(newPullParser.getName(), "VAST")) {
    ...
    public static com.explorestack.iab.vast.tags.VastTag m6613a(java.lang.String r4) {
        /*
            ...
            com.explorestack.iab.vast.tags.VastTag r4 = m6612a((java.io.InputStream) r2)     // Catch:{ Exception -> 0x002d, all -> 0x002b }
            r2.close()     // Catch:{ Exception -> 0x0022 }
            goto L_0x002a
        L_0x0022:
            r1 = move-exception
            java.lang.String r2 = r1.getMessage()
            com.explorestack.iab.vast.VastLog.m6352a(r0, r2, r1)
        L_0x002a:
            return r4
        L_0x002b:
            r4 = move-exception
        ...
        L_0x0033:
            ...
            com.explorestack.iab.vast.VastLog.m6352a(r0, r2, r4)     // Catch:{ all -> 0x0030 }
        ...
        L_0x0050:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.explorestack.iab.vast.tags.C1473a.m6613a(java.lang.String):com.explorestack.iab.vast.tags.VastTag");
    }
}
