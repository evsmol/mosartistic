...
class C6308g1 {
    ...
    /* renamed from: a */
    private static int f13538a;

    /* renamed from: b */
    private static int f13539b;

    /* renamed from: c */
    private static int f13540c;

    /* renamed from: d */
    private static int f13541d;

    /* renamed from: com.adcolony.sdk.g1$a */
    private static class C6309a {
        /* renamed from: a */
        static int m15319a(WindowManager windowManager) {
    ...
    private static class C6310b {
        /* renamed from: a */
        static int m15320a(WindowManager windowManager) {
            Point point = new Point();
            windowManager.getDefaultDisplay().getSize(point);
            return point.x;
        }
    ...
    static float m15310a(android.view.View r9, android.content.Context r10, boolean r11, boolean r12, boolean r13, boolean r14) {
        /*
            r0 = 0
        ...
        L_0x0007:
            ...
            float r1 = m15316b((android.view.View) r9)
        ...
        L_0x002c:
            ...
            int r7 = r7 + r8
            r6[r2] = r7
            int r7 = m15313a((android.content.Context) r10)
            int r10 = m15317b((android.content.Context) r10)
            r8 = r6[r1]
        ...
        L_0x0092:
            ...
            float r9 = m15311a(r9, r3, r10, r1)     // Catch:{ Exception -> 0x00b3 }
        ...
        L_0x00c3:
            ...
            r8 = r3[r2]
            r4.<init>(r5, r6, r7, r8)
            int r5 = m15313a((android.content.Context) r10)
            int r10 = m15317b((android.content.Context) r10)
            r6 = r3[r1]
        ...
        L_0x011c:
            ...
            float r9 = m15311a(r9, r4, r10, r2)     // Catch:{ Exception -> 0x0138 }
        ...
        L_0x0147:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.adcolony.sdk.C6308g1.m15310a(android.view.View, android.content.Context, boolean, boolean, boolean, boolean):float");
    }

    /* renamed from: b */
    private static float m15316b(View view) {
        if (view == null) {
            return 0.0f;
        }
        if (m15312a() < 11) {
    ...
    /* renamed from: c */
    private static boolean m15318c(View view) {
        if (view == null) {
            return false;
        }
        if (view.getBackground() == null || (m15312a() > 18 && view.getBackground().getAlpha() == 0)) {
            return true;
        }
        return false;
    }
    ...
    /* renamed from: b */
    private static int m15317b(Context context) {
        int i;
        int i2;
        int i3;
        int i4 = context != null ? context.getResources().getConfiguration().orientation : -1;
        if (i4 == 2 && (i3 = f13539b) > 0) {
            return i3;
        }
        if (i4 == 1 && (i2 = f13541d) > 0) {
            return i2;
        }
        try {
            WindowManager windowManager = (WindowManager) context.getApplicationContext().getSystemService("window");
            if (m15312a() >= 13) {
                i = C6310b.m15320a(windowManager);
            } else {
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static float m15311a(android.view.View r11, android.graphics.Rect r12, float r13, boolean r14) {
        /*
        ...
        L_0x0035:
            ...
            float r8 = m15316b((android.view.View) r5)
        ...
        L_0x00a9:
            ...
            boolean r10 = m15318c(r9)
            if (r10 != 0) goto L_0x00cc
            int r10 = r9.getVisibility()
            if (r10 != 0) goto L_0x00a9
            float r10 = m15316b((android.view.View) r9)
            int r10 = (r10 > r7 ? 1 : (r10 == r7 ? 0 : -1))
            if (r10 == 0) goto L_0x00a9
            r3.addFirst(r9)
            goto L_0x00a9
        L_0x00cc:
            java.util.ArrayList r9 = m15315a((android.view.View) r9)
        ...
        L_0x0173:
            ...
            android.graphics.Rect r8 = m15314a(r1, r12, r3)
            int r9 = r8.height()
        ...
        L_0x01b9:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.adcolony.sdk.C6308g1.m15311a(android.view.View, android.graphics.Rect, float, boolean):float");
    }

    /* renamed from: a */
    private static Rect m15314a(Rect rect, Rect rect2, int i) {
        Rect rect3 = new Rect();
        switch (i) {
            case 1:
    ...
    /* renamed from: a */
    private static ArrayList<View> m15315a(View view) {
        if ((view instanceof ViewGroup) && view.getVisibility() == 0 && m15316b(view) != 0.0f) {
            ...
            while (listIterator.hasNext()) {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    if (childAt.getVisibility() == 0 && m15316b(childAt) != 0.0f) {
    ...
    /* renamed from: a */
    private static int m15313a(Context context) {
        int i;
        int i2;
        int i3;
        int i4 = context != null ? context.getResources().getConfiguration().orientation : -1;
        if (i4 == 2 && (i3 = f13538a) > 0) {
            return i3;
        }
        if (i4 == 1 && (i2 = f13540c) > 0) {
            return i2;
        }
        try {
            WindowManager windowManager = (WindowManager) context.getApplicationContext().getSystemService("window");
            if (m15312a() >= 13) {
                i = C6309a.m15319a(windowManager);
            } else {
