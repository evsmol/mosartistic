    ...
    static /* synthetic */ class C65351 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.amazon.device.ads.MraidStateType.C65351.<clinit>():void");
        }
    }

    public String toString() {
        int i = C65351.$SwitchMap$com$amazon$device$ads$MraidStateType[ordinal()];
        if (i == 1) {
            return "loading";
        }
        if (i == 2) {
