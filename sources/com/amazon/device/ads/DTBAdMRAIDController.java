...
abstract class DTBAdMRAIDController implements DTBActivityListener {
    ...
    static /* synthetic */ class C65222 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.amazon.device.ads.DTBAdMRAIDController.C65222.<clinit>():void");
        }
    }

    private MraidProperty getCurrentStateProperty() {
        int i = C65222.$SwitchMap$com$amazon$device$ads$MraidStateType[this.state.ordinal()];
        if (i == 1) {
    ...
    public void setCloseIndicatorContent(View.OnTouchListener onTouchListener) {
        ...
        this.closeIndicatorRegion.setId(C6536R.C6539id.mraid_close_indicator);
        ImageView imageView = new ImageView(getAdView().getContext());
        imageView.setId(C6536R.C6539id.mraid_close_indicator);
        ...
        if (getDtbOmSdkSessionManager() != null) {
            getDtbOmSdkSessionManager().addFriendlyObstruction(this.closeIndicatorRegion.findViewById(C6536R.C6539id.mraid_close_indicator), FriendlyObstructionPurpose.CLOSE_AD);
        }
        imageView.setImageDrawable(AppCompatResources.getDrawable(getAdView().getContext(), C6536R.C6538drawable.mraid_close));
