...
public final class DTBAdResponse {
    ...
    private String getAmazonInfo() {
        ...
        int i = C65241.$SwitchMap$com$amazon$device$ads$AdType[dTBAdSize.getDTBAdType().ordinal()];
        if (i == 1) {
            str = "video";
        } else if (i == 2) {
            str = "banner";
    ...
    static /* synthetic */ class C65241 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.amazon.device.ads.DTBAdResponse.C65241.<clinit>():void");
        }
    }
