...
public class DTBInterstitialActivity extends Activity implements DTBMRAIDCloseButtonListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            setContentView(C6536R.layout.mdtb_interstitial_ad);
            if (getIntent() != null) {
            ...
            RelativeLayout relativeLayout = (RelativeLayout) findViewById(C6536R.C6539id.inter_container);
            ...
            LinearLayout linearLayout = (LinearLayout) findViewById(C6536R.C6539id.mraid_close_indicator);
            ...
            if (controller.getDtbOmSdkSessionManager() != null) {
                controller.getDtbOmSdkSessionManager().addFriendlyObstruction(linearLayout.findViewById(C6536R.C6539id.mraid_close_indicator), FriendlyObstructionPurpose.CLOSE_AD);
            }
            ...
            imageView.setImageDrawable(AppCompatResources.getDrawable(this, C6536R.C6538drawable.mraid_close));
    ...
    public /* synthetic */ void lambda$useCustomButtonUpdated$0$DTBInterstitialActivity() {
        findViewById(C6536R.C6539id.mraid_close_indicator).setVisibility(getUseCustomClose() ? 4 : 0);
    }
