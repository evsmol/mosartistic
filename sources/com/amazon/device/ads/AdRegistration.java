...
public class AdRegistration {
    ...
    public static class SlotGroup {
        ...
        public DTBAdSize getSizeByBannerType(DTBBannerType dTBBannerType) {
            try {
                int i = C65191.$SwitchMap$com$amazon$device$ads$DTBBannerType[dTBBannerType.ordinal()];
                if (i == 1) {
        ...
        public DTBAdSize getSizeBySlotType(DTBSlotType dTBSlotType) {
            try {
                int i = C65191.$SwitchMap$com$amazon$device$ads$DTBSlotType[dTBSlotType.ordinal()];
                int i2 = 50;
                int i3 = 320;
                if (i == 1) {
                    return getSizeByWidthAndHeight(320, 50);
                ...
                if (i == 2) {
                    return getSizeByWidthAndHeight(C5643c.COLLECT_MODE_FINANCE, IronSourceConstants.INTERSTITIAL_DAILY_CAPPED);
                }
                if (i == 3) {
                    return getSizeByWidthAndHeight(728, 90);
                }
    ...
    static /* synthetic */ class C65191 {
        ...
        static {
            ...
            L_0x004e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.amazon.device.ads.AdRegistration.C65191.<clinit>():void");
        }
    }
