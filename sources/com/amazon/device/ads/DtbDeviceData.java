...
final class DtbDeviceData {
    ...
    private String generateSha1Hash(String str) throws NoSuchAlgorithmException {
        ...
        for (byte b : digest) {
            sb.append(Integer.toHexString((b & 255) | Ascii.NUL).substring(1));
        }
        return sb.toString();
    }
    ...
    private void getUserAgent() {
        try {
            this.f13979ua = WebSettings.getDefaultUserAgent(AdRegistration.getContext());
        } catch (Exception unused) {
            DtbLog.info("Unable to Get User Agent, Setting it to default");
            this.f13979ua = "Android";
        }
    }

    /* access modifiers changed from: package-private */
    public String getUserAgentString() {
        return this.f13979ua;
    }
