...
final class Utils {
    ...
    static int calculateMemoryCacheSize(Context context) {
        ...
        return (int) ((((long) ((context.getApplicationInfo().flags & 1048576) != 0 ? activityManager.getLargeMemoryClass() : activityManager.getMemoryClass())) * C8850d.f22423fc) / 7);
    }
