...
import com.ironsource.mediationsdk.C4448D;
...
public class IronSourceUtils {
    ...
    public static String getDeviceType(Context context) {
        return C4407h.m12549c(context) ? "Tablet" : "Phone";
    }

    public static boolean getFirstSession(Context context) {
        if (mFirstSession == null) {
            mFirstSession = Boolean.valueOf(!C4448D.m12635b(context));
        }
    ...
    public static C4454G getIronSourceAdvId(Context context) {
        String str;
        if (context == null) {
            return null;
        }
        C4455H.m12683a();
        String a = C4455H.m12685a(context);
    ...
    public static String getMediationUserId() {
        return C4675e.m13718a().mo34127a(DataKeys.USER_ID);
    }

    public static JSONObject getProviderAdditionalData(C4605b bVar) {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put("providerPriority", bVar.f11370n);
            jSONObject.put("spId", bVar.f11362f);
            jSONObject.put(IronSourceConstants.EVENTS_PROVIDER, !TextUtils.isEmpty(bVar.f11363g) ? bVar.f11363g : bVar.mo33867j());
            jSONObject.put("providerSDKVersion", bVar.f11358b.getCoreSDKVersion());
            jSONObject.put("providerAdapterVersion", bVar.f11358b.getVersion());
        } catch (Exception e) {
            IronSourceLoggerManager logger = IronSourceLoggerManager.getLogger();
            IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.NATIVE;
            logger.logException(ironSourceTag, "IronSourceUtils:getProviderAdditionalData(adapter: " + bVar.mo33867j() + ")", e);
        }
        return jSONObject;
    }

    public static JSONObject getProviderAdditionalData(C4636l lVar) {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put("spId", lVar.f11532b.getSubProviderId());
            jSONObject.put(IronSourceConstants.EVENTS_PROVIDER, !TextUtils.isEmpty(lVar.f11532b.getAdSourceNameForEvents()) ? lVar.f11532b.getAdSourceNameForEvents() : lVar.mo33948a());
            jSONObject.put("providerSDKVersion", lVar.f11531a.getCoreSDKVersion());
            jSONObject.put("providerAdapterVersion", lVar.f11531a.getVersion());
            jSONObject.put("providerPriority", lVar.f11536f);
        } catch (Exception e) {
            IronSourceLoggerManager logger = IronSourceLoggerManager.getLogger();
            IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.NATIVE;
            logger.logException(ironSourceTag, "IronSourceUtils:getProviderAdditionalData(adapter: " + lVar.mo33948a() + ")", e);
        }
        return jSONObject;
    }
    ...
    public static String getTransId(long j, String str) {
        return getSHA256(String.format("%s%s%s", new Object[]{Long.valueOf(j), C4455H.m12683a().f10652j, str}));
    }

    public static String getUserIdForNetworks() {
        String a = C4675e.m13718a().mo34127a("userIdType");
        String a2 = C4675e.m13718a().mo34127a(DataKeys.USER_ID);
