...
public class IronSourceNetwork {
    ...
    /* renamed from: a */
    private static C4925e f12022a;

    /* renamed from: b */
    private static C4960d f12023b;

    /* renamed from: c */
    private static JSONObject f12024c;

    /* renamed from: a */
    private static synchronized void m13913a() {
    ...
    public static synchronized void applyConsentInfo(JSONObject jSONObject) {
        synchronized (IronSourceNetwork.class) {
            if (f12022a != null) {
                if (jSONObject != null) {
                    f12022a.mo34613a(jSONObject);
                }
            }
        }
    }

    public static C4960d getInitListener() {
        return f12023b;
    }

    public static synchronized void getOfferWallCredits(C4961e eVar) {
        synchronized (IronSourceNetwork.class) {
            m13913a();
            f12022a.mo34603a(eVar);
        }
    }
    ...
    public static synchronized JSONObject getRawToken(Context context) {
        JSONObject b;
        synchronized (IronSourceNetwork.class) {
            b = C4980d.m14484a().mo34724b(context);
        }
        return b;
    }
    ...
    public static synchronized String getToken(Context context) {
        String a;
        synchronized (IronSourceNetwork.class) {
            a = C4980d.m14484a().mo34719a(context);
        }
        return a;
    }
    ...
    public static synchronized void initOfferWall(Map<String, String> map, C4961e eVar) {
        synchronized (IronSourceNetwork.class) {
            m13913a();
            f12022a.mo34612a(map, eVar);
        }
    }
    ...
    public static synchronized void initSDK(android.content.Context r6, java.lang.String r7, java.lang.String r8, java.util.Map<java.lang.String, java.lang.String> r9) {
        /*
            ...
            com.ironsource.sdk.utils.Logger.m14505e(r6, r7)     // Catch:{ all -> 0x00be }
            monitor-exit(r0)
            return
        L_0x0012:
            com.ironsource.sdk.e r1 = f12022a     // Catch:{ all -> 0x00be }
            ...
            r3.<init>(r4, r5)     // Catch:{ Exception -> 0x0099 }
            r1.add(r3)     // Catch:{ Exception -> 0x0099 }
            java.util.ArrayList<android.util.Pair<java.lang.String, java.lang.String>> r3 = r2.f10387f     // Catch:{ Exception -> 0x0099 }
            r3.addAll(r1)     // Catch:{ Exception -> 0x0099 }
            r1 = 0
            r2.f10386e = r1     // Catch:{ Exception -> 0x0099 }
            com.ironsource.a.a r3 = new com.ironsource.a.a     // Catch:{ Exception -> 0x0099 }
            r3.<init>(r2)     // Catch:{ Exception -> 0x0099 }
            boolean r2 = r3.f10377b     // Catch:{ Exception -> 0x0099 }
            ...
            r2.f12030a = r9     // Catch:{ Exception -> 0x0099 }
        L_0x008a:
            r2.f12032c = r6     // Catch:{ Exception -> 0x0099 }
            r2.f12033d = r8     // Catch:{ Exception -> 0x0099 }
            r2.f12031b = r7     // Catch:{ Exception -> 0x0099 }
            com.ironsource.sdk.a.b r9 = new com.ironsource.sdk.a.b     // Catch:{ Exception -> 0x0099 }
            r9.<init>(r2, r1)     // Catch:{ Exception -> 0x0099 }
            com.ironsource.sdk.p137a.C4747d.m13919a((com.ironsource.p116a.C4353a) r3, (com.ironsource.sdk.p137a.C4744b) r9)     // Catch:{ Exception -> 0x0099 }
            goto L_0x00b1
        L_0x0099:
            r9 = move-exception
            ...
            com.ironsource.sdk.utils.Logger.m14505e(r1, r9)     // Catch:{ all -> 0x00be }
        L_0x00b1:
            com.ironsource.sdk.e r6 = com.ironsource.sdk.p140d.C4908b.m14294a((java.lang.String) r7, (java.lang.String) r8, (android.content.Context) r6)     // Catch:{ all -> 0x00be }
            f12022a = r6     // Catch:{ all -> 0x00be }
            org.json.JSONObject r6 = f12024c     // Catch:{ all -> 0x00be }
    ...
    public static synchronized boolean isAdAvailableForInstance(C4751b bVar) {
        synchronized (IronSourceNetwork.class) {
            if (f12022a == null) {
                return false;
            }
            boolean a = f12022a.mo34614a(bVar);
            return a;
        }
    }

    public static synchronized void loadAd(Activity activity, C4751b bVar, Map<String, String> map) {
        synchronized (IronSourceNetwork.class) {
            m13913a();
            f12022a.mo34596a(activity, bVar, map);
        }
    }
    ...
    public static synchronized void setInitListener(C4960d dVar) {
        synchronized (IronSourceNetwork.class) {
            f12023b = dVar;
        }
    }

    public static synchronized void showAd(C4751b bVar, Map<String, String> map) {
        synchronized (IronSourceNetwork.class) {
            m13913a();
            f12022a.mo34598a(bVar, map);
        }
    }
    ...
    public static synchronized void updateMetadata(JSONObject jSONObject) {
        synchronized (IronSourceNetwork.class) {
            ...
            while (keys.hasNext()) {
                ...
                a.mo34722a("metadata_" + next, jSONObject.opt(next));
            }
        }
    }
}
