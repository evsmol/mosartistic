...
public final class C4364a extends SQLiteOpenHelper {

    /* renamed from: a */
    private static C4364a f10394a;

    /* renamed from: b */
    private final int f10395b = 4;

    /* renamed from: c */
    private final int f10396c = 400;

    /* renamed from: d */
    private final String f10397d = "DROP TABLE IF EXISTS events";

    /* renamed from: e */
    private final String f10398e = "CREATE TABLE events (_id INTEGER PRIMARY KEY,eventid INTEGER,timestamp INTEGER,type TEXT,data TEXT )";

    private C4364a(Context context, String str, int i) {
        super(context, str, (SQLiteDatabase.CursorFactory) null, i);
    }

    /* renamed from: a */
    private synchronized SQLiteDatabase m12407a(boolean z) {
        int i = 0;
        while (true) {
            if (z) {
                try {
    ...
    /* renamed from: a */
    public static synchronized C4364a m12408a(Context context, String str, int i) {
        C4364a aVar;
        synchronized (C4364a.class) {
            if (f10394a == null) {
                f10394a = new C4364a(context, str, 5);
            }
            aVar = f10394a;
        }
        return aVar;
    ...
    public final synchronized java.util.ArrayList<com.ironsource.mediationsdk.p126a.C4532c> mo33145a(java.lang.String r13) {
        /*
            r12 = this;
            monitor-enter(r12)
            ...
            r1 = 0
            r2 = 0
            android.database.sqlite.SQLiteDatabase r11 = r12.m12407a((boolean) r1)     // Catch:{ all -> 0x0079 }
        ...
        L_0x00b0:
            ...
            throw r13
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.p117b.C4364a.mo33145a(java.lang.String):java.util.ArrayList");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized void mo33146a(java.util.List<com.ironsource.mediationsdk.p126a.C4532c> r8, java.lang.String r9) {
        /*
            r7 = this;
            monitor-enter(r7)
        ...
        L_0x000b:
            r0 = 1
            r1 = 0
            android.database.sqlite.SQLiteDatabase r0 = r7.m12407a((boolean) r0)     // Catch:{ all -> 0x006d }
        ...
        L_0x0094:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.p117b.C4364a.mo33146a(java.util.List, java.lang.String):void");
    }

    /* renamed from: b */
    public final synchronized void mo33147b(String str) {
        SQLiteDatabase sQLiteDatabase = null;
        String[] strArr = {str};
        try {
            sQLiteDatabase = m12407a(true);
