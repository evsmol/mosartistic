...
public class AdView extends RelativeLayout implements C1715Ad {
    ...
    public interface AdViewLoadConfig extends C1715Ad.LoadAdConfig {
    }

    public interface AdViewLoadConfigBuilder extends C1715Ad.LoadConfigBuilder {
