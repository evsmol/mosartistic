...
public final class TypeAdapters {
    ...
    public static final TypeAdapterFactory ENUM_FACTORY = new TypeAdapterFactory() {
        ...
        public <T> com.google.gson.TypeAdapter<T> create(com.google.gson.Gson r1, com.google.gson.reflect.TypeToken<T> r2) {
            ...
            L_0x0021:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C407229.create(com.google.gson.Gson, com.google.gson.reflect.TypeToken):com.google.gson.TypeAdapter");
        }
    };
    ...
    static {
        ...
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() {
            public BitSet read(JsonReader jsonReader) throws IOException {
                ...
                while (peek != JsonToken.END_ARRAY) {
                    int i2 = C408035.$SwitchMap$com$google$gson$stream$JsonToken[peek.ordinal()];
                    boolean z = true;
                    if (i2 == 1 || i2 == 2) {
                        int nextInt = jsonReader.nextInt();
                        if (nextInt == 0) {
        ...
        C406119 r0 = new TypeAdapter<StringBuilder>() {
        ...
        C406320 r02 = new TypeAdapter<StringBuffer>() {
        ...
        C406421 r03 = new TypeAdapter<URL>() {
        ...
        C406522 r04 = new TypeAdapter<URI>() {
        ...
        C406623 r05 = new TypeAdapter<InetAddress>() {
        ...
        C406724 r06 = new TypeAdapter<UUID>() {
        ...
        C406926 r07 = new TypeAdapter<Calendar>() {
            public Calendar read(JsonReader jsonReader) throws IOException {
                ...
                while (jsonReader.peek() != JsonToken.END_OBJECT) {
                    ...
                    if ("year".equals(nextName)) {
                        ...
                        i4 = nextInt;
                    } else if (C8850d.f22429fi.equals(nextName)) {
                        i5 = nextInt;
                    } else if (C8850d.f22428fh.equals(nextName)) {
                        i6 = nextInt;
                    }
                }
            ...
            public void write(JsonWriter jsonWriter, Calendar calendar) throws IOException {
                ...
                jsonWriter.name(C8850d.f22429fi);
                jsonWriter.value((long) calendar.get(12));
                jsonWriter.name(C8850d.f22428fh);
        ...
        C407027 r08 = new TypeAdapter<Locale>() {
        ...
        C407128 r09 = new TypeAdapter<JsonElement>() {
            public JsonElement read(JsonReader jsonReader) throws IOException {
                if (jsonReader instanceof JsonTreeReader) {
                    return ((JsonTreeReader) jsonReader).nextJsonElement();
                }
                switch (C408035.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()]) {
                    case 1:
    ...
    static /* synthetic */ class C408035 {
        ...
        static {
            ...
            L_0x0078:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C408035.<clinit>():void");
        }
    }
    ...
    class C407430 implements TypeAdapterFactory {
