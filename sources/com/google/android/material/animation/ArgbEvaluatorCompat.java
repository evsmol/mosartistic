...
public class ArgbEvaluatorCompat implements TypeEvaluator<Integer> {
    ...
    public Integer evaluate(float f, Integer num, Integer num2) {
        ...
        float f2 = ((float) ((intValue >> 24) & KotlinVersion.MAX_COMPONENT_VALUE)) / 255.0f;
        ...
        float pow5 = pow3 + (f * (((float) Math.pow((double) (((float) (intValue2 & KotlinVersion.MAX_COMPONENT_VALUE)) / 255.0f), 2.2d)) - pow3));
        return Integer.valueOf((Math.round(((float) Math.pow((double) (pow + ((pow4 - pow) * f)), 0.45454545454545453d)) * 255.0f) << 16) | (Math.round((f2 + (((((float) ((intValue2 >> 24) & KotlinVersion.MAX_COMPONENT_VALUE)) / 255.0f) - f2) * f)) * 255.0f) << 24) | (Math.round(((float) Math.pow((double) (pow2 + ((((float) Math.pow((double) (((float) ((intValue2 >> 8) & KotlinVersion.MAX_COMPONENT_VALUE)) / 255.0f), 2.2d)) - pow2) * f)), 0.45454545454545453d)) * 255.0f) << 8) | Math.round(((float) Math.pow((double) pow5, 0.45454545454545453d)) * 255.0f));
    }
}
