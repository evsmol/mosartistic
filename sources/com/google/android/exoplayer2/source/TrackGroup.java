...
public final class TrackGroup implements Bundleable {
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            this.hashCode = ((IronSourceError.ERROR_NON_EXISTENT_INSTANCE + this.f4843id.hashCode()) * 31) + Arrays.hashCode(this.formats);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.length != trackGroup.length || !this.f4843id.equals(trackGroup.f4843id) || !Arrays.equals(this.formats, trackGroup.formats)) {
            return false;
        }
        return true;
    }
    ...
    static /* synthetic */ TrackGroup lambda$static$0(Bundle bundle) {
        return new TrackGroup(bundle.getString(keyForField(1), ""), (Format[]) BundleableUtil.fromBundleNullableList(Format.CREATOR, bundle.getParcelableArrayList(keyForField(0)), ImmutableList.m11239of()).toArray(new Format[0]));
    }
    ...
    private static void logErrorMessage(String str, String str2, String str3, int i) {
        ...
        sb.append(i);
        sb.append(")");
        Log.m6668e("TrackGroup", "", new IllegalStateException(sb.toString()));
    }
}
