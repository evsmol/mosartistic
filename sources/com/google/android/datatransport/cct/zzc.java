...
import com.google.android.datatransport.cct.p076a.zzaa;
import com.google.android.datatransport.cct.p076a.zzo;
import com.google.android.datatransport.cct.p076a.zzq;
import com.google.android.datatransport.cct.p076a.zzs;
import com.google.android.datatransport.cct.p076a.zzt;
import com.google.android.datatransport.cct.p076a.zzv;
import com.google.android.datatransport.cct.p076a.zzx;
...
final class zzc implements TransportBackend {
    ...
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        for (Map.Entry entry : hashMap.entrySet()) {
            ...
            for (EventInternal eventInternal2 : (List) entry.getValue()) {
                ...
                if (encoding.equals(Encoding.m6660of("proto"))) {
                    zza2 = zzt.zza(encodedPayload.getBytes());
                } else if (encoding.equals(Encoding.m6660of("json"))) {
                    zza2 = zzt.zza(new String(encodedPayload.getBytes(), Charset.forName("UTF-8")));
                } else {
                    Logging.m6666w("CctTransportBackend", "Received event of unsupported encoding %s. Skipping...", encoding);
                }
        ...
        try {
            ...
            if (zzb2.zza == 200) {
                return BackendResponse.m6661ok(zzb2.zzc);
            }
            int i = zzb2.zza;
            if (i < 500) {
                if (i != 404) {
            ...
            Logging.m6664e("CctTransportBackend", "Could not make request to the backend", e);
            return BackendResponse.transientError();
        }
    }
    ...
    public zzb zza(zza zza2) throws IOException {
        ...
        Logging.m6662d("CctTransportBackend", "Making request to: %s", (Object) zza2.zza);
        ...
        try {
            ...
            try {
                ...
                Logging.m6665i("CctTransportBackend", sb.toString());
                StringBuilder sb2 = new StringBuilder();
                sb2.append("Content-Type: ");
                sb2.append(httpURLConnection.getHeaderField("Content-Type"));
                Logging.m6665i("CctTransportBackend", sb2.toString());
                StringBuilder sb3 = new StringBuilder();
                sb3.append("Content-Encoding: ");
                sb3.append(httpURLConnection.getHeaderField("Content-Encoding"));
                Logging.m6665i("CctTransportBackend", sb3.toString());
                ...
                Logging.m6664e("CctTransportBackend", "Couldn't encode request, returning with 400", e);
    ...
    static /* synthetic */ zza zza(zza zza2, zzb zzb2) {
        ...
        Logging.m6662d("CctTransportBackend", "Following redirect to: %s", (Object) url);
