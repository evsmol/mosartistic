...
public final class zzr extends FastSafeParcelableJsonResponse implements Person {
    ...
    public static final class zzb extends FastSafeParcelableJsonResponse implements Person.Cover {
        ...
        public static final class C10730zzb extends FastSafeParcelableJsonResponse implements Person.Cover.CoverPhoto {
            public static final Parcelable.Creator<C10730zzb> CREATOR = new zzw();
            private static final HashMap<String, FastJsonResponse.Field<?, ?>> zzao;
            private final Set<Integer> zzap;
            private int zzbu;
            private int zzbv;
            ...
            C10730zzb(Set<Integer> set, int i, int i2, String str, int i3) {
                this.zzap = set;
                this.zzw = i;
                this.zzbu = i2;
                this.zzk = str;
            ...
            public final boolean equals(Object obj) {
                if (!(obj instanceof C10730zzb)) {
                    return false;
                }
                if (this == obj) {
                    return true;
                }
                C10730zzb zzb = (C10730zzb) obj;
                for (FastJsonResponse.Field next : zzao.values()) {
                    if (isFieldSet(next)) {
        ...
        static {
            ...
            zzao.put("coverPhoto", FastJsonResponse.Field.forConcreteType("coverPhoto", 3, C10730zzb.class));
        ...
        zzb(Set<Integer> set, int i, zza zza2, C10730zzb zzb, int i2) {
            this.zzap = set;
            this.zzw = i;
            this.zzbp = zza2;
            this.zzbq = zzb;
    ...
    public static final class zze extends FastSafeParcelableJsonResponse implements Person.Organizations {
        ...
        static {
            ...
            zzao.put(AppMeasurementSdk.ConditionalUserProperty.NAME, FastJsonResponse.Field.forString(AppMeasurementSdk.ConditionalUserProperty.NAME, 6));
    ...
    static {
        ...
        zzao.put(AppMeasurementSdk.ConditionalUserProperty.NAME, FastJsonResponse.Field.forConcreteType(AppMeasurementSdk.ConditionalUserProperty.NAME, 19, zzd.class));
