        ...
        if (zzcjd != null) {
            ...
            if (this.zzl != zza2 && zza2 > 0) {
                ...
                if (((Boolean) zzba.zzc().zzb(zzbjj.zzbF)).booleanValue()) {
                    zzK("timeupdate", C8850d.f22432fl, String.valueOf(f), "totalBytes", String.valueOf(this.zzg.zzh()), "qoeCachedBytes", String.valueOf(this.zzg.zzf()), "qoeLoadedBytes", String.valueOf(this.zzg.zzg()), "droppedFrames", String.valueOf(this.zzg.zzb()), "reportTime", String.valueOf(zzt.zzB().currentTimeMillis()));
                } else {
                    zzK("timeupdate", C8850d.f22432fl, String.valueOf(f));
                }
                this.zzl = zza2;
            }
        }
