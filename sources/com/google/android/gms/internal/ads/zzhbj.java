    ...
    static final String zzd(ByteBuffer byteBuffer, int i, int i2) throws zzgyp {
        if ((i | i2 | ((byteBuffer.limit() - i) - i2)) >= 0) {
            ...
            while (r11 < i3) {
                ...
                if (zzhbi.zzd(b2)) {
                ...
                } else if (zzhbi.zzf(b2)) {
                    if (i6 < i3) {
                        zzhbi.zzc(b2, byteBuffer.get(i6), cArr, i5);
                        r11 = i6 + 1;
                        i5++;
                    } else {
                        throw zzgyp.zzd();
                    }
                } else if (zzhbi.zze(b2)) {
                    if (i6 < i3 - 1) {
                        int i8 = i6 + 1;
                        zzhbi.zzb(b2, byteBuffer.get(i6), byteBuffer.get(i8), cArr, i5);
                        r11 = i8 + 1;
                        i5++;
                    } else {
                        throw zzgyp.zzd();
                    ...
                    int i9 = i6 + 1;
                    int i10 = i9 + 1;
                    zzhbi.zza(b2, byteBuffer.get(i6), byteBuffer.get(i9), byteBuffer.get(i10), cArr, i5);
                    i5 += 2;
                    r11 = i10 + 1;
                } else {
                    throw zzgyp.zzd();
