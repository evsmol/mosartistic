...
public final class zzdsq {
    ...
    public final /* synthetic */ Bitmap zza(double d, boolean z, zzaka zzaka) {
        byte[] bArr = zzaka.zzb;
    ...
    public final zzgfb zzb(String str, double d, boolean z) {
        return zzger.zzm(this.zza.zza(str), new zzdsp(this, d, z), this.zzc);
    }
}
