...
public final class zzdth {
    ...
    private final zzgfb zzp(JSONObject jSONObject, zzfil zzfil, zzfio zzfio) {
        zzgfb zzb2 = this.zzi.zzb(jSONObject.optString("base_url"), jSONObject.optString("html"), zzfil, zzfio, zzk(jSONObject.optInt(IabUtils.KEY_WIDTH, 0), jSONObject.optInt(IabUtils.KEY_HEIGHT, 0)));
    ...
    public final zzgfb zzh(JSONObject jSONObject, zzfil zzfil, zzfio zzfio) {
        ...
        boolean z = false;
        if (((Boolean) zzba.zzc().zzb(zzbjj.zziJ)).booleanValue() && optJSONObject.has("html")) {
            z = true;
        }
        if (TextUtils.isEmpty(optString)) {
            if (!z) {
