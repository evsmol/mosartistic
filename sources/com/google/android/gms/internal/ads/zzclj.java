        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    zzg();
                    throw new zzazz(e, this.zzh, i);
                }
            } catch (IOException e2) {
                zzg();
                throw new zzazz("Unable to connect to ".concat(String.valueOf(uri2)), e2, this.zzh, i);
            }
        } catch (IOException e3) {
            throw new zzazz("Unable to connect to ".concat(String.valueOf(uri)), e3, this.zzh, i);
        }
    }
