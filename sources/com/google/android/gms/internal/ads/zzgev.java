...
final class zzgev implements zzgfb {
    ...
    public final void zzc(Runnable runnable, Executor executor) {
        ...
        try {
            ...
            logger.logp(level, "com.google.common.util.concurrent.ImmediateFuture", "addListener", "RuntimeException while executing runnable " + valueOf + " with executor " + valueOf2, e);
        }
    }
}
