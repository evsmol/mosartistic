...
public final class zzfqy {
    ...
    public static JSONObject zza(int i, int i2, int i3, int i4) {
        ...
        try {
            ...
            zzfqz.zza("Error with creating viewStateObject", e);
        }
        return jSONObject;
    }
    ...
    public static void zzb(JSONObject jSONObject, String str) {
        try {
            ...
            zzfqz.zza("Error with setting ad session id", e);
        }
    }
    ...
    public static void zzd(JSONObject jSONObject, zzfrc zzfrc) {
        ...
        try {
            ...
            zzfqz.zza("Error with setting friendly obstruction", e);
        }
    }
    ...
    public static void zze(JSONObject jSONObject, Boolean bool) {
        try {
            ...
            zzfqz.zza("Error with setting not visible reason", e);
        }
    }
    ...
    public static void zzh(JSONObject jSONObject, String str, Object obj) {
        try {
            ...
            zzfqz.zza("JSONException during JSONObject.put for name [" + str + "]", e);
        }
    }
    ...
    public static void zzi(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put(IabUtils.KEY_WIDTH, (double) f2);
            jSONObject.put(IabUtils.KEY_HEIGHT, (double) f);
        } catch (JSONException e) {
            e.printStackTrace();
        }
    }
