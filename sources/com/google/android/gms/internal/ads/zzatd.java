...
public final class zzatd implements Parcelable {
    ...
    public static zzatd zzl(String str, String str2, String str3, int i, int i2, int i3, int i4, float f, List list, int i5, float f2, byte[] bArr, int i6, zzbbb zzbbb, zzavc zzavc) {
        return new zzatd(str, (String) null, str2, (String) null, -1, i2, i3, i4, -1.0f, i5, f2, bArr, i6, zzbbb, -1, -1, -1, -1, -1, 0, (String) null, -1, Long.MAX_VALUE, list, zzavc, (zzaxo) null);
    }
    ...
    zzatd(String str, String str2, String str3, String str4, int i, int i2, int i3, int i4, float f, int i5, float f2, byte[] bArr, int i6, zzbbb zzbbb, int i7, int i8, int i9, int i10, int i11, int i12, String str5, int i13, long j, List list, zzavc zzavc, zzaxo zzaxo) {
        this.zza = str;
        this.zze = str2;
        this.zzf = str3;
        this.zzc = str4;
