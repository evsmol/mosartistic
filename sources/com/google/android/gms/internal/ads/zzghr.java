        ...
        if (length > 5) {
            ...
            for (zzghe zzghe : this.zza.zze(copyOf)) {
                try {
                    ...
                    zzghs.zza.logp(Level.INFO, "com.google.crypto.tink.aead.AeadWrapper$WrappedAead", "decrypt", "ciphertext prefix matches a key, but cannot decrypt: ".concat(e.toString()));
                }
            }
        }
