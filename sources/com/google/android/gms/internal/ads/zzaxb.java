            ...
            if (zzauy2.zzf()) {
                ...
                if (this.zzl && !zzi2) {
                    ...
                    while (true) {
                        ...
                        if (i4 == 3) {
                            if (b == 1) {
                                if ((byteBuffer.get(i5) & Ascii.f15554US) == 7) {
        ...
        if (this.zzj == null && (zzatd = this.zzi) != null) {
            ...
            if (zzawz == null) {
                try {
                    ...
                    throw zzasp.zza(new zzaxa(this.zzi, (Throwable) e, false, -49998), zza());
                }
            }
            if (zzaa(zzawz)) {
                ...
                try {
                    ...
                    throw zzasp.zza(new zzaxa(this.zzi, (Throwable) e2, false, str), zza());
                }
            }
        }
    }
