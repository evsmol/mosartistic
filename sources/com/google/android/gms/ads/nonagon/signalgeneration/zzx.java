    ...
    public final /* bridge */ /* synthetic */ void zzb(Object obj) {
        ...
        if (zzao == null) {
            try {
                ...
                zzfol2.zzf(false);
                zzcho.zzh("", e2);
                zzt.zzo().zzu(e2, "SignalGeneratorImpl.generateSignals.onSuccess");
                if (((Boolean) zzbks.zze.zze()).booleanValue() && zzr != null) {
                    zzr.zza(this.zzd);
                    zzr.zzg();
                }
            ...
            try {
                ...
                if (((Boolean) zzba.zzc().zzb(zzbjj.zziC)).booleanValue()) {
                    try {
                        ...
                        zze.zzh("Error retrieving JSONObject from the requestJson, ", e3);
                    }
                }
                ...
                zzfol4.zzg(e4);
                zzfol4.zzf(false);
                zzt.zzo().zzu(e4, "SignalGeneratorImpl.generateSignals.onSuccess");
                if (((Boolean) zzbks.zze.zze()).booleanValue() && zzr != null) {
                    zzr.zza(this.zzd);
                    zzr.zzg();
                }
