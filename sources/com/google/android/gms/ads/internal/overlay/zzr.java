...
public final class zzr extends FrameLayout implements View.OnClickListener {
    ...
    private final void zzc() {
        ...
        if (zzd != null) {
            ...
            try {
                if ("white".equals(str)) {
                    drawable = zzd.getDrawable(C1766R.C1767drawable.admob_close_button_white_circle_black_cross);
                } else if ("black".equals(str)) {
                    drawable = zzd.getDrawable(C1766R.C1767drawable.admob_close_button_black_circle_white_cross);
                }
