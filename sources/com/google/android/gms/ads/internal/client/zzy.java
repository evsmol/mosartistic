...
import com.google.android.gms.ads.C1764R;
...
public final class zzy {
    ...
    public zzy(Context context, AttributeSet attributeSet) {
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C1764R.styleable.AdsAttrs);
        String string = obtainAttributes.getString(C1764R.styleable.AdsAttrs_adSize);
        String string2 = obtainAttributes.getString(C1764R.styleable.AdsAttrs_adSizes);
        ...
        this.zzb = obtainAttributes.getString(C1764R.styleable.AdsAttrs_adUnitId);
        obtainAttributes.recycle();
