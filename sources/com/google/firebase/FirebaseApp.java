...
import androidx.core.p161os.UserManagerCompat;
...
public class FirebaseApp {
    ...
    protected FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        this.componentRuntime = ComponentRuntime.builder(UI_EXECUTOR).addLazyComponentRegistrars(discoverLazy).addComponentRegistrar(new FirebaseCommonRegistrar()).addComponent(Component.m11242of(context, Context.class, new Class[0])).addComponent(Component.m11242of(this, FirebaseApp.class, new Class[0])).addComponent(Component.m11242of(firebaseOptions, FirebaseOptions.class, new Class[0])).setProcessor(new ComponentMonitor()).build();
        FirebaseTrace.popTrace();
