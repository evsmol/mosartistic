...
import com.google.android.gms.internal.p090firebaseiid.zza;
import com.google.android.gms.internal.p090firebaseiid.zze;
import com.google.android.gms.internal.p090firebaseiid.zzf;
...
public class MessengerIpcClient {
    ...
    private static class TwoWayRequest extends Request<Bundle> {
        ...
        /* access modifiers changed from: package-private */
        public void handleResponseInternal(Bundle bundle) {
            Bundle bundle2 = bundle.getBundle(C8849c.DATA);
            if (bundle2 == null) {
    ...
    private static abstract class Request<T> {
        ...
        public Message createMessage(Context context, Messenger messenger) {
            ...
            bundle.putBundle(C8849c.DATA, this.data);
