...
/* renamed from: com.google.protobuf.nano.ym.CodedInputByteBufferNano */
public final class CodedInputByteBufferNano {
    ...
    public int readRawVarint32() {
        ...
        if (readRawByte2 >= 0) {
            ...
            b |= (readRawByte2 & Ascii.DEL) << 7;
            byte readRawByte3 = readRawByte();
            if (readRawByte3 >= 0) {
                i = readRawByte3 << Ascii.f15552SO;
            } else {
                b |= (readRawByte3 & Ascii.DEL) << Ascii.f15552SO;
                byte readRawByte4 = readRawByte();
                if (readRawByte4 >= 0) {
                    i = readRawByte4 << Ascii.NAK;
                } else {
                    byte b2 = b | ((readRawByte4 & Ascii.DEL) << Ascii.NAK);
                    byte readRawByte5 = readRawByte();
                    byte b3 = b2 | (readRawByte5 << Ascii.f15545FS);
                    if (readRawByte5 >= 0) {
                        return b3;
                    }
    ...
    public void skipMessage() {
        ...
        L_0x000c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.nano.p091ym.CodedInputByteBufferNano.skipMessage():void");
    }
