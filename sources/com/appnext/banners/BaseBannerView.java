...
public abstract class BaseBannerView extends ViewGroup {
    protected C8810e bannerAdapter;
    ...
    public abstract C8810e getBannerAdapter();
    ...
    private void parseAttributeSet(AttributeSet attributeSet) {
        if (!isInEditMode()) {
            ...
            C8809d.m26560S().mo59050r("tid", "301");
            C8809d.m26560S().mo59042a(getContext(), (C8936p.C8938a) null);
            getViewTreeObserver().addOnScrollChangedListener(this.onScrollChangedListener);
            if (attributeSet != null) {
                TypedArray obtainAttributes = getResources().obtainAttributes(attributeSet, C8773R.styleable.BannersAttrs);
                String string = obtainAttributes.getString(C8773R.styleable.BannersAttrs_bannerSize);
                if (string != null) {
                    char c = 65535;
                ...
                String string2 = obtainAttributes.getString(C8773R.styleable.BannersAttrs_placementId);
                if (string2 != null) {
    ...
    public void setParams(String str, String str2) {
        C8809d.m26560S().mo59051s(str, str2);
    }
