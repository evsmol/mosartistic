...
public class BannerSize {
    ...
    public static final BannerSize MEDIUM_RECTANGLE = new BannerSize(C5643c.COLLECT_MODE_FINANCE, IronSourceConstants.INTERSTITIAL_DAILY_CAPPED, "MEDIUM_RECTANGLE");
    private int height;
    private String name;
    private int width;
