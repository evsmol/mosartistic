...
public class C8812g extends C8777a {
    ...
    public void inflateView(int i, AppnextAd appnextAd) {
        try {
            ...
            AppnextWebView.m27061u(this.context).mo59087a(jSurl, (AppnextWebView.C8967c) new AppnextWebView.C8967c() {
                /* renamed from: f */
                public final void mo58459f(String str) {
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        public final void run() {
                            C8812g.this.loadWebview(jSurl, AppnextWebView.m27061u(C8812g.this.context).mo59090aj(jSurl));
                        }
                    });
                }
                ...
                public final void error(String str) {
                    ...
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        public final void run() {
                            C8812g.this.loadWebview(jSurl, C8812g.this.getFallbackScript());
                        }
                    });
                }
            });
            AppnextWebView.m27061u(this.context).mo59087a(getTargetJSurl(), (AppnextWebView.C8967c) null);
    ...
    public void destroy() {
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            public final void run() {
                try {
                    ((ViewGroup) C8812g.this.webView.getParent()).removeView(C8812g.this.webView);
                } catch (Throwable unused) {
                }
                if (C8812g.this.webView != null) {
                    C8812g.this.webView.destroyDrawingCache();
                    C8812g.this.webView.destroy();
                }
            }
        });
    ...
    public JSONObject getConfigParams() throws JSONException {
        ...
        jSONObject.put("pview", C8809d.m26560S().get("pview"));
        ...
        jSONObject.put("remove_poster_on_auto_play", C8809d.m26560S().get("remove_poster_on_auto_play"));
        ...
        jSONObject.put("gdpr", C8927k.m26971a((AppnextAd) getSelectedAd(), (C8936p) C8809d.m26560S()));
        jSONObject.put("lang_settings", new JSONObject(C8894b.m26842bp().mo58970bq()).toString());
    ...
    public class C8822a {
        ...
        public void openStore(String str) {
            C8812g.this.handler.removeCallbacksAndMessages((Object) null);
            if (!C8812g.this.isDestroyed()) {
                C8812g.this.handler.post(new Runnable() {
                    public final void run() {
                        if (!C8812g.this.getSelectedAd().getWebview().equals(BuildConfig.ADAPTER_VERSION)) {
                            C8812g.this.click();
                            return;
                        }
                        char c = 65535;
                        if (C8812g.this.getSelectedAd().getRevenueType().equals("cpi")) {
                            C8809d S = C8809d.m26560S();
                            String lowerCase = S.get(C8812g.this.getBannerSize().toString() + "_cpiActiveFlow").toLowerCase();
                            StringBuilder sb = new StringBuilder();
                            sb.append(C8812g.this.getBannerSize().toString());
                            ...
                            if (c != 0) {
                                if (c == 1) {
                                    boolean unused = C8812g.this.clicked = true;
                                } else if (c == 2) {
                                    C8812g.this.openResultPage(false);
                                    return;
                                }
                                C8812g.this.click();
                                return;
                            }
                            C8812g.this.openResultPage(true);
                            return;
                        }
                        C8809d S2 = C8809d.m26560S();
                        String lowerCase2 = S2.get(C8812g.this.getBannerSize().toString() + "_cpcActiveFlow").toLowerCase();
                        StringBuilder sb2 = new StringBuilder();
                        sb2.append(C8812g.this.getBannerSize().toString());
                        ...
                        if (c == 0) {
                            boolean unused2 = C8812g.this.clicked = true;
                        }
                        C8812g.this.click();
                    }
                });
        ...
        public void openLink(String str) {
            if (!C8812g.this.isDestroyed()) {
                C8812g.this.openLink(str);
            }
        }

        @JavascriptInterface
        public void logSTP(String str, String str2) {
            C8917f.m26924a((C8874Ad) C8812g.this.getBannerAd(), (AppnextAd) C8812g.this.getSelectedAd(), str, str2, (C8936p) C8809d.m26560S());
        }
    }
    ...
    public class C8824b extends WebViewClient {
        public C8824b() {
        }
    ...
    public void pageFinished() {
        if (!isDestroyed()) {
            new Thread(new Runnable() {
                public final void run() {
                    C8812g gVar = C8812g.this;
                    String unused = gVar.adsid = C8917f.m26931b(gVar.context, false);
                    C8812g.this.handler.removeCallbacksAndMessages((Object) null);
                    C8812g.this.handler.post(new Runnable() {
                        public final void run() {
                            try {
                                C8812g.this.loadJS("javascript:(function() { try { Appnext.Layout.destroy('internal'); } catch(err){ Appnext.jsError(err.message); }})()");
                                C8812g gVar = C8812g.this;
                                gVar.loadJS("javascript:(function() { try { Appnext.setParams(" + C8812g.this.getConfigParams().toString() + "); } catch(err){ Appnext.jsError(err.message); }})()");
                                C8812g gVar2 = C8812g.this;
                                gVar2.loadJS("javascript:(function() { try { Appnext.loadBanner(" + new JSONObject(C8812g.this.getSelectedAd().getAdJSON()).toString() + ",'" + C8812g.this.getBannerSize().toString() + "'); } catch(err){ Appnext.jsError(err.message); }})()");
                                C8812g.this.shown.add(C8812g.this.getSelectedAd().getBannerID());
                            } catch (Throwable unused) {
                            }
                        }
                    });
    ...
    private void activateAutoRefresh() {
        ...
        if (Boolean.parseBoolean(S.get("_arFlag")) && i > 0) {
            this.refreshHandler.postDelayed(new Runnable() {
                public final void run() {
                    try {
                        AppnextAd a = C8807b.m26543R().mo58648a(C8812g.this.context, (C8874Ad) C8812g.this.getBannerAd(), (ArrayList<?>) C8812g.this.getAds(), C8812g.this.getAdRequest().getCreativeType(), (ArrayList<String>) C8812g.this.shown);
                        if (a != null) {
                            C8812g.this.setSelectedAd(new BannerAdData(a));
                            if (Boolean.parseBoolean(C8809d.m26560S().get("impOne"))) {
                                C8812g.this.setReportedImpression(false);
                                C8812g.this.impression();
                            } else if (Boolean.parseBoolean(C8809d.m26560S().get("pview"))) {
                                C8812g.this.refreshHandler.postDelayed(new Runnable() {
                                    public final void run() {
                                        C8812g.this.getUserAction().mo59055a(C8812g.this.getSelectedAd(), C8812g.this.getSelectedAd().getImpressionURL(), (C8906e.C8915a) null);
                                    }
                                }, (long) (Integer.parseInt(C8809d.m26560S().get("postpone_vta_sec")) * 1000));
                            }
                            C8812g.this.pageFinished();
                        }
                    } catch (Throwable unused) {
