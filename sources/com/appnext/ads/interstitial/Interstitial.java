...
import com.appnext.core.webview.C8968a;
import java.io.IOException;
import java.util.ArrayList;
import java.util.HashMap;

public class Interstitial extends C8874Ad {
    ...
    private void init() {
        loadConfig();
        AppnextWebView.m27061u(this.context).mo59087a(getPageUrl(), (AppnextWebView.C8967c) null);
        super.setOnAdErrorCallback(new OnAdError() {
            ...
            public final void adError(java.lang.String r11) {
                ...
                L_0x006b:
                    ...
                    java.lang.String r8 = ""
                    java.lang.String r9 = ""
                    com.appnext.core.C8917f.m26926a((java.lang.String) r1, (java.lang.String) r2, (java.lang.String) r3, (java.lang.String) r4, (java.lang.String) r5, (java.lang.String) r6, (java.lang.String) r7, (java.lang.String) r8, (java.lang.String) r9)
                    com.appnext.ads.interstitial.Interstitial r0 = com.appnext.ads.interstitial.Interstitial.this
                ...
                L_0x00a3:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.appnext.ads.interstitial.Interstitial.C87241.adError(java.lang.String):void");
            }
        });
    }
            ...
            new Thread(new Runnable() {
                public final void run() {
                    try {
                        ...
                        Interstitial.this.getConfig().mo59042a(Interstitial.this.context, (C8936p.C8938a) new C8936p.C8938a() {
                            /* renamed from: b */
    ...
    /* access modifiers changed from: private */
    public void load() {
        C8752a.m26507G().mo58521a(this.context, this, getPlacementID(), new C8898d.C8905a() {
            /* renamed from: a */
            public final <T> void mo58343a(T t) {
                AppnextAd appnextAd;
                try {
                    appnextAd = C8752a.m26507G().mo58519a(Interstitial.this.context, (ArrayList<AppnextAd>) (ArrayList) t, Interstitial.this.getCreative(), (C8874Ad) Interstitial.this);
                } catch (Throwable unused) {
                    if (Interstitial.this.getOnAdErrorCallback() != null) {
    ...
    public void showAd() {
        if (getPlacementID().equals("")) {
            ...
            int Z = C8917f.m26914Z(getConfig().get("min_internet_connection"));
            ...
            if (Z2 == -1) {
                ...
                currentAd = this;
                if (C8752a.m26507G().mo58523d(this)) {
    ...
    public void getECPM(final OnECPMLoaded onECPMLoaded) {
        if (onECPMLoaded != null) {
            C8752a.m26507G().mo58983a(this.context, (C8874Ad) this, getPlacementID(), (C8898d.C8905a) new C8898d.C8905a() {
                /* renamed from: a */
                public final <T> void mo58343a(T t) {
                    AppnextAd a = C8752a.m26507G().mo58519a(Interstitial.this.context, (ArrayList<AppnextAd>) (ArrayList) t, Interstitial.this.getCreative(), (C8874Ad) Interstitial.this);
                    if (a != null) {
    ...
    public String getCreative() {
        int Z = C8917f.m26914Z(getConfig().get("min_internet_connection"));
        int Z2 = C8917f.m26914Z(getConfig().get("min_internet_connection_video"));
        int Z3 = C8917f.m26914Z(C8917f.m26953o(this.context));
        if (Z3 < Z || Z3 >= Z2) {
    ...
    public boolean isAdLoaded() {
        return !getPlacementID().equals("") && C8752a.m26507G().mo58523d(this);
    }
    ...
    private void loadConfig() {
        ...
        getConfig().mo59042a(this.context, (C8936p.C8938a) new C8936p.C8938a() {
            ...
            public final void mo58339b(HashMap<String, Object> hashMap) {
                ...
                C8925j.m26963bj().mo59030b(Integer.parseInt(Interstitial.this.getConfig().get("banner_expiration_time")));
