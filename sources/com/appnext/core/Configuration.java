...
public abstract class Configuration implements Serializable {
    ...
    public Boolean mute;
    public String orientation = C8874Ad.ORIENTATION_DEFAULT;
    public String postback = "";

    /* access modifiers changed from: protected */
    /* renamed from: l */
    public abstract C8936p mo58279l();
    ...
    public boolean getMute() {
        ...
        return bool == null ? Boolean.parseBoolean(mo58279l().get("mute")) : bool.booleanValue();
    }
    ...
    public void setOrientation(String str) {
        ...
        } else if (str.equals(C8874Ad.ORIENTATION_AUTO) || str.equals(C8874Ad.ORIENTATION_DEFAULT) || str.equals("landscape") || str.equals("portrait")) {
    ...
    public boolean isBackButtonCanClose() {
        ...
        return bool == null ? Boolean.parseBoolean(mo58279l().get("can_close")) : bool.booleanValue();
    }
}
