...
public abstract class C8874Ad {
    ...
    /* renamed from: fq */
    protected static boolean f22488fq = false;
    private OnAdOpened adOpenedCallback;
    private C8897c adRequest;
    private String cat = "";
    ...
    public C8874Ad(final Context context2, String str) {
        if (context2 == null) {
            throw new IllegalArgumentException("Context cannot be null");
        } else if (str != null) {
            this.context = context2;
            setPlacementID(str);
            C8925j.m26963bj().mo59031d(context2, str);
            ...
            new Thread(new Runnable() {
                public final void run() {
                    ...
                    C8874Ad.this.setSessionId(C8917f.m26956q(context2));
                }
            }).start();
            C8894b.m26842bp();
            new Thread(new Runnable() {
    ...
    /* access modifiers changed from: protected */
    public C8897c getAdRequest() {
        return this.adRequest;
    }

    /* access modifiers changed from: protected */
    public void setAdRequest(C8897c cVar) {
        this.adRequest = cVar;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof C8874Ad)) {
            return super.equals(obj);
        }
        C8874Ad ad = (C8874Ad) obj;
