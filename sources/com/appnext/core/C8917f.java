...
public final class C8917f {
    ...
    /* renamed from: fd */
    static final int f22595fd = 8000;

    /* renamed from: gP */
    private static final String f22596gP = "expiredTimems";

    /* renamed from: gQ */
    private static double f22597gQ = -1.0d;

    /* renamed from: gR */
    private static HashMap<String, Bitmap> f22598gR = new HashMap<>();

    /* renamed from: gS */
    private static String f22599gS = "";

    /* renamed from: gT */
    private static String f22600gT = "";

    /* renamed from: gU */
    private static String f22601gU = "";

    /* renamed from: gV */
    public static final Executor f22602gV = new ThreadPoolExecutor(Runtime.getRuntime().availableProcessors() + 1, (Runtime.getRuntime().availableProcessors() * 2) + 1, 1, TimeUnit.SECONDS, new LinkedBlockingQueue(128), new ThreadFactory() {

        /* renamed from: gW */
        private final AtomicInteger f22603gW = new AtomicInteger(1);

        public final Thread newThread(Runnable runnable) {
            return new Thread(runnable, "AsyncTask #" + this.f22603gW.getAndIncrement());
        }
    });

    /* renamed from: bg */
    public static double m26940bg() {
        return 0.0d;
    }

    /* renamed from: c */
    public static void m26945c(Throwable th) {
    }

    /* renamed from: o */
    public static void m26954o(String str) {
    }
    ...
    /* renamed from: l */
    public static String m26949l(Context context) {
        return m26931b(context, true);
    }

    /* renamed from: b */
    public static String m26931b(Context context, boolean z) {
        String str;
        ...
        try {
            ...
            str = AdsIDHelper.m26801a(context.getApplicationContext(), z);
    ...
    /* renamed from: m */
    static void m26951m(Context context) {
        try {
            WebView webView = new WebView(context);
            f22599gS = webView.getSettings().getUserAgentString();
            webView.destroy();
    ...
    /* renamed from: bd */
    static String m26937bd() {
        return f22599gS;
    }

    /* renamed from: V */
    private static void m26910V(String str) {
        f22599gS = str;
    }

    /* renamed from: be */
    public static String m26938be() {
        try {
    ...
    /* renamed from: bf */
    public static int m26939bf() {
        Runtime runtime = Runtime.getRuntime();
        return (int) ((runtime.maxMemory() / C8850d.f22423fc) - ((runtime.totalMemory() - runtime.freeMemory()) / C8850d.f22423fc));
    }

    /* renamed from: a */
    public static String m26919a(String str, HashMap<String, String> hashMap) throws IOException {
        return m26922a(str, hashMap, true, (int) f22595fd);
    }

    /* renamed from: a */
    public static String m26921a(String str, HashMap<String, String> hashMap, boolean z) throws IOException {
        return m26922a(str, hashMap, z, (int) f22595fd);
    }

    /* renamed from: a */
    public static String m26920a(String str, HashMap<String, String> hashMap, int i) throws IOException {
        return m26922a(str, (HashMap<String, String>) null, true, i);
    }

    /* renamed from: a */
    public static String m26922a(String str, HashMap<String, String> hashMap, boolean z, int i) throws IOException {
        return new String(m26936b(str, hashMap, z, i, C8850d.C8851a.HashMap), "UTF-8");
    }

    /* renamed from: a */
    public static String m26917a(String str, ArrayList<Pair<String, String>> arrayList) throws IOException {
        return m26918a(str, arrayList, (int) f22595fd);
    }

    /* renamed from: a */
    public static String m26918a(String str, ArrayList<Pair<String, String>> arrayList, int i) throws IOException {
        return new String(m26936b(str, arrayList, true, i, C8850d.C8851a.ArrayList), "UTF-8");
    }

    /* renamed from: b */
    public static String m26932b(String str, JSONObject jSONObject) throws IOException {
        return new String(m26936b(str, jSONObject, true, f22595fd, C8850d.C8851a.JSONObject), "UTF-8");
    }

    /* renamed from: a */
    public static byte[] m26928a(String str, Object obj, boolean z, int i) throws IOException {
        return m26936b(str, obj, z, i, C8850d.C8851a.HashMap);
    }

    /* renamed from: W */
    private static boolean m26911W(String str) {
        try {
            ...
            if (TextUtils.isEmpty(string) || !string.equals(m26931b(C8852e.getContext(), true))) {
                return false;
            }
            return true;
        } catch (Throwable unused) {
    ...
    /* renamed from: X */
    private static boolean m26912X(String str) {
        try {
            JSONObject jSONObject = new JSONObject(str);
            if (!jSONObject.has(f22596gP)) {
                return true;
            }
            if (System.currentTimeMillis() >= jSONObject.getLong(f22596gP)) {
                return true;
            }
            return false;
        } catch (Throwable unused) {
    ...
    public static byte[] m26929a(java.lang.String r18, java.lang.Object r19, boolean r20, int r21, com.appnext.base.p264b.C8850d.C8851a r22) throws java.lang.Exception {
        /*
            r0 = r19
            r1 = r22
            java.lang.String r2 = "secret"
            java.lang.String r3 = "rnd"
            com.appnext.base.services.a r4 = com.appnext.base.services.C8868a.m26772aK()
            ...
            boolean r5 = m26911W(r4)
            if (r5 == 0) goto L_0x002b
            boolean r5 = m26912X(r4)
            if (r5 == 0) goto L_0x0094
        L_0x002b:
            java.util.HashMap r4 = new java.util.HashMap
            r4.<init>()
            com.appnext.base.b.h r5 = com.appnext.base.p264b.C8855h.m26688aO()
            android.content.Context r12 = com.appnext.base.p264b.C8852e.getContext()
            java.lang.String r12 = m26931b((android.content.Context) r12, (boolean) r10)
            java.lang.String r5 = r5.mo58753M(r12)
            r4.put(r7, r5)
            ...
            com.appnext.base.b.d$a r12 = com.appnext.base.p264b.C8850d.C8851a.HashMap     // Catch:{ all -> 0x0207 }
            byte[] r4 = m26936b(r5, r4, r9, r8, r12)     // Catch:{ all -> 0x0207 }
        ...
        L_0x005c:
            ...
            android.content.Context r12 = com.appnext.base.p264b.C8852e.getContext()     // Catch:{ all -> 0x0207 }
            java.lang.String r12 = m26931b((android.content.Context) r12, (boolean) r10)     // Catch:{ all -> 0x0207 }
            ...
            com.appnext.base.services.a r12 = com.appnext.base.services.C8868a.m26772aK()     // Catch:{ all -> 0x0207 }
        ...
        L_0x00a7:
            ...
            java.lang.String r13 = f22599gS     // Catch:{ all -> 0x01f7 }
            r5.setRequestProperty(r12, r13)     // Catch:{ all -> 0x01f7 }
            r5.setRequestProperty(r3, r4)     // Catch:{ all -> 0x01f7 }
            android.content.Context r3 = com.appnext.base.p264b.C8852e.getContext()     // Catch:{ all -> 0x01f7 }
            java.lang.String r3 = m26931b((android.content.Context) r3, (boolean) r10)     // Catch:{ all -> 0x01f7 }
            boolean r4 = android.text.TextUtils.isEmpty(r3)     // Catch:{ all -> 0x01f7 }
            java.lang.String r12 = "aidForSend"
            if (r4 == 0) goto L_0x00f8
            com.appnext.base.b.d$a r3 = com.appnext.base.p264b.C8850d.C8851a.String     // Catch:{ all -> 0x01f7 }
            java.lang.Object r3 = com.appnext.base.p264b.C8857j.m26697a(r12, r3)     // Catch:{ all -> 0x01f7 }
        ...
        L_0x00f7:
            return r11
        L_0x00f8:
            com.appnext.base.b.d$a r4 = com.appnext.base.p264b.C8850d.C8851a.String     // Catch:{ all -> 0x01f7 }
            com.appnext.base.p264b.C8857j.m26700a((java.lang.String) r12, (java.lang.String) r3, (com.appnext.base.p264b.C8850d.C8851a) r4)     // Catch:{ all -> 0x01f7 }
        L_0x00fd:
            boolean r4 = android.text.TextUtils.isEmpty(r3)     // Catch:{ all -> 0x01f7 }
        ...
        L_0x0108:
            return r11
        L_0x0109:
            com.appnext.base.b.h r4 = com.appnext.base.p264b.C8855h.m26688aO()     // Catch:{ all -> 0x01f7 }
            java.lang.String r3 = r4.mo58753M(r3)     // Catch:{ all -> 0x01f7 }
            ...
            com.appnext.base.b.d$a r3 = com.appnext.base.p264b.C8850d.C8851a.JSONObject     // Catch:{ all -> 0x01f7 }
            if (r1 == r3) goto L_0x0124
            com.appnext.base.b.d$a r3 = com.appnext.base.p264b.C8850d.C8851a.JSONArray     // Catch:{ all -> 0x01f7 }
        ...
        L_0x0139:
            java.lang.String r3 = ""
            com.appnext.base.b.d$a r4 = com.appnext.base.p264b.C8850d.C8851a.JSONArray     // Catch:{ all -> 0x01f7 }
            ...
            goto L_0x0194
        L_0x0147:
            com.appnext.base.b.d$a r4 = com.appnext.base.p264b.C8850d.C8851a.JSONObject     // Catch:{ all -> 0x01f7 }
            ...
            goto L_0x0194
        L_0x0153:
            com.appnext.base.b.d$a r4 = com.appnext.base.p264b.C8850d.C8851a.HashMap     // Catch:{ all -> 0x01f7 }
        ...
        L_0x0167:
            ...
            goto L_0x0167
        L_0x0184:
            java.lang.String r3 = m26934b((java.util.List<android.util.Pair<java.lang.String, java.lang.String>>) r4, (boolean) r9)     // Catch:{ all -> 0x01f7 }
            goto L_0x0194
        L_0x0189:
            com.appnext.base.b.d$a r4 = com.appnext.base.p264b.C8850d.C8851a.ArrayList     // Catch:{ all -> 0x01f7 }
            if (r1 != r4) goto L_0x0194
            r3 = r0
            java.util.ArrayList r3 = (java.util.ArrayList) r3     // Catch:{ all -> 0x01f7 }
            java.lang.String r3 = m26934b((java.util.List<android.util.Pair<java.lang.String, java.lang.String>>) r3, (boolean) r9)     // Catch:{ all -> 0x01f7 }
        L_0x0194:
            com.appnext.base.b.h r4 = com.appnext.base.p264b.C8855h.m26688aO()     // Catch:{ all -> 0x01f7 }
            byte[] r2 = r4.mo58754f(r3, r2)     // Catch:{ all -> 0x01f7 }
        ...
        L_0x01a5:
            ...
            java.io.InputStream r0 = m26916a((java.io.InputStream) r11)     // Catch:{ all -> 0x01f7 }
            byte[] r0 = m26935b((java.io.InputStream) r0)     // Catch:{ all -> 0x01f7 }
        ...
        L_0x01d4:
            ...
            byte[] r0 = m26935b((java.io.InputStream) r11)     // Catch:{ all -> 0x01f7 }
        ...
        L_0x01e7:
            ...
            byte[] r0 = m26936b(r2, r0, r9, r8, r1)     // Catch:{ all -> 0x01f7 }
        ...
        L_0x0207:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appnext.core.C8917f.m26929a(java.lang.String, java.lang.Object, boolean, int, com.appnext.base.b.d$a):byte[]");
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static byte[] m26936b(java.lang.String r9, java.lang.Object r10, boolean r11, int r12, com.appnext.base.p264b.C8850d.C8851a r13) throws java.io.IOException {
        /*
            ...
            java.lang.String r2 = f22599gS     // Catch:{ all -> 0x0124 }
            r0.setRequestProperty(r1, r2)     // Catch:{ all -> 0x0124 }
            ...
            com.appnext.base.b.d$a r2 = com.appnext.base.p264b.C8850d.C8851a.JSONObject     // Catch:{ all -> 0x0124 }
            if (r13 == r2) goto L_0x003f
            com.appnext.base.b.d$a r2 = com.appnext.base.p264b.C8850d.C8851a.JSONArray     // Catch:{ all -> 0x0124 }
        ...
        L_0x0054:
            ...
            com.appnext.base.b.d$a r4 = com.appnext.base.p264b.C8850d.C8851a.JSONArray     // Catch:{ all -> 0x0124 }
            ...
            goto L_0x00c7
        L_0x0071:
            com.appnext.base.b.d$a r4 = com.appnext.base.p264b.C8850d.C8851a.JSONObject     // Catch:{ all -> 0x0124 }
            ...
            goto L_0x00c7
        L_0x0080:
            com.appnext.base.b.d$a r4 = com.appnext.base.p264b.C8850d.C8851a.HashMap     // Catch:{ all -> 0x0124 }
        ...
        L_0x0094:
            ...
            goto L_0x0094
        L_0x00b1:
            java.lang.String r4 = m26934b((java.util.List<android.util.Pair<java.lang.String, java.lang.String>>) r5, (boolean) r11)     // Catch:{ all -> 0x0124 }
            r3.write(r4)     // Catch:{ all -> 0x0124 }
            goto L_0x00c7
        L_0x00b9:
            com.appnext.base.b.d$a r4 = com.appnext.base.p264b.C8850d.C8851a.ArrayList     // Catch:{ all -> 0x0124 }
            if (r13 != r4) goto L_0x00c7
            r4 = r10
            java.util.ArrayList r4 = (java.util.ArrayList) r4     // Catch:{ all -> 0x0124 }
            java.lang.String r4 = m26934b((java.util.List<android.util.Pair<java.lang.String, java.lang.String>>) r4, (boolean) r11)     // Catch:{ all -> 0x0124 }
            r3.write(r4)     // Catch:{ all -> 0x0124 }
        L_0x00c7:
        ...
        L_0x00d0:
            ...
            java.io.InputStream r10 = m26916a((java.io.InputStream) r9)     // Catch:{ all -> 0x0124 }
            byte[] r10 = m26935b((java.io.InputStream) r10)     // Catch:{ all -> 0x0124 }
        ...
        L_0x00fc:
            ...
            byte[] r10 = m26935b((java.io.InputStream) r9)     // Catch:{ all -> 0x0124 }
        ...
        L_0x0114:
            ...
            byte[] r9 = m26936b(r1, r10, r11, r12, r13)     // Catch:{ all -> 0x0124 }
        ...
        L_0x0132:
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appnext.core.C8917f.m26936b(java.lang.String, java.lang.Object, boolean, int, com.appnext.base.b.d$a):byte[]");
    }

    /* renamed from: a */
    public static InputStream m26916a(InputStream inputStream) throws IOException {
    ...
    /* renamed from: b */
    private static byte[] m26935b(InputStream inputStream) throws IOException {
    ...
    /* renamed from: Y */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.graphics.Bitmap m26913Y(java.lang.String r4) {
        /*
            r0 = 0
            java.util.HashMap<java.lang.String, android.graphics.Bitmap> r1 = f22598gR     // Catch:{ all -> 0x0086 }
        ...
        L_0x0070:
            return r0
        L_0x0071:
            java.util.HashMap<java.lang.String, android.graphics.Bitmap> r2 = f22598gR     // Catch:{ all -> 0x0084 }
        ...
        L_0x008c:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appnext.core.C8917f.m26913Y(java.lang.String):android.graphics.Bitmap");
    }

    /* renamed from: d */
    private static void m26947d(HashMap<String, Bitmap> hashMap) {
        try {
    ...
    /* renamed from: b */
    private static String m26934b(List<Pair<String, String>> list, boolean z) {
    ...
    /* renamed from: a */
    public static int m26915a(Context context, float f) {
        return (int) (f * (((float) context.getResources().getDisplayMetrics().densityDpi) / 160.0f));
    }

    /* renamed from: a */
    public static void m26926a(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9) {
        String str10 = str6;
        try {
            if (str10.equals(C8668a.f21984I) || str10.equals(C8668a.f21988M)) {
                ...
                new Thread(new Runnable() {
                    public final void run() {
                        ...
                        try {
                            ...
                            C8917f.m26919a(format, (HashMap<String, String>) null);
                        } catch (Throwable th) {
    ...
    /* renamed from: a */
    private static void m26923a(Context context, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8) {
        try {
            ...
            new Thread(new Runnable() {
                public final void run() {
                    String str;
                    try {
                        str = C8917f.m26956q(context2);
                    } catch (Throwable unused) {
                        str = "";
                    }
                    C8917f.m26926a(str9, str10, str11, str12, str, str13, str14, str15, str16);
                }
            }).start();
        } catch (Throwable unused) {
        }
    ...
    /* renamed from: a */
    public static void m26924a(C8874Ad ad, AppnextAd appnextAd, String str, String str2, C8936p pVar) {
        final C8936p pVar2 = pVar;
            ...
            public final void run() {
                try {
                    if (Boolean.parseBoolean(pVar2.get("stp_flag"))) {
                        ...
                        arrayList.add(new Pair("did", C8917f.m26931b(ad2.getContext(), true)));
                        ...
                        C8917f.m26918a("https://global.appnext.com/stp.aspx", (ArrayList<Pair<String, String>>) arrayList, (int) C8917f.f22595fd);
                    }
                } catch (Throwable unused) {
                }
            }
    ...
    /* renamed from: c */
    public static boolean m26946c(Context context, String str) {
        try {
    ...
    /* renamed from: m */
    public static String m26950m(String str, String str2) {
    ...
    /* renamed from: n */
    public static String m26952n(Context context) {
    ...
    /* renamed from: o */
    public static String m26953o(Context context) {
    ...
    /* renamed from: Z */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static int m26914Z(java.lang.String r7) {
        /*
        ...
        L_0x0056:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appnext.core.C8917f.m26914Z(java.lang.String):int");
    }

    /* renamed from: b */
    public static String m26933b(Throwable th) {
    ...
    /* renamed from: a */
    public static boolean m26927a(Context context, String str) {
    ...
    /* renamed from: p */
    public static String m26955p(Context context) {
    ...
    /* renamed from: bh */
    public static String m26941bh() {
        return Locale.getDefault().getLanguage();
    }

    /* renamed from: q */
    public static String m26956q(Context context) {
        if (f22601gU.equals("")) {
            synchronized ("2.5.1.472") {
                if (f22601gU.equals("")) {
                    f22601gU = m26957r(context);
                }
            }
        }
        return f22601gU;
    ...
    /* renamed from: aa */
    private static String m26930aa(String str) {
        try {
            ...
            for (int i = 0; i < length; i++) {
                ...
                sb.append(Character.forDigit(digest[i] & Ascii.f15551SI, 16));
            }
            return sb.toString();
    ...
    /* renamed from: c */
    private static String m26943c(int i) {
    ...
    /* renamed from: c */
    public static String m26944c(String str) {
    ...
    /* renamed from: g */
    public static String m26948g(AppnextAd appnextAd) {
        String str;
    ...
    /* renamed from: s */
    public static boolean m26958s(Context context) {
        try {
            if (context.checkPermission("android.permission.ACCESS_NETWORK_STATE", Process.myPid(), Process.myUid()) != 0) {
                m26919a("http://www.appnext.com/myid.html", (HashMap<String, String>) null);
                return true;
            }
            NetworkInfo activeNetworkInfo = ((ConnectivityManager) context.getSystemService("connectivity")).getActiveNetworkInfo();
            if (activeNetworkInfo != null && activeNetworkInfo.isConnected()) {
    ...
    /* renamed from: a */
    public static void m26925a(File file) {
        if (file.isDirectory()) {
    ...
    /* renamed from: r */
    public static String m26957r(Context context) {
        String b = m26931b(context, true);
        if (b.equals("")) {
            return m26943c(32);
        }
        return m26930aa(b + "_" + (System.currentTimeMillis() / 1000));
    }
}
