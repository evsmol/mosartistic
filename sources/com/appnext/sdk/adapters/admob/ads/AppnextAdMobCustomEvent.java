...
public abstract class AppnextAdMobCustomEvent implements CustomEventInterstitial {
    ...
    protected C8874Ad mAd;
    protected CustomEventInterstitialListener mListener;

    /* access modifiers changed from: protected */
    public abstract C8874Ad createAd(Context context, String str, Bundle bundle);
    ...
    public void requestInterstitialAd(Context context, CustomEventInterstitialListener customEventInterstitialListener, String str, MediationAdRequest mediationAdRequest, Bundle bundle) {
        try {
            C8874Ad createAd = createAd(context, str, bundle);
            this.mAd = createAd;
            if (createAd == null) {
            ...
            this.mAd.setOnAdErrorCallback(new OnAdError() {
                ...
                public void adError(java.lang.String r6) {
                    ...
                    L_0x004d:
                        ...
                        return
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.appnext.sdk.adapters.admob.ads.AppnextAdMobCustomEvent.C89735.adError(java.lang.String):void");
                }
            });
            this.mAd.loadAd();
        } catch (Throwable th) {
