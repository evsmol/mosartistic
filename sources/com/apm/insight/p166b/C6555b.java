...
public class C6555b {
    ...
    /* renamed from: a */
    static volatile boolean f13994a = true;

    /* renamed from: f */
    private static volatile boolean f13995f;

    /* renamed from: A */
    private long f13996A = 0;

    /* renamed from: B */
    private final Runnable f13997B = new Runnable() {
        public void run() {
            try {
                C6555b.this.mo51982a(200, 25);
            } catch (Throwable th) {
    ...
    /* renamed from: D */
    private List<Pattern> f13999D = null;

    /* renamed from: E */
    private File f14000E = null;

    /* renamed from: b */
    Pattern f14001b = null;

    /* renamed from: c */
    private C6558c f14002c;
    ...
    /* renamed from: g */
    private long f14005g = -1;

    /* renamed from: h */
    private File f14006h = null;
    /* access modifiers changed from: private */

    /* renamed from: i */
    public boolean f14007i = true;

    /* renamed from: j */
    private JSONObject f14008j;

    /* renamed from: k */
    private JSONObject f14009k;

    /* renamed from: l */
    private String f14010l = DtbDeviceDataRetriever.ORIENTATION_UNKNOWN;

    /* renamed from: m */
    private String f14011m = DtbDeviceDataRetriever.ORIENTATION_UNKNOWN;

    /* renamed from: n */
    private String f14012n = DtbDeviceDataRetriever.ORIENTATION_UNKNOWN;

    /* renamed from: o */
    private String f14013o = "npth_inner_default";

    /* renamed from: p */
    private JSONArray f14014p;

    /* renamed from: q */
    private JSONObject f14015q;

    /* renamed from: r */
    private int f14016r = 0;

    /* renamed from: s */
    private long f14017s = -1;

    /* renamed from: t */
    private JSONArray f14018t;

    /* renamed from: u */
    private JSONArray f14019u;

    /* renamed from: v */
    private JSONObject f14020v;

    /* renamed from: w */
    private boolean f14021w;

    /* renamed from: x */
    private final Object f14022x = new Object();

    /* renamed from: y */
    private volatile boolean f14023y;

    /* renamed from: z */
    private long f14024z = -1;

    public C6555b(Context context) {
        this.f14003d = context;
    }

    /* renamed from: a */
    private static String m16008a(float f) {
        return f <= 0.0f ? "0%" : f <= 0.1f ? "0% - 10%" : f <= 0.3f ? "10% - 30%" : f <= 0.6f ? "30% - 60%" : f <= 0.9f ? "60% - 90%" : "90% - 100%";
    }

    /* renamed from: a */
    private static String m16009a(float f, float f2) {
        return f2 > 0.0f ? m16008a(f / f2) : f > 0.0f ? "100%" : "0%";
    }

    /* renamed from: a */
    private JSONObject m16010a(String str, JSONArray jSONArray) {
        JSONObject jSONObject = new JSONObject();
        JSONArray a = C6678l.m16554a(256, 128, jSONArray);
    ...
    private void m16011a(java.lang.String r30, org.json.JSONObject r31) {
        /*
            r29 = this;
            r0 = r29
            r1 = r31
        ...
        L_0x00fb:
            ...
            goto L_0x01aa
        L_0x0112:
            android.content.Context r11 = r0.f14003d
        ...
        L_0x01de:
            r26 = r8
            int r8 = com.apm.insight.p178l.C6668d.m16503e()     // Catch:{ all -> 0x01f0 }
        ...
        L_0x02b5:
            r20 = r7
            int r7 = com.apm.insight.p178l.C6668d.m16503e()     // Catch:{ all -> 0x02c7 }
        ...
        L_0x040e:
            ...
            goto L_0x044c
        L_0x043d:
            java.lang.Float r0 = com.apm.insight.p178l.C6689r.m16634a((java.util.Map<? super java.lang.String, java.lang.Float>) r6)
            float r0 = r0.floatValue()
            java.lang.String r0 = m16017b((float) r0)
            r2.put(r1, r0)
        L_0x044c:
            ...
            goto L_0x0467
        L_0x0458:
            java.lang.Float r0 = com.apm.insight.p178l.C6689r.m16634a((java.util.Map<? super java.lang.String, java.lang.Float>) r27)
            float r0 = r0.floatValue()
            java.lang.String r0 = m16017b((float) r0)
            r2.put(r1, r0)
        L_0x0467:
            ...
            goto L_0x0482
        L_0x0473:
            java.lang.Float r0 = com.apm.insight.p178l.C6689r.m16634a((java.util.Map<? super java.lang.String, java.lang.Float>) r26)
            float r0 = r0.floatValue()
            java.lang.String r0 = m16017b((float) r0)
            r2.put(r1, r0)
        L_0x0482:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.apm.insight.p166b.C6555b.m16011a(java.lang.String, org.json.JSONObject):void");
    }

    /* renamed from: a */
    private static void m16012a(HashMap<String, Float> hashMap, JSONObject jSONObject, String str) {
        String str2;
        String a;
        ...
        if (hashMap.isEmpty()) {
            ...
            jSONObject.put(str3 + "_total", m16017b(f6));
            jSONObject.put(str3 + "_kernel_user_ratio", m16009a(f2, f6));
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void m16013a(org.json.JSONArray r17) {
        /*
            r16 = this;
            r1 = r16
            r2 = r17
        ...
        L_0x0030:
            ...
            if (r11 != 0) goto L_0x00bb
            org.json.JSONObject r11 = r1.f14008j
            if (r11 != 0) goto L_0x0064
            boolean r11 = r15.equals(r0)
            if (r11 == 0) goto L_0x0064
            org.json.JSONObject r11 = r1.m16022c((org.json.JSONArray) r8)
            r1.f14008j = r11
            goto L_0x006b
        L_0x0064:
            org.json.JSONObject r11 = r1.m16010a((java.lang.String) r0, (org.json.JSONArray) r8)
            r5.put(r11)
        L_0x006b:
        ...
        L_0x007d:
            r11 = r0
            boolean r0 = r1.m16016a((java.lang.String) r11)
            if (r0 != 0) goto L_0x00bb
            int[] r0 = r1.m16020b((org.json.JSONArray) r8)     // Catch:{ IllegalArgumentException -> 0x0089, all -> 0x0092 }
            goto L_0x0093
        L_0x0089:
            r0 = move-exception
            r12 = r0
            com.apm.insight.c r0 = com.apm.insight.C6553b.m16004a()
            r0.mo52019a((java.lang.String) r13, (java.lang.Throwable) r12)
        L_0x0092:
            r0 = 0
        L_0x0093:
        ...
        L_0x00d0:
            ...
            if (r12 != 0) goto L_0x014c
            org.json.JSONObject r12 = r1.f14008j
            if (r12 != 0) goto L_0x00f5
            boolean r12 = r15.equals(r0)
            if (r12 == 0) goto L_0x00f5
            org.json.JSONObject r12 = r1.m16022c((org.json.JSONArray) r8)
            r1.f14008j = r12
            goto L_0x00fc
        L_0x00f5:
            org.json.JSONObject r12 = r1.m16010a((java.lang.String) r0, (org.json.JSONArray) r8)
            r5.put(r12)
        L_0x00fc:
        ...
        L_0x010e:
            r12 = r0
            boolean r0 = r1.m16016a((java.lang.String) r12)
            if (r0 != 0) goto L_0x014c
            int[] r0 = r1.m16020b((org.json.JSONArray) r8)     // Catch:{ IllegalArgumentException -> 0x011a, all -> 0x0123 }
            goto L_0x0124
        L_0x011a:
            r0 = move-exception
            r14 = r0
            com.apm.insight.c r0 = com.apm.insight.C6553b.m16004a()
            r0.mo52019a((java.lang.String) r13, (java.lang.Throwable) r14)
        L_0x0123:
            r0 = 0
        L_0x0124:
        ...
        L_0x01dd:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.apm.insight.p166b.C6555b.m16013a(org.json.JSONArray):void");
    }

    /* renamed from: a */
    private boolean m16014a(long j) {
        if (this.f14023y) {
            this.f14023y = false;
            m16018b(j);
        }
    ...
    /* renamed from: a */
    private boolean m16016a(String str) {
        if (this.f13999D == null) {
            JSONArray c = C6718a.m16800c();
            if (c != null) {
                this.f13999D = new LinkedList();
                this.f14013o = c.optString(0);
                for (int i = 1; i < c.length(); i++) {
                    try {
                        this.f13999D.add(Pattern.compile(c.optString(i)));
            ...
            if (this.f13999D == null) {
                ...
                this.f13999D = linkedList;
                linkedList.add(Pattern.compile("^main$"));
                this.f13999D.add(Pattern.compile("^default_npth_thread$"));
                this.f13999D.add(Pattern.compile("^RenderThread$"));
                this.f13999D.add(Pattern.compile("^Jit thread pool worker thread.*$"));
            }
        }
        for (Pattern matcher : this.f13999D) {
    ...
    /* renamed from: b */
    private static String m16017b(float f) {
        return m16008a(f / 100.0f);
    }
    ...
    private void m16018b(long r18) {
        /*
            ...
            r1.f14017s = r4     // Catch:{ all -> 0x005f }
            com.apm.insight.b.h r4 = com.apm.insight.p166b.C6564g.m16055b()     // Catch:{ all -> 0x005f }
            org.json.JSONArray r4 = r4.mo52003c()     // Catch:{ all -> 0x005f }
            r1.f14019u = r4     // Catch:{ all -> 0x005f }
            r4 = 100
            org.json.JSONArray r4 = com.apm.insight.p166b.C6581k.m16106a((int) r4, (long) r2)     // Catch:{ all -> 0x005f }
            r1.f14018t = r4     // Catch:{ all -> 0x005f }
            com.apm.insight.b.h r4 = com.apm.insight.p166b.C6564g.m16055b()     // Catch:{ all -> 0x005f }
            com.apm.insight.b.h$e r2 = r4.mo52000a((long) r2)     // Catch:{ all -> 0x005f }
            org.json.JSONObject r2 = r2.mo52008a()     // Catch:{ all -> 0x005f }
            r1.f14009k = r2     // Catch:{ all -> 0x005f }
            org.json.JSONObject r2 = new org.json.JSONObject     // Catch:{ all -> 0x005f }
            r2.<init>()     // Catch:{ all -> 0x005f }
            r1.f14020v = r2     // Catch:{ all -> 0x005f }
            android.content.Context r3 = r1.f14003d     // Catch:{ all -> 0x005f }
            com.apm.insight.p178l.C6662a.m16473a((android.content.Context) r3, (org.json.JSONObject) r2)     // Catch:{ all -> 0x005f }
            boolean r2 = r17.m16023g()     // Catch:{ all -> 0x005f }
            r1.f14021w = r2     // Catch:{ all -> 0x005f }
        ...
        L_0x005c:
            r2 = 0
        L_0x005d:
            r1.f14007i = r2     // Catch:{ all -> 0x005f }
        L_0x005f:
            int r2 = android.os.Build.VERSION.SDK_INT     // Catch:{ all -> 0x00ee }
            if (r2 < r12) goto L_0x00e3
            long r2 = r1.f14017s     // Catch:{ all -> 0x00ee }
            r1.f14005g = r2     // Catch:{ all -> 0x00ee }
            java.lang.String r2 = com.apm.insight.p178l.C6685o.m16593b()     // Catch:{ all -> 0x00ee }
            java.io.File r3 = new java.io.File     // Catch:{ all -> 0x00ee }
            java.io.File r4 = new java.io.File     // Catch:{ all -> 0x00ee }
            android.content.Context r5 = r1.f14003d     // Catch:{ all -> 0x00ee }
            java.io.File r5 = com.apm.insight.p178l.C6685o.m16604f((android.content.Context) r5)     // Catch:{ all -> 0x00ee }
            ...
            android.content.Context r6 = r1.f14003d     // Catch:{ all -> 0x00ee }
            java.lang.String r6 = com.apm.insight.p178l.C6662a.m16480c(r6)     // Catch:{ all -> 0x00ee }
            ...
            java.text.DateFormat r5 = com.apm.insight.p178l.C6663b.m16485a()     // Catch:{ all -> 0x00ee }
            ...
            com.apm.insight.p178l.C6675i.m16524a((java.io.File) r3, (java.lang.String) r4, (boolean) r13)     // Catch:{ all -> 0x00ee }
            com.apm.insight.runtime.C6764r.m17029a((java.lang.String) r0, (java.lang.String) r2)     // Catch:{ all -> 0x00ee }
            java.lang.String r0 = r3.getAbsolutePath()     // Catch:{ all -> 0x00ee }
            com.apm.insight.nativecrash.NativeImpl.m16728i(r0)     // Catch:{ all -> 0x00ee }
            java.lang.String r0 = r3.getAbsolutePath()     // Catch:{ IOException -> 0x00e3, all -> 0x00db }
            org.json.JSONArray r0 = com.apm.insight.p178l.C6675i.m16535b((java.lang.String) r0)     // Catch:{ IOException -> 0x00e3, all -> 0x00db }
            r1.f14014p = r0     // Catch:{ IOException -> 0x00e3, all -> 0x00db }
            r1.m16013a((org.json.JSONArray) r0)     // Catch:{ IOException -> 0x00e3, all -> 0x00db }
            goto L_0x00e3
        L_0x00db:
            r0 = move-exception
            com.apm.insight.c r2 = com.apm.insight.C6553b.m16004a()     // Catch:{ all -> 0x00ee }
            r2.mo52019a((java.lang.String) r15, (java.lang.Throwable) r0)     // Catch:{ all -> 0x00ee }
        L_0x00e3:
            org.json.JSONObject r0 = r1.f14008j     // Catch:{ all -> 0x00ee }
            if (r0 != 0) goto L_0x00f6
            org.json.JSONObject r0 = com.apm.insight.p166b.C6560d.m16044a((boolean) r14)     // Catch:{ all -> 0x00ee }
            r1.f14008j = r0     // Catch:{ all -> 0x00ee }
            goto L_0x00f6
        L_0x00ee:
            r0 = move-exception
            com.apm.insight.c r2 = com.apm.insight.C6553b.m16004a()
            r2.mo52019a((java.lang.String) r15, (java.lang.Throwable) r0)
        L_0x00f6:
            com.apm.insight.p178l.C6672f.m16507a()
            goto L_0x0192
        L_0x00fb:
            long r2 = r1.f14017s     // Catch:{ all -> 0x018a }
            r1.f14005g = r2     // Catch:{ all -> 0x018a }
            int r2 = android.os.Build.VERSION.SDK_INT     // Catch:{ all -> 0x018a }
            if (r2 < r12) goto L_0x017f
            java.lang.String r2 = com.apm.insight.p178l.C6685o.m16593b()     // Catch:{ all -> 0x018a }
            java.io.File r3 = new java.io.File     // Catch:{ all -> 0x018a }
            java.io.File r4 = new java.io.File     // Catch:{ all -> 0x018a }
            android.content.Context r5 = r1.f14003d     // Catch:{ all -> 0x018a }
            java.io.File r5 = com.apm.insight.p178l.C6685o.m16604f((android.content.Context) r5)     // Catch:{ all -> 0x018a }
            ...
            android.content.Context r6 = r1.f14003d     // Catch:{ all -> 0x018a }
            java.lang.String r6 = com.apm.insight.p178l.C6662a.m16480c(r6)     // Catch:{ all -> 0x018a }
            ...
            java.text.DateFormat r5 = com.apm.insight.p178l.C6663b.m16485a()     // Catch:{ all -> 0x018a }
            ...
            com.apm.insight.p178l.C6675i.m16524a((java.io.File) r3, (java.lang.String) r4, (boolean) r13)     // Catch:{ all -> 0x018a }
            com.apm.insight.runtime.C6764r.m17029a((java.lang.String) r0, (java.lang.String) r2)     // Catch:{ all -> 0x018a }
            java.lang.String r0 = r3.getAbsolutePath()     // Catch:{ all -> 0x018a }
            com.apm.insight.nativecrash.NativeImpl.m16728i(r0)     // Catch:{ all -> 0x018a }
            java.lang.String r0 = r3.getAbsolutePath()     // Catch:{ IOException -> 0x017f, all -> 0x0177 }
            org.json.JSONArray r0 = com.apm.insight.p178l.C6675i.m16535b((java.lang.String) r0)     // Catch:{ IOException -> 0x017f, all -> 0x0177 }
            r1.f14014p = r0     // Catch:{ IOException -> 0x017f, all -> 0x0177 }
            r1.m16013a((org.json.JSONArray) r0)     // Catch:{ IOException -> 0x017f, all -> 0x0177 }
            goto L_0x017f
        L_0x0177:
            r0 = move-exception
            com.apm.insight.c r2 = com.apm.insight.C6553b.m16004a()     // Catch:{ all -> 0x018a }
            r2.mo52019a((java.lang.String) r15, (java.lang.Throwable) r0)     // Catch:{ all -> 0x018a }
        L_0x017f:
            org.json.JSONObject r0 = r1.f14008j     // Catch:{ all -> 0x018a }
            if (r0 != 0) goto L_0x0192
            org.json.JSONObject r0 = com.apm.insight.p166b.C6560d.m16044a((boolean) r14)     // Catch:{ all -> 0x018a }
            r1.f14008j = r0     // Catch:{ all -> 0x018a }
            goto L_0x0192
        L_0x018a:
            r0 = move-exception
            com.apm.insight.c r2 = com.apm.insight.C6553b.m16004a()
        ...
        L_0x01a3:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.apm.insight.p166b.C6555b.m16018b(long):void");
    }

    /* renamed from: b */
    private static void m16019b(String str) {
        for (ICrashCallback onCrash : C6756o.m16977a().mo52289e()) {
            try {
    ...
    /* renamed from: b */
    private int[] m16020b(JSONArray jSONArray) {
        int i = 0;
        while (i < jSONArray.length()) {
            ...
            if (indexOf > 0) {
                if (this.f14001b == null) {
                    this.f14001b = Pattern.compile("[^0-9]+");
                }
                String[] split = this.f14001b.split(optString.substring(indexOf));
    ...
    /* renamed from: c */
    private String m16021c(long j) {
        long j2 = j - C6617h.m16316j();
    ...
    /* renamed from: c */
    private JSONObject m16022c(JSONArray jSONArray) {
        JSONObject jSONObject = new JSONObject();
        JSONArray a = C6678l.m16554a(256, 128, jSONArray);
        if (a.length() != jSONArray.length()) {
            this.f14016r++;
    ...
    /* renamed from: g */
    private boolean m16023g() {
        boolean z = !C6662a.m16477a(this.f14003d);
        if (!z || C6720b.m16835d().mo52250e() > 2000) {
            return z;
        }
        return false;
    }
    ...
    /* renamed from: h */
    private File m16024h() {
        if (this.f14000E == null) {
            File filesDir = this.f14003d.getFilesDir();
            this.f14000E = new File(filesDir, "has_anr_signal_" + C6662a.m16480c(this.f14003d).replaceAll(":", "_"));
        }
        return this.f14000E;
    }

    /* renamed from: i */
    private boolean m16025i() {
        return C6718a.m16807i();
    }

    /* renamed from: a */
    public void mo51981a() {
        if (!this.f14004e) {
            this.f14002c = new C6558c(this);
            this.f14005g = C6617h.m16316j();
            this.f14004e = true;
        }
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean mo51982a(int r26, int r27) {
        /*
            r25 = this;
            r1 = r25
            boolean r0 = com.apm.insight.p166b.C6563f.m16052a()
            long r2 = android.os.SystemClock.uptimeMillis()
            boolean r4 = r1.m16014a((long) r2)
            android.content.Context r5 = r1.f14003d
            r6 = 1
            java.lang.String r5 = com.apm.insight.p166b.C6560d.m16042a((android.content.Context) r5, (int) r6)
        ...
        L_0x0038:
            ...
            goto L_0x00c1
        L_0x004a:
            java.lang.Object r4 = r1.f14022x
            monitor-enter(r4)
        ...
        L_0x0052:
            ...
            org.json.JSONObject r4 = r1.f14008j
        ...
        L_0x0078:
            org.json.JSONObject r4 = r1.f14008j
            java.lang.String r12 = r1.f14010l
            java.lang.String r13 = r1.f14011m
            java.lang.String r14 = r1.f14012n
            org.json.JSONArray r6 = r1.f14014p
            org.json.JSONArray r7 = r1.f14019u
            org.json.JSONArray r15 = r1.f14018t
            org.json.JSONObject r11 = r1.f14020v
            r19 = r4
            org.json.JSONObject r4 = r1.f14009k
            r20 = r4
            boolean r4 = r1.f14021w
            r21 = r6
            r22 = r7
            long r6 = r1.f14017s
            r23 = r4
        ...
        L_0x00c1:
            ...
            org.json.JSONObject r0 = r1.f14008j
        ...
        L_0x00ff:
            ...
            int r0 = (r2 > r4 ? 1 : (r2 == r4 ? 0 : -1))
            if (r0 <= 0) goto L_0x011f
            boolean r0 = com.apm.insight.nativecrash.NativeImpl.m16724g()
            if (r0 == 0) goto L_0x011d
            java.io.File r0 = r25.m16024h()
            com.apm.insight.p178l.C6675i.m16532a((java.io.File) r0)
        L_0x011d:
            r2 = 0
            return r2
        ...
        L_0x0121:
            ...
            com.apm.insight.b.h r17 = com.apm.insight.p166b.C6564g.m16055b()     // Catch:{ all -> 0x0152 }
            org.json.JSONArray r17 = r17.mo52003c()     // Catch:{ all -> 0x0152 }
            r18 = r11
            r11 = 100
            org.json.JSONArray r15 = com.apm.insight.p166b.C6581k.m16106a((int) r11, (long) r2)     // Catch:{ all -> 0x014f }
            com.apm.insight.b.h r11 = com.apm.insight.p166b.C6564g.m16055b()     // Catch:{ all -> 0x014f }
            com.apm.insight.b.h$e r2 = r11.mo52000a((long) r2)     // Catch:{ all -> 0x014f }
            org.json.JSONObject r20 = r2.mo52008a()     // Catch:{ all -> 0x014f }
            org.json.JSONObject r2 = new org.json.JSONObject     // Catch:{ all -> 0x014f }
            r2.<init>()     // Catch:{ all -> 0x014f }
            android.content.Context r3 = r1.f14003d     // Catch:{ all -> 0x014d }
            com.apm.insight.p178l.C6662a.m16473a((android.content.Context) r3, (org.json.JSONObject) r2)     // Catch:{ all -> 0x014d }
            r11 = r2
            goto L_0x015b
        L_0x014d:
            r11 = r2
        ...
        L_0x0157:
            ...
            r17 = r21
        L_0x015b:
            boolean r2 = f13994a     // Catch:{ all -> 0x0161 }
            org.json.JSONObject r19 = com.apm.insight.p166b.C6560d.m16044a((boolean) r2)     // Catch:{ all -> 0x0161 }
        L_0x0161:
            r2 = r17
            r3 = r19
            r17 = r9
        ...
        L_0x0174:
            ...
            android.content.Context r5 = r1.f14003d     // Catch:{ all -> 0x0493 }
            ...
            r0.mo52052a((java.lang.String) r5, (java.lang.Object) r6)     // Catch:{ all -> 0x0493 }
            java.lang.String r5 = "is_anr"
            r26 = r3
            r6 = 1
            java.lang.Integer r3 = java.lang.Integer.valueOf(r6)     // Catch:{ all -> 0x0493 }
            r0.mo52052a((java.lang.String) r5, (java.lang.Object) r3)     // Catch:{ all -> 0x0493 }
            java.lang.String r3 = "anrType"
            r0.mo52052a((java.lang.String) r3, (java.lang.Object) r12)     // Catch:{ all -> 0x0493 }
            java.lang.String r3 = "history_message"
            r0.mo52052a((java.lang.String) r3, (java.lang.Object) r2)     // Catch:{ all -> 0x0493 }
            java.lang.String r2 = "current_message"
            r0.mo52052a((java.lang.String) r2, (java.lang.Object) r9)     // Catch:{ all -> 0x0493 }
            java.lang.String r2 = "pending_messages"
            r0.mo52052a((java.lang.String) r2, (java.lang.Object) r15)     // Catch:{ all -> 0x0493 }
            ...
            r0.mo52052a((java.lang.String) r2, (java.lang.Object) r3)     // Catch:{ all -> 0x0493 }
            java.lang.String r2 = "crash_time"
            java.lang.Long r3 = java.lang.Long.valueOf(r7)     // Catch:{ all -> 0x0493 }
            r0.mo52052a((java.lang.String) r2, (java.lang.Object) r3)     // Catch:{ all -> 0x0493 }
            com.apm.insight.p167c.C6584b.m16116b()     // Catch:{ all -> 0x0493 }
            r0.mo52060c((org.json.JSONObject) r11)     // Catch:{ all -> 0x0493 }
        ...
        L_0x01fb:
            ...
            r0.mo52052a((java.lang.String) r2, (java.lang.Object) r4)     // Catch:{ all -> 0x0493 }
        L_0x0205:
            java.lang.String r2 = "all_thread_stacks"
            if (r10 != 0) goto L_0x021b
            org.json.JSONObject r3 = r1.f14015q     // Catch:{ all -> 0x0493 }
        ...
        L_0x0215:
            r3 = 0
            org.json.JSONObject r4 = com.apm.insight.p178l.C6693v.m16674b((java.lang.String) r3)     // Catch:{ all -> 0x0493 }
            goto L_0x021d
        L_0x021b:
            org.json.JSONObject r4 = r1.f14015q     // Catch:{ all -> 0x0493 }
        L_0x021d:
            r0.mo52052a((java.lang.String) r2, (java.lang.Object) r4)     // Catch:{ all -> 0x0493 }
            com.apm.insight.runtime.a.f r2 = com.apm.insight.runtime.p179a.C6729f.m16893a()     // Catch:{ all -> 0x0493 }
            com.apm.insight.CrashType r3 = com.apm.insight.CrashType.ANR     // Catch:{ all -> 0x0493 }
            com.apm.insight.entity.a r2 = r2.mo52278a((com.apm.insight.CrashType) r3, (com.apm.insight.entity.C6594a) r0)     // Catch:{ all -> 0x0493 }
            java.lang.String r0 = "is_background"
            java.lang.Boolean r3 = java.lang.Boolean.valueOf(r23)     // Catch:{ all -> 0x0493 }
            r2.mo52052a((java.lang.String) r0, (java.lang.Object) r3)     // Catch:{ all -> 0x0493 }
            java.lang.String r0 = "logcat"
            java.lang.String r3 = com.apm.insight.C6617h.m16312f()     // Catch:{ all -> 0x0493 }
            org.json.JSONArray r3 = com.apm.insight.runtime.C6751k.m16959b(r3)     // Catch:{ all -> 0x0493 }
            r2.mo52052a((java.lang.String) r0, (java.lang.Object) r3)     // Catch:{ all -> 0x0493 }
            ...
            com.apm.insight.CrashType r3 = com.apm.insight.CrashType.ANR     // Catch:{ all -> 0x0493 }
            r4 = 0
            java.lang.String r3 = com.apm.insight.C6617h.m16298a(r7, r3, r4, r4)     // Catch:{ all -> 0x0493 }
            r2.mo52052a((java.lang.String) r0, (java.lang.Object) r3)     // Catch:{ all -> 0x0493 }
            java.lang.String r0 = "jiffy"
            long r3 = com.apm.insight.runtime.C6762q.C6763a.m17022a()     // Catch:{ all -> 0x0493 }
            java.lang.Long r3 = java.lang.Long.valueOf(r3)     // Catch:{ all -> 0x0493 }
            r2.mo52052a((java.lang.String) r0, (java.lang.Object) r3)     // Catch:{ all -> 0x0493 }
            org.json.JSONObject r0 = r2.mo52066h()     // Catch:{ all -> 0x0493 }
            java.lang.String r3 = "filters"
            org.json.JSONObject r0 = r0.optJSONObject(r3)     // Catch:{ all -> 0x0493 }
            org.json.JSONObject r3 = r2.mo52066h()     // Catch:{ all -> 0x0493 }
            com.apm.insight.entity.C6598d.m16214b(r3)     // Catch:{ all -> 0x0493 }
            if (r0 != 0) goto L_0x0283
            org.json.JSONObject r3 = new org.json.JSONObject     // Catch:{ all -> 0x027f }
            r3.<init>()     // Catch:{ all -> 0x027f }
            java.lang.String r0 = "filters"
            r2.mo52052a((java.lang.String) r0, (java.lang.Object) r3)     // Catch:{ all -> 0x027e }
            goto L_0x0284
        L_0x027e:
            r0 = r3
        L_0x027f:
        ...
        L_0x0284:
            ...
            java.lang.String r4 = r1.f14013o     // Catch:{ all -> 0x03e7 }
            r3.put(r0, r4)     // Catch:{ all -> 0x03e7 }
            java.lang.String r0 = "crash_length"
            java.lang.String r4 = r1.m16021c((long) r7)     // Catch:{ all -> 0x03e7 }
            r3.put(r0, r4)     // Catch:{ all -> 0x03e7 }
            java.lang.String r0 = "disable_looper_monitor"
            boolean r4 = com.apm.insight.runtime.C6718a.m16802d()     // Catch:{ all -> 0x03e7 }
            java.lang.String r4 = java.lang.String.valueOf(r4)     // Catch:{ all -> 0x03e7 }
            r3.put(r0, r4)     // Catch:{ all -> 0x03e7 }
            java.lang.String r0 = "npth_force_apm_crash"
            boolean r4 = com.apm.insight.p167c.C6584b.m16116b()     // Catch:{ all -> 0x03e7 }
            java.lang.String r4 = java.lang.String.valueOf(r4)     // Catch:{ all -> 0x03e7 }
            r3.put(r0, r4)     // Catch:{ all -> 0x03e7 }
            ...
            boolean r4 = r2.mo52053a()     // Catch:{ all -> 0x03e7 }
            java.lang.String r4 = java.lang.String.valueOf(r4)     // Catch:{ all -> 0x03e7 }
            r3.put(r0, r4)     // Catch:{ all -> 0x03e7 }
            java.lang.String r0 = "memory_leak"
            boolean r4 = r2.mo52064f()     // Catch:{ all -> 0x03e7 }
            java.lang.String r4 = java.lang.String.valueOf(r4)     // Catch:{ all -> 0x03e7 }
            r3.put(r0, r4)     // Catch:{ all -> 0x03e7 }
            java.lang.String r0 = "fd_leak"
            boolean r4 = r2.mo52061d()     // Catch:{ all -> 0x03e7 }
            java.lang.String r4 = java.lang.String.valueOf(r4)     // Catch:{ all -> 0x03e7 }
            r3.put(r0, r4)     // Catch:{ all -> 0x03e7 }
            java.lang.String r0 = "threads_leak"
            boolean r4 = r2.mo52063e()     // Catch:{ all -> 0x03e7 }
            java.lang.String r4 = java.lang.String.valueOf(r4)     // Catch:{ all -> 0x03e7 }
            r3.put(r0, r4)     // Catch:{ all -> 0x03e7 }
            java.lang.String r0 = "is_64_devices"
            boolean r4 = com.apm.insight.entity.Header.m16141a()     // Catch:{ all -> 0x03e7 }
            java.lang.String r4 = java.lang.String.valueOf(r4)     // Catch:{ all -> 0x03e7 }
            r3.put(r0, r4)     // Catch:{ all -> 0x03e7 }
            java.lang.String r0 = "is_64_runtime"
            boolean r4 = com.apm.insight.nativecrash.NativeImpl.m16720e()     // Catch:{ all -> 0x03e7 }
            java.lang.String r4 = java.lang.String.valueOf(r4)     // Catch:{ all -> 0x03e7 }
            r3.put(r0, r4)     // Catch:{ all -> 0x03e7 }
            java.lang.String r0 = "is_x86_devices"
            boolean r4 = com.apm.insight.entity.Header.m16144b()     // Catch:{ all -> 0x03e7 }
            java.lang.String r4 = java.lang.String.valueOf(r4)     // Catch:{ all -> 0x03e7 }
            r3.put(r0, r4)     // Catch:{ all -> 0x03e7 }
            java.lang.String r0 = "has_meminfo_file"
            boolean r4 = r2.mo52065g()     // Catch:{ all -> 0x03e7 }
            java.lang.String r4 = java.lang.String.valueOf(r4)     // Catch:{ all -> 0x03e7 }
            r3.put(r0, r4)     // Catch:{ all -> 0x03e7 }
            java.lang.String r0 = "is_root"
            boolean r4 = com.apm.insight.nativecrash.C6700b.m16747m()     // Catch:{ all -> 0x03e7 }
        ...
        L_0x0340:
            ...
            boolean r4 = r1.f14023y     // Catch:{ all -> 0x03e7 }
        ...
        L_0x0368:
            ...
            boolean r4 = com.apm.insight.p166b.C6560d.m16046a()     // Catch:{ all -> 0x03e7 }
            java.lang.String r4 = java.lang.String.valueOf(r4)     // Catch:{ all -> 0x03e7 }
            r3.put(r0, r4)     // Catch:{ all -> 0x03e7 }
            java.lang.String r0 = "has_dump"
            java.lang.String r4 = "true"
            ...
            com.apm.insight.runtime.a.b r4 = com.apm.insight.runtime.p179a.C6720b.m16835d()     // Catch:{ all -> 0x03e7 }
            java.lang.String r4 = r4.mo52253h()     // Catch:{ all -> 0x03e7 }
            r3.put(r0, r4)     // Catch:{ all -> 0x03e7 }
            int r0 = r1.f14016r     // Catch:{ all -> 0x03e7 }
            if (r0 <= 0) goto L_0x03a4
            java.lang.String r0 = "may_have_stack_overflow"
            int r4 = r1.f14016r     // Catch:{ all -> 0x027e }
            java.lang.String r4 = java.lang.String.valueOf(r4)     // Catch:{ all -> 0x027e }
            r3.put(r0, r4)     // Catch:{ all -> 0x027e }
        L_0x03a4:
            if (r10 != 0) goto L_0x03b8
            r4 = r18
            r1.m16011a((java.lang.String) r4, (org.json.JSONObject) r3)     // Catch:{ all -> 0x03ac }
            goto L_0x03eb
        L_0x03ac:
            r0 = move-exception
            r5 = r0
            com.apm.insight.c r0 = com.apm.insight.C6553b.m16004a()     // Catch:{ all -> 0x03e9 }
            java.lang.String r6 = "NPTH_CATCH"
            r0.mo52019a((java.lang.String) r6, (java.lang.Throwable) r5)     // Catch:{ all -> 0x03e9 }
            goto L_0x03eb
        L_0x03b8:
            r4 = r18
            boolean r0 = r25.m16025i()     // Catch:{ all -> 0x03e9 }
            if (r0 != 0) goto L_0x03eb
            java.lang.String r0 = "aid"
            com.apm.insight.entity.Header r5 = r2.mo52067i()     // Catch:{ all -> 0x03e9 }
            org.json.JSONObject r5 = r5.mo52042f()     // Catch:{ all -> 0x03e9 }
            ...
            com.apm.insight.entity.Header r0 = r2.mo52067i()     // Catch:{ all -> 0x03e9 }
            org.json.JSONObject r0 = r0.mo52042f()     // Catch:{ all -> 0x03e9 }
        ...
        L_0x03eb:
            ...
            java.lang.String r0 = com.apm.insight.p177k.C6647e.m16427c()     // Catch:{ all -> 0x0493 }
            java.io.File r3 = new java.io.File     // Catch:{ all -> 0x0493 }
            android.content.Context r4 = r1.f14003d     // Catch:{ all -> 0x0493 }
            java.io.File r4 = com.apm.insight.p178l.C6685o.m16585a((android.content.Context) r4)     // Catch:{ all -> 0x0493 }
            com.apm.insight.CrashType r5 = com.apm.insight.CrashType.ANR     // Catch:{ all -> 0x0493 }
            r6 = 0
            java.lang.String r5 = com.apm.insight.C6617h.m16298a(r7, r5, r6, r6)     // Catch:{ all -> 0x0493 }
            r3.<init>(r4, r5)     // Catch:{ all -> 0x0493 }
            r1.f14006h = r3     // Catch:{ all -> 0x0493 }
            java.lang.String r4 = r3.getName()     // Catch:{ all -> 0x0493 }
            org.json.JSONObject r2 = r2.mo52066h()     // Catch:{ all -> 0x0493 }
            boolean r5 = com.apm.insight.p177k.C6647e.m16424b()     // Catch:{ all -> 0x0493 }
            com.apm.insight.p178l.C6675i.m16520a(r3, r4, r0, r2, r5)     // Catch:{ all -> 0x0493 }
            goto L_0x049d
        L_0x0416:
            java.io.File r0 = r1.f14006h     // Catch:{ all -> 0x0493 }
            if (r0 == 0) goto L_0x0422
            java.io.File r0 = r1.f14006h     // Catch:{ all -> 0x0493 }
            com.apm.insight.p178l.C6675i.m16532a((java.io.File) r0)     // Catch:{ all -> 0x0493 }
            r5 = 0
            r1.f14006h = r5     // Catch:{ all -> 0x0493 }
        L_0x0422:
            com.apm.insight.a.a r0 = com.apm.insight.p165a.C6549a.m15999a()     // Catch:{ all -> 0x0493 }
            com.apm.insight.CrashType r5 = com.apm.insight.CrashType.ANR     // Catch:{ all -> 0x0493 }
            java.lang.String r6 = com.apm.insight.C6617h.m16311e()     // Catch:{ all -> 0x0493 }
            r0.mo51976a((com.apm.insight.CrashType) r5, (long) r7, (java.lang.String) r6)     // Catch:{ all -> 0x0493 }
            java.io.File r0 = com.apm.insight.p178l.C6672f.m16512f()     // Catch:{ all -> 0x0444 }
            ...
            r2.mo52047a((java.lang.String) r0, (java.lang.String) r5)     // Catch:{ all -> 0x0444 }
        L_0x0444:
            java.lang.String r0 = com.apm.insight.C6617h.m16312f()     // Catch:{ all -> 0x0477 }
            java.io.File r0 = com.apm.insight.p178l.C6685o.m16603e((java.lang.String) r0)     // Catch:{ all -> 0x0477 }
            java.lang.String r5 = com.apm.insight.C6617h.m16312f()     // Catch:{ all -> 0x0477 }
            java.io.File r5 = com.apm.insight.p178l.C6685o.m16606f((java.lang.String) r5)     // Catch:{ all -> 0x0477 }
            org.json.JSONArray r0 = com.apm.insight.nativecrash.C6707c.m16775a(r0, r5)     // Catch:{ all -> 0x0477 }
            ...
            java.lang.String r3 = com.apm.insight.C6617h.m16312f()     // Catch:{ all -> 0x0477 }
            java.io.File r3 = com.apm.insight.p178l.C6685o.m16609g((java.lang.String) r3)     // Catch:{ all -> 0x0477 }
            r5 = 0
            com.apm.insight.p178l.C6675i.m16526a((java.io.File) r3, (org.json.JSONArray) r0, (boolean) r5)     // Catch:{ all -> 0x0477 }
        L_0x0477:
            java.lang.String r0 = "mainStackFromTrace"
            r3 = r26
            java.lang.String r0 = r3.optString(r0)     // Catch:{ all -> 0x0493 }
            org.json.JSONArray r0 = com.apm.insight.entity.C6595b.m16202a((java.lang.String) r0)     // Catch:{ all -> 0x0493 }
            org.json.JSONObject r2 = r2.mo52066h()     // Catch:{ all -> 0x0493 }
            com.apm.insight.b.b$2 r3 = new com.apm.insight.b.b$2     // Catch:{ all -> 0x0493 }
            r3.<init>(r7)     // Catch:{ all -> 0x0493 }
            com.apm.insight.entity.C6595b.m16206a((org.json.JSONObject) r2, (org.json.JSONArray) r0, (com.apm.insight.entity.C6595b.C6596a) r3)     // Catch:{ all -> 0x0493 }
            m16019b((java.lang.String) r4)     // Catch:{ all -> 0x0493 }
            goto L_0x049d
        L_0x0493:
            r0 = move-exception
            com.apm.insight.c r2 = com.apm.insight.C6553b.m16004a()
        ...
        L_0x049e:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.apm.insight.p166b.C6555b.mo51982a(int, int):boolean");
    }

    /* renamed from: b */
    public void mo51983b() {
        if (this.f14004e) {
            this.f14004e = false;
            C6558c cVar = this.f14002c;
            if (cVar != null) {
                cVar.mo51991b();
            }
            this.f14002c = null;
    ...
    /* renamed from: e */
    public void mo51986e() {
        if (NativeImpl.m16724g()) {
            try {
                C6675i.m16524a(m16024h(), String.valueOf(this.f13998C + 1), false);
            } catch (Throwable th) {
                C6553b.m16004a().mo52019a("NPTH_CATCH", th);
            }
        }
        this.f14024z = SystemClock.uptimeMillis();
        this.f14023y = true;
    }

    /* renamed from: f */
    public void mo51987f() {
        File h = m16024h();
        try {
            int intValue = Integer.decode(C6675i.m16540c(h.getAbsolutePath())).intValue();
            this.f13998C = intValue;
            if (intValue >= 2) {
                NativeImpl.m16706a(false);
            } else {
                NativeImpl.m16706a(true);
            }
