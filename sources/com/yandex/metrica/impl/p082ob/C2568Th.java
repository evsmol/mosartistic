...
public final class C2568Th {
    ...
    /* renamed from: a */
    private Map<String, ? extends List<String>> f6799a = MapsKt.emptyMap();

    /* renamed from: b */
    private Map<String, ? extends C2673W0> f6800b = MapsKt.emptyMap();

    /* renamed from: c */
    private C2673W0 f6801c;

    /* renamed from: a */
    public final C2673W0 mo16714a() {
        return this.f6801c;
    }

    /* renamed from: b */
    public final Map<String, C2673W0> mo16717b() {
        return this.f6800b;
    }
    ...
    public final synchronized void mo16715a(com.yandex.metrica.impl.p082ob.C2673W0 r9) {
        /*
            r8 = this;
            monitor-enter(r8)
            com.yandex.metrica.impl.ob.W0 r0 = r8.f6801c     // Catch:{ all -> 0x00ef }
            r1 = 0
            if (r0 == 0) goto L_0x0009
            java.lang.String r0 = r0.f7065a     // Catch:{ all -> 0x00ef }
            goto L_0x000a
        L_0x0009:
            r0 = r1
        L_0x000a:
        ...
        L_0x0018:
            ...
            java.lang.String r0 = r9.f7065a     // Catch:{ all -> 0x00ef }
        ...
        L_0x003d:
            ...
            java.util.List r5 = com.yandex.metrica.impl.p082ob.C2572Tl.m8532b((org.json.JSONArray) r5)     // Catch:{ all -> 0x003d }
        ...
        L_0x0074:
            ...
            org.json.JSONArray r3 = com.yandex.metrica.impl.p082ob.C2572Tl.m8534b((java.util.List<?>) r3)     // Catch:{ all -> 0x00ef }
            java.lang.String r3 = java.lang.String.valueOf(r3)     // Catch:{ all -> 0x00ef }
            com.yandex.metrica.impl.ob.U0 r6 = r9.f7066b     // Catch:{ all -> 0x00ef }
            java.lang.String r7 = r9.f7067c     // Catch:{ all -> 0x00ef }
        ...
        L_0x00ba:
            ...
            com.yandex.metrica.impl.ob.W0 r2 = (com.yandex.metrica.impl.p082ob.C2673W0) r2     // Catch:{ all -> 0x00ef }
            java.lang.String r2 = r2.f7065a     // Catch:{ all -> 0x00ef }
            if (r2 != 0) goto L_0x00d5
            goto L_0x00df
        L_0x00d5:
            org.json.JSONArray r4 = new org.json.JSONArray     // Catch:{ all -> 0x00df }
            r4.<init>(r2)     // Catch:{ all -> 0x00df }
            java.util.List r2 = com.yandex.metrica.impl.p082ob.C2572Tl.m8532b((org.json.JSONArray) r4)     // Catch:{ all -> 0x00df }
            goto L_0x00e0
        L_0x00df:
            r2 = r1
        L_0x00e0:
        ...
        L_0x00ef:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.yandex.metrica.impl.p082ob.C2568Th.mo16715a(com.yandex.metrica.impl.ob.W0):void");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized void mo16716a(java.util.List<java.lang.String> r5, java.util.Map<java.lang.String, com.yandex.metrica.impl.p082ob.C2673W0> r6) {
        /*
            r4 = this;
            monitor-enter(r4)
        ...
        L_0x000a:
            ...
            java.util.Map<java.lang.String, ? extends java.util.List<java.lang.String>> r2 = r4.f6799a     // Catch:{ all -> 0x0051 }
        ...
        L_0x0030:
            ...
            java.lang.String r0 = com.yandex.metrica.impl.p082ob.C2572Tl.m8529b((java.util.Map<java.lang.String, java.util.List<java.lang.String>>) r0)     // Catch:{ all -> 0x0051 }
            com.yandex.metrica.impl.ob.W0 r2 = r4.f6801c     // Catch:{ all -> 0x0051 }
            if (r2 == 0) goto L_0x0041
            com.yandex.metrica.impl.ob.U0 r3 = r2.f7066b     // Catch:{ all -> 0x0051 }
            if (r3 == 0) goto L_0x0041
            goto L_0x0043
        L_0x0041:
            com.yandex.metrica.impl.ob.U0 r3 = com.yandex.metrica.impl.p082ob.C2577U0.UNKNOWN     // Catch:{ all -> 0x0051 }
        L_0x0043:
            if (r2 == 0) goto L_0x0048
            java.lang.String r2 = r2.f7067c     // Catch:{ all -> 0x0051 }
            goto L_0x0049
        L_0x0048:
            r2 = 0
        L_0x0049:
        ...
        L_0x0051:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.yandex.metrica.impl.p082ob.C2568Th.mo16716a(java.util.List, java.util.Map):void");
    }
}
