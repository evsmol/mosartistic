...
public class C2158Ii {
    ...
    public void mo15939a(com.yandex.metrica.impl.p082ob.C2638Ui r6, com.yandex.metrica.impl.p082ob.C2572Tl.C2573a r7) {
        /*
            r5 = this;
            java.lang.String r0 = ""
        ...
        L_0x002a:
            ...
            r6.mo16906f((java.lang.String) r2)     // Catch:{ all -> 0x00bf }
        L_0x0033:
            java.lang.String r2 = "report"
            java.util.List r2 = r5.m7423a((org.json.JSONObject) r7, (java.lang.String) r2)     // Catch:{ all -> 0x00bf }
            boolean r4 = com.yandex.metrica.impl.p082ob.C1848A2.m6814b((java.util.Collection) r2)     // Catch:{ all -> 0x00bf }
            if (r4 != 0) goto L_0x0042
            r6.mo16907f((java.util.List<java.lang.String>) r2)     // Catch:{ all -> 0x00bf }
        L_0x0042:
        ...
        L_0x0050:
            ...
            r6.mo16909g((java.lang.String) r0)     // Catch:{ all -> 0x00bf }
        L_0x0059:
            java.lang.String r0 = "location"
            java.util.List r0 = r5.m7423a((org.json.JSONObject) r7, (java.lang.String) r0)     // Catch:{ all -> 0x00bf }
            boolean r1 = com.yandex.metrica.impl.p082ob.C1848A2.m6814b((java.util.Collection) r0)     // Catch:{ all -> 0x00bf }
            if (r1 != 0) goto L_0x0068
            r6.mo16898c((java.util.List<java.lang.String>) r0)     // Catch:{ all -> 0x00bf }
        L_0x0068:
            java.lang.String r0 = "startup"
            java.util.List r0 = r5.m7423a((org.json.JSONObject) r7, (java.lang.String) r0)     // Catch:{ all -> 0x00bf }
            boolean r1 = com.yandex.metrica.impl.p082ob.C1848A2.m6814b((java.util.Collection) r0)     // Catch:{ all -> 0x00bf }
            if (r1 != 0) goto L_0x0077
            r6.mo16913h((java.util.List<java.lang.String>) r0)     // Catch:{ all -> 0x00bf }
        L_0x0077:
            java.lang.String r0 = "diagnostic"
            java.util.List r0 = r5.m7423a((org.json.JSONObject) r7, (java.lang.String) r0)     // Catch:{ all -> 0x00bf }
            boolean r1 = com.yandex.metrica.impl.p082ob.C1848A2.m6814b((java.util.Collection) r0)     // Catch:{ all -> 0x00bf }
            if (r1 != 0) goto L_0x0086
            r6.mo16887a((java.util.List<java.lang.String>) r0)     // Catch:{ all -> 0x00bf }
        L_0x0086:
            java.lang.String r0 = "mediascope"
            java.util.List r0 = r5.m7423a((org.json.JSONObject) r7, (java.lang.String) r0)     // Catch:{ all -> 0x00bf }
            boolean r1 = com.yandex.metrica.impl.p082ob.C1848A2.m6814b((java.util.Collection) r0)     // Catch:{ all -> 0x00bf }
            if (r1 != 0) goto L_0x0095
            r6.mo16904e((java.util.List<java.lang.String>) r0)     // Catch:{ all -> 0x00bf }
        L_0x0095:
        ...
        L_0x009e:
            ...
            java.util.Set<java.lang.String> r3 = f5777a     // Catch:{ all -> 0x00bf }
            boolean r3 = r3.contains(r2)     // Catch:{ all -> 0x00bf }
            if (r3 != 0) goto L_0x009e
            java.util.List r3 = r5.m7423a((org.json.JSONObject) r7, (java.lang.String) r2)     // Catch:{ all -> 0x00bf }
            if (r3 == 0) goto L_0x009e
            r0.put(r2, r3)     // Catch:{ all -> 0x00bf }
            goto L_0x009e
        L_0x00bc:
            r6.mo16888a((java.util.Map<java.lang.String, java.util.List<java.lang.String>>) r0)     // Catch:{ all -> 0x00bf }
        L_0x00bf:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.yandex.metrica.impl.p082ob.C2158Ii.mo15939a(com.yandex.metrica.impl.ob.Ui, com.yandex.metrica.impl.ob.Tl$a):void");
    }

    /* renamed from: a */
    private List<String> m7423a(JSONObject jSONObject, String str) {
        try {
            JSONObject optJSONObject = jSONObject.optJSONObject(str);
            if (optJSONObject != null) {
                return C2572Tl.m8532b(optJSONObject.getJSONArray("urls"));
            }
