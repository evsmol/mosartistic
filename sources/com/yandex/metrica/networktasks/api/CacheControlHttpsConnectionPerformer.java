...
public class CacheControlHttpsConnectionPerformer {
    ...
    /* renamed from: a */
    private final C3756a f9651a;

    /* renamed from: b */
    private final SSLSocketFactory f9652b;
    ...
    CacheControlHttpsConnectionPerformer(C3756a aVar, SSLSocketFactory sSLSocketFactory) {
        this.f9651a = aVar;
        this.f9652b = sSLSocketFactory;
    }

    public CacheControlHttpsConnectionPerformer(SSLSocketFactory sSLSocketFactory) {
        this(new C3756a(), sSLSocketFactory);
    }
    ...
    public void performConnection(java.lang.String r5, com.yandex.metrica.networktasks.api.CacheControlHttpsConnectionPerformer.Client r6) {
        /*
            r4 = this;
            r0 = 0
            com.yandex.metrica.networktasks.api.a r1 = r4.f9651a     // Catch:{ all -> 0x0045 }
            java.lang.String r2 = r6.getOldETag()     // Catch:{ all -> 0x0045 }
            javax.net.ssl.SSLSocketFactory r3 = r4.f9652b     // Catch:{ all -> 0x0045 }
            com.yandex.metrica.network.Response r5 = r1.mo18591a(r2, r5, r3)     // Catch:{ all -> 0x0045 }
