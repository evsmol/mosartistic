...
/* renamed from: com.appodeal.ads.n5 */
public final class C9326n5 {

    /* renamed from: a */
    public static Boolean f23586a = null;

    /* renamed from: b */
    public static final /* synthetic */ boolean f23587b = (!C9326n5.class.desiredAssertionStatus());

    /* renamed from: a */
    public static ComponentName m27526a(Context context, Intent intent) {
    ...
    /* renamed from: a */
    public static Rect m27527a(View view) {
        int[] iArr = new int[2];
    ...
    /* renamed from: a */
    public static String m27528a(int i) {
    ...
    public static java.lang.String m27530a(java.io.InputStream r4) {
        /*
            r0 = 0
        ...
        L_0x0062:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appodeal.ads.C9326n5.m27530a(java.io.InputStream):java.lang.String");
    }

    /* renamed from: a */
    public static String m27531a(String str) {
    ...
    /* renamed from: a */
    public static String m27532a(JSONObject jSONObject, String str, String str2) {
        return (jSONObject == null || str == null || jSONObject.isNull(str)) ? str2 : jSONObject.optString(str, str2);
    }

    /* renamed from: a */
    public static JSONObject m27533a() {
        JSONObject jSONObject = new JSONObject();
        try {
            C9662x m = C9409q4.m27877m();
            jSONObject.put("session_id", m.mo61188g());
            jSONObject.put("session_uptime", m.mo61189h());
            jSONObject.put("session_uptime_m", m.mo61190i());
            jSONObject.put("app_uptime", m.mo61186e());
            jSONObject.put("app_uptime_m", m.mo61187f());
            jSONObject.put("sdk", Constants.SDK_VERSION);
            EventsTracker eventsTracker = EventsTracker.get();
            EventsTracker.EventType eventType = EventsTracker.EventType.Impression;
            jSONObject.put("imp_count", eventsTracker.mo61023b(eventType));
            EventsTracker.EventType eventType2 = EventsTracker.EventType.Click;
            jSONObject.put("click_count", eventsTracker.mo61023b(eventType2));
            EventsTracker.EventType eventType3 = EventsTracker.EventType.Finish;
            jSONObject.put("finish_count", eventsTracker.mo61023b(eventType3));
            jSONObject.put("imp", eventsTracker.mo61024c(eventType));
            jSONObject.put(Constants.CLICK, eventsTracker.mo61024c(eventType2));
            jSONObject.put(Constants.FINISH, eventsTracker.mo61024c(eventType3));
            jSONObject.put("timp", eventsTracker.mo61021a(eventType));
            jSONObject.put("tclick", eventsTracker.mo61021a(eventType2));
            jSONObject.put("tfinish", eventsTracker.mo61021a(eventType3));
            JSONObject jSONObject2 = C9217i0.f23174d;
            if (jSONObject2 != null) {
                Iterator<String> keys = jSONObject2.keys();
                while (keys.hasNext()) {
                    String next = keys.next();
                    jSONObject.put(next, C9217i0.f23174d.get(next));
                }
            }
    ...
    /* renamed from: a */
    public static void m27536a(Closeable closeable) {
        if (closeable != null) {
            try {
                closeable.close();
            } catch (Exception e) {
    ...
    /* renamed from: a */
    public static void m27537a(OutputStream outputStream) {
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static /* synthetic */ void m27540a(java.lang.String r3, java.lang.Runnable r4) {
        /*
            r0 = 0
        ...
        L_0x0076:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appodeal.ads.C9326n5.m27540a(java.lang.String, java.lang.Runnable):void");
    }

    /* renamed from: a */
    public static boolean m27541a(Context context) {
        if (m27542a(context, "android.permission.WRITE_EXTERNAL_STORAGE")) {
    ...
    /* renamed from: b */
    public static Activity m27544b() {
        return C9148b.f22956b.getTopActivityFlow().getValue();
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.lang.String m27545b(java.lang.String r6) {
        /*
        ...
        L_0x003e:
            ...
            java.lang.String r6 = m27545b((java.lang.String) r0)     // Catch:{ Exception -> 0x00e5, all -> 0x00e2 }
        ...
        L_0x0111:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appodeal.ads.C9326n5.m27545b(java.lang.String):java.lang.String");
    }

    /* renamed from: b */
    public static boolean m27546b(Context context) {
        Boolean bool = f23586a;
        if (bool != null) {
    ...
    /* renamed from: b */
    public static boolean m27549b(View view) {
        return view.getAlpha() == 0.0f;
    }

    @Deprecated
    /* renamed from: c */
    public static C9269l5 m27550c() {
        return C9269l5.m27453a();
    }
    ...
    /* renamed from: c */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static /* synthetic */ void m27552c(java.lang.String r3) {
        /*
            r0 = 0
        ...
        L_0x0061:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appodeal.ads.C9326n5.m27552c(java.lang.String):void");
    }

    /* renamed from: d */
    public static BitmapDrawable m27553d(Context context) {
    ...
    /* renamed from: e */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.lang.String m27555e(android.content.Context r7) {
        /*
        ...
        L_0x0008:
            ...
            java.lang.Class<com.appodeal.ads.q4> r6 = com.appodeal.ads.C9409q4.class
        ...
        L_0x005e:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appodeal.ads.C9326n5.m27555e(android.content.Context):java.lang.String");
    }

    /* renamed from: f */
    public static String m27556f(Context context) {
        try {
    ...
    /* renamed from: a */
    public static byte[] m27543a(byte[] bArr) {
        try {
    ...
    /* renamed from: c */
    public static File m27551c(Context context) {
    ...
    /* renamed from: a */
    public static void m27538a(String str, C9650s sVar) {
        if (!TextUtils.isEmpty(str) && sVar != null) {
            sVar.f24450a.execute(new Runnable(str) {
    ...
    /* renamed from: b */
    public static boolean m27548b(Context context, String str, Runnable runnable) {
        boolean z = false;
        if (TextUtils.isEmpty(str)) {
            if (runnable != null) {
                C9212h5.f23153a.post(runnable);
            }
            return false;
        } else if (f23587b || str != null) {
            try {
                new URL(str);
            ...
            if (C9217i0.f23176f) {
                ...
                if (z) {
                    ...
                    sVar.f24450a.execute(new Runnable(context, str, runnable) {
                        ...
                        public final void run() {
                            C9326n5.m27534a(this.f$0, this.f$1, this.f$2);
                        }
                    });
                    return true;
                }
    ...
    /* renamed from: a */
    public static void m27539a(String str, C9650s sVar, Runnable runnable) {
        if (!TextUtils.isEmpty(str) && sVar != null) {
            sVar.f24450a.execute(new Runnable(str, runnable) {
                public final /* synthetic */ String f$0;
                ...
                public final void run() {
                    C9326n5.m27540a(this.f$0, this.f$1);
                }
            });
        }
    }
    ...
    /* renamed from: a */
    public static boolean m27542a(Context context, String str) {
        return context.checkPermission(str, Process.myPid(), Process.myUid()) == 0;
    }

    /* renamed from: a */
    public static void m27534a(Context context, String str, Runnable runnable) {
        m27547b(context, m27545b(str));
        if (runnable != null) {
            C9212h5.f23153a.post(runnable);
        }
    }
    ...
    /* renamed from: a */
    public static void m27535a(AdType adType, C9692a aVar) {
        String str;
        String displayName = adType.getDisplayName();
        ArrayList b = aVar.mo61215b();
        ArrayList c = aVar.mo61216c();
        C9409q4 q4Var = C9409q4.f23839a;
        if (C9422r0.f23915d != Log.LogLevel.none) {
            StringBuilder sb = new StringBuilder();
            sb.append(String.format("%s waterfall:", new Object[]{m27531a(displayName)}));
            int i = 3;
            if (b != null && !b.isEmpty()) {
                ...
                while (it.hasNext()) {
                    ...
                    if (jSONObject.has(AppMeasurementSdk.ConditionalUserProperty.NAME)) {
                        ...
                        objArr[0] = m27531a(jSONObject.optString(AppMeasurementSdk.ConditionalUserProperty.NAME));
                        objArr[1] = m27531a(jSONObject.optString("status"));
                        objArr[2] = Double.valueOf(jSONObject.optDouble("ecpm", 0.0d));
                        sb.append(String.format(locale, "%s (%s), eCPM: %.2f; ", objArr));
                    } else {
                        sb.append(String.format(Locale.ENGLISH, "%s, eCPM: %.2f; ", new Object[]{m27531a(jSONObject.optString("status")), Double.valueOf(jSONObject.optDouble("ecpm", 0.0d))}));
                    }
                    i = 3;
                }
            }
            if (c == null || c.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    ...
                    if (jSONObject2.has(AppMeasurementSdk.ConditionalUserProperty.NAME)) {
                        str = String.format(Locale.ENGLISH, "%s (%s), eCPM: %.2f; ", new Object[]{m27531a(jSONObject2.optString(AppMeasurementSdk.ConditionalUserProperty.NAME)), m27531a(jSONObject2.optString("status")), Double.valueOf(jSONObject2.optDouble("ecpm", 0.0d))});
                    } else {
                        str = String.format(Locale.ENGLISH, "%s, eCPM: %.2f; ", new Object[]{m27531a(jSONObject2.optString("status")), Double.valueOf(jSONObject2.optDouble("ecpm", 0.0d))});
                    }
                    sb.append(str);
                    i3 += str.length();
                    i2 = 100;
    ...
    /* renamed from: a */
    public static String m27529a(Uri uri) {
        FileOutputStream fileOutputStream;
        Exception e;
        File file;
        MediaMetadataRetriever mediaMetadataRetriever = new MediaMetadataRetriever();
        C9148b bVar = C9148b.f22956b;
        mediaMetadataRetriever.setDataSource(bVar.f22957a.getApplicationContext(), uri);
        ...
        if (frameAtTime != null) {
            try {
                file = new File(m27551c(bVar.f22957a.getApplicationContext()), new BigInteger(m27543a(uri.toString().getBytes())).abs().toString(36));
                ...
                try {
                    Log.log(e);
                    m27537a((OutputStream) fileOutputStream);
                    m27536a((Closeable) fileOutputStream);
                    return null;
                } catch (Throwable th) {
                    th = th;
                    fileOutputStream2 = fileOutputStream;
                    m27537a((OutputStream) fileOutputStream2);
                    m27536a((Closeable) fileOutputStream2);
                    throw th;
                }
            } catch (Throwable th2) {
                th = th2;
