...
@Metadata(mo38197bv = {}, mo38198d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\u0018\u00002\u00020\u0001B\u0011\u0012\b\b\u0002\u0010\u000b\u001a\u00020\u0003¢\u0006\u0004\b\f\u0010\rJ\u0017\u0010\u0006\u001a\u00020\u0005*\u00020\u00022\b\u0010\u0004\u001a\u0004\u0018\u00010\u0003H\u0004J\u0017\u0010\b\u001a\u00020\u0005*\u00020\u00022\b\u0010\u0004\u001a\u0004\u0018\u00010\u0007H\u0004J\u0017\u0010\t\u001a\u00020\u0005*\u00020\u00022\b\u0010\u0004\u001a\u0004\u0018\u00010\u0001H\u0004J\u0006\u0010\n\u001a\u00020\u0003¨\u0006\u000e"}, mo38199d2 = {"Lcom/appodeal/ads/modules/common/internal/ext/JsonObjectBuilder;", "", "", "Lorg/json/JSONObject;", "value", "", "hasObject", "Lorg/json/JSONArray;", "hasArray", "hasValue", "build", "jsonObject", "<init>", "(Lorg/json/JSONObject;)V", "apd_internal"}, mo38200k = 1, mo38201mv = {1, 6, 0})
public final class JsonObjectBuilder {

    /* renamed from: a */
    public final JSONObject f23355a;
    ...
    public final void hasArray(String str, JSONArray jSONArray) {
        ...
        if (jSONArray != null) {
            this.f23355a.put(str, jSONArray);
        } else if (this.f23355a.has(str)) {
            this.f23355a.remove(str);
        }
    }
    ...
    public final void hasObject(String str, JSONObject jSONObject) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        if (jSONObject != null) {
            this.f23355a.put(str, jSONObject);
        } else if (this.f23355a.has(str)) {
            this.f23355a.remove(str);
        }
    }
