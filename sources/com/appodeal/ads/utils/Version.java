...
public class Version implements Comparable<Version> {
    ...
    /* renamed from: a */
    public final LinkedList f24350a;

    public Version(String str) {
        this.f24350a = m28349a(str);
    }

    /* renamed from: a */
    public static LinkedList m28349a(String str) {
        if (str == null) {
    ...
    public int compareTo(com.appodeal.ads.utils.Version r8) {
        /*
            r7 = this;
            java.util.LinkedList r0 = r7.f24350a
            java.util.Iterator r0 = r0.iterator()
            java.util.LinkedList r8 = r8.f24350a
