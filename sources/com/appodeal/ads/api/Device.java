...
public final class Device extends GeneratedMessageV3 implements DeviceOrBuilder {
                ...
                try {
                    ...
                    switch (readTag) {
                        ...
                        case 26:
                            ...
                            break;
                        case 32:
                            this.f22925w_ = codedInputStream.readInt32();
                            break;
                        case 40:
                            this.f22924h_ = codedInputStream.readInt32();
                            break;
                        case 53:
    ...
    public int getW() {
        return this.f22925w_;
    }

    public int getH() {
        return this.f22924h_;
    }
    ...
    public int getSerializedSize() {
        ...
        float f2 = this.cpuUsage_;
        if (f2 != 0.0f) {
            i2 += CodedOutputStream.computeFloatSize(27, f2);
        }
        if (!getSecureAndroidIdBytes().isEmpty()) {
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements DeviceOrBuilder {
        ...
        public Device buildPartial() {
            ...
            int unused4 = device.f22925w_ = this.f22927w_;
            int unused5 = device.f22924h_ = this.f22926h_;
