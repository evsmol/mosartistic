...
public class IronSourceNetwork extends AdNetwork<RequestParams> {
    ...
    private static final UnifiedAppStateChangeListener appStateChangeListener = new UnifiedAppStateChangeListener() {
        public void onAppStateChanged(Activity activity, AppState appState, boolean z) {
            if (!z) {
                int i = C90583.$SwitchMap$com$appodeal$ads$utils$app$AppState[appState.ordinal()];
                if (i == 1) {
    ...
    /* renamed from: com.appodeal.ads.adapters.ironsource.IronSourceNetwork$3 */
    static /* synthetic */ class C90583 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.appodeal.ads.adapters.ironsource.IronSourceNetwork.C90583.<clinit>():void");
        }
    }
