...
/* renamed from: com.appodeal.ads.adapters.vast.rewarded_video.b */
public final class C9098b extends UnifiedVastRewarded<VASTNetwork.RequestParams> {
    public final void performVastRequest(Context context, UnifiedFullscreenAdParams unifiedFullscreenAdParams, UnifiedVastNetworkParams unifiedVastNetworkParams, UnifiedFullscreenAdCallback unifiedFullscreenAdCallback, String str) {
        ...
        S2SAdTask.requestVast(context, str, unifiedVastNetworkParams, unifiedRewardedCallback, new C9097a(this, (UnifiedRewardedParams) unifiedFullscreenAdParams, unifiedRewardedCallback));
    }
}
