...
/* renamed from: com.appodeal.ads.adapters.vast.video.b */
public final class C9100b extends UnifiedVastVideo<VASTNetwork.RequestParams> {
    public final void performVastRequest(Context context, UnifiedFullscreenAdParams unifiedFullscreenAdParams, UnifiedVastNetworkParams unifiedVastNetworkParams, UnifiedFullscreenAdCallback unifiedFullscreenAdCallback, String str) {
        ...
        S2SAdTask.requestVast(context, str, unifiedVastNetworkParams, unifiedVideoCallback, new C9099a(this, (UnifiedVideoParams) unifiedFullscreenAdParams, unifiedVideoCallback));
    }
}
