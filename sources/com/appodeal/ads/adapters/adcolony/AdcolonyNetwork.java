...
import com.appodeal.ads.adapters.adcolony.rewarded_video.C9010a;
import com.appodeal.ads.adapters.adcolony.video.C9012a;
...
public class AdcolonyNetwork extends AdNetwork<RequestParams> {
    ...
    /* renamed from: com.appodeal.ads.adapters.adcolony.AdcolonyNetwork$a */
    public static /* synthetic */ class C9009a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f22790a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.appodeal.ads.adapters.adcolony.AdcolonyNetwork.C9009a.<clinit>():void");
        }
    }
    ...
    private AdColonyAdOptions setTargeting(Context context, RestrictedData restrictedData) {
        ...
        if (gender != null) {
            int i = C9009a.f22790a[gender.ordinal()];
            if (i == 1) {
    ...
    public String getRecommendedVersion() {
        return p150io.bidmachine.ads.networks.adcolony.BuildConfig.ADAPTER_SDK_VERSION_NAME;
    }
