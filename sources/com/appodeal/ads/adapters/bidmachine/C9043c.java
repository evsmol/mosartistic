...
/* renamed from: com.appodeal.ads.adapters.bidmachine.c */
/* compiled from: BidMachineUtils */
public final class C9043c {

    /* renamed from: com.appodeal.ads.adapters.bidmachine.c$a */
    /* compiled from: BidMachineUtils */
    public static /* synthetic */ class C9044a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f22852a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f22852a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f22852a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f22852a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.appodeal.ads.adapters.bidmachine.C9043c.C9044a.<clinit>():void");
        }
    }
    ...
    public static p150io.bidmachine.TargetingParams m27143a(android.content.Context r7, org.json.JSONObject r8, com.appodeal.ads.RestrictedData r9) {
        /*
            ...
            io.bidmachine.utils.Gender r1 = p150io.bidmachine.utils.Gender.Male
            r0.setGender((p150io.bidmachine.utils.Gender) r1)
            goto L_0x002d
        L_0x001a:
            com.appodeal.ads.UserSettings$Gender r2 = com.appodeal.ads.UserSettings.Gender.FEMALE
            if (r1 != r2) goto L_0x0024
            io.bidmachine.utils.Gender r1 = p150io.bidmachine.utils.Gender.Female
            r0.setGender((p150io.bidmachine.utils.Gender) r1)
            goto L_0x002d
        L_0x0024:
            com.appodeal.ads.UserSettings$Gender r2 = com.appodeal.ads.UserSettings.Gender.OTHER
            if (r1 != r2) goto L_0x002d
            io.bidmachine.utils.Gender r1 = p150io.bidmachine.utils.Gender.Omitted
            r0.setGender((p150io.bidmachine.utils.Gender) r1)
        L_0x002d:
        ...
        L_0x0148:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appodeal.ads.adapters.bidmachine.C9043c.m27143a(android.content.Context, org.json.JSONObject, com.appodeal.ads.RestrictedData):io.bidmachine.TargetingParams");
    }

    /* renamed from: a */
    public static CustomParams m27141a(JSONObject jSONObject) {
    ...
    /* renamed from: a */
    public static LogListener m27140a() {
        return new LogListener("bm mraid event") {
            ...
            public final void onLog(Logger.LogLevel logLevel, String str, String str2) {
                C9043c.m27144a(this.f$0, logLevel, str, str2);
            }
        };
    }

    /* renamed from: a */
    public static void m27144a(String str, Logger.LogLevel logLevel, String str2, String str3) {
        Function1<? super InternalLogEvent, Unit> function1 = InternalLogKt.observer;
        int i = C9044a.f22852a[logLevel.ordinal()];
    ...
    /* renamed from: a */
    public static PriceFloorParams m27142a(String str) {
        ...
        try {
            ...
            for (int i = 0; i < jSONArray.length(); i++) {
                ...
                if (opt instanceof JSONObject) {
                    ...
                    while (keys.hasNext()) {
                        String next = keys.next();
                        double a = m27139a(jSONObject.opt(next));
                        if (!TextUtils.isEmpty(next) && a > -1.0d) {
                            priceFloorParams.addPriceFloor(next, a);
                        }
                    }
                } else {
                    double a2 = m27139a(opt);
                    if (a2 > -1.0d) {
                        priceFloorParams.addPriceFloor(a2);
                    }
                }
            }
            return priceFloorParams;
    ...
    /* renamed from: a */
    public static double m27139a(Object obj) {
        double d;
        ...
        try {
            if (str.lastIndexOf(46) > str.lastIndexOf(44)) {
                d = NumberFormat.getInstance(Locale.TAIWAN).parse(str).doubleValue();
            } else {
