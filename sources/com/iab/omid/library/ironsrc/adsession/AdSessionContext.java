...
public final class AdSessionContext {
    ...
    public static AdSessionContext createHtmlAdSessionContext(Partner partner2, WebView webView2, String str, String str2) {
        C4330e.m12302a((Object) partner2, "Partner is null");
        C4330e.m12302a((Object) webView2, "WebView is null");
        if (str2 != null) {
            C4330e.m12303a(str2, 256, "CustomReferenceData is greater than 256 characters");
        }
    ...
    public static AdSessionContext createNativeAdSessionContext(Partner partner2, String str, List<VerificationScriptResource> list, String str2, String str3) {
        C4330e.m12302a((Object) partner2, "Partner is null");
        C4330e.m12302a((Object) str, "OM SDK JS script content is null");
        C4330e.m12302a((Object) list, "VerificationScriptResources is null");
        if (str3 != null) {
            C4330e.m12303a(str3, 256, "CustomReferenceData is greater than 256 characters");
        }
