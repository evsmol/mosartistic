...
public class ByteString implements Serializable, Comparable<ByteString> {
    public static final ByteString EMPTY = m14712of(new byte[0]);
    ...
    /* renamed from: of */
    public static ByteString m14712of(byte... bArr) {
        if (bArr != null) {
    ...
    private ByteString digest(String str) {
        try {
            return m14712of(MessageDigest.getInstance(str).digest(this.data));
