...
public class BeaconManager {
    ...
    public void checkIfMainProcess() {
        ...
        LogManager.m14728i("BeaconManager", "BeaconManager started up on pid " + pid + " named '" + processName + "' for application package '" + packageName + "'.  isMainProcess=" + this.mMainProcess, new Object[0]);
    }
    ...
    public void applySettings() {
        if (!determineIfCalledFromSeparateScannerProcess()) {
            if (!isAnyConsumerBound()) {
                LogManager.m14725d("BeaconManager", "Not synchronizing settings to service, as it has not started up yet", new Object[0]);
            } else if (isScannerInDifferentProcess()) {
                LogManager.m14725d("BeaconManager", "Synchronizing settings to service", new Object[0]);
                syncSettingsToService();
            } else {
                LogManager.m14725d("BeaconManager", "Not synchronizing settings to service, as it is in the same process", new Object[0]);
            }
        }
    }
    ...
    public void syncSettingsToService() {
        ...
        try {
            ...
            LogManager.m14726e("BeaconManager", "Failed to sync settings to service", e);
        }
    }
    ...
    private String callbackPackageName() {
        ...
        LogManager.m14725d("BeaconManager", "callback packageName: %s", packageName);
        return packageName;
    }
    ...
    private boolean determineIfCalledFromSeparateScannerProcess() {
        ...
        LogManager.m14729w("BeaconManager", "Ranging/Monitoring may not be controlled from a separate BeaconScanner process.  To remove this warning, please wrap this call in: if (beaconManager.isMainProcess())", new Object[0]);
        return true;
    }
}
