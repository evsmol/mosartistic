...
public class BeaconService extends Service {
        ...
        public void handleMessage(Message message) {
            ...
            if (beaconService != null) {
                ...
                if (fromBundle != null) {
                    int i = message.what;
                    if (i == 2) {
                        LogManager.m14728i("BeaconService", "start ranging received", new Object[0]);
                        ...
                        LogManager.m14728i("BeaconService", "stop ranging received", new Object[0]);
                        beaconService.stopRangingBeaconsInRegion(fromBundle.getRegionData());
                        beaconService.setScanPeriods(fromBundle.getScanPeriod(), fromBundle.getBetweenScanPeriod(), fromBundle.getBackgroundFlag());
                    } else if (i == 4) {
                        LogManager.m14728i("BeaconService", "start monitoring received", new Object[0]);
                        beaconService.startMonitoringBeaconsInRegion(fromBundle.getRegionData(), new Callback(fromBundle.getCallbackPackageName()));
                        beaconService.setScanPeriods(fromBundle.getScanPeriod(), fromBundle.getBetweenScanPeriod(), fromBundle.getBackgroundFlag());
                    } else if (i == 5) {
                        LogManager.m14728i("BeaconService", "stop monitoring received", new Object[0]);
                        beaconService.stopMonitoringBeaconsInRegion(fromBundle.getRegionData());
                        beaconService.setScanPeriods(fromBundle.getScanPeriod(), fromBundle.getBetweenScanPeriod(), fromBundle.getBackgroundFlag());
                    } else if (i != 6) {
                        super.handleMessage(message);
                    } else {
                        LogManager.m14728i("BeaconService", "set scan intervals received", new Object[0]);
                        beaconService.setScanPeriods(fromBundle.getScanPeriod(), fromBundle.getBetweenScanPeriod(), fromBundle.getBackgroundFlag());
                    }
                } else if (message.what == 7) {
                    LogManager.m14728i("BeaconService", "Received settings update from other process", new Object[0]);
                    SettingsData fromBundle2 = SettingsData.fromBundle(message.getData());
                    if (fromBundle2 != null) {
                        fromBundle2.apply(beaconService);
                    } else {
                        LogManager.m14729w("BeaconService", "Settings data missing", new Object[0]);
                    }
                } else {
                    LogManager.m14728i("BeaconService", "Received unknown message from other process : " + message.what, new Object[0]);
                }
            }
        }
    }
    ...
    public void onCreate() {
        ...
        if (instanceForApplication.isMainProcess()) {
            LogManager.m14728i("BeaconService", "beaconService version %s is starting up on the main process", "2.13.1");
        } else {
            LogManager.m14728i("BeaconService", "beaconService version %s is starting up on a separate process", "2.13.1");
            ProcessUtils processUtils = new ProcessUtils(this);
            LogManager.m14728i("BeaconService", "beaconService PID is " + processUtils.getPid() + " with process name " + processUtils.getProcessName(), new Object[0]);
        }
        try {
            ...
            if (!(serviceInfo == null || serviceInfo.metaData == null || serviceInfo.metaData.get("longScanForcingEnabled") == null || !serviceInfo.metaData.get("longScanForcingEnabled").toString().equals("true"))) {
                LogManager.m14728i("BeaconService", "longScanForcingEnabled to keep scans going on Android N for > 30 minutes", new Object[0]);
        ...
        try {
            ...
            LogManager.m14725d("BeaconService", "No org.altbeacon.beacon.SimulatedScanData class exists.", new Object[0]);
        } catch (Exception e) {
            LogManager.m14727e(e, "BeaconService", "Cannot get simulated Scan data.  Make sure your org.altbeacon.beacon.SimulatedScanData class defines a field with the signature 'public static List<Beacon> beacons'", new Object[0]);
        }
    }
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        LogManager.m14728i("BeaconService", str, new Object[0]);
        return super.onStartCommand(intent, i, i2);
    }

    public IBinder onBind(Intent intent) {
        LogManager.m14728i("BeaconService", "binding", new Object[0]);
        return this.mMessenger.getBinder();
    }

    public boolean onUnbind(Intent intent) {
        LogManager.m14728i("BeaconService", "unbinding", new Object[0]);
        return false;
    }

    public void onDestroy() {
        LogManager.m14726e("BeaconService", "onDestroy()", new Object[0]);
        if (Build.VERSION.SDK_INT < 18) {
            LogManager.m14729w("BeaconService", "Not supported prior to API 18.", new Object[0]);
            return;
        }
        this.bluetoothCrashResolver.stop();
        LogManager.m14728i("BeaconService", "onDestroy called.  stopping scanning", new Object[0]);
    ...
    public void onTaskRemoved(Intent intent) {
        ...
        LogManager.m14725d("BeaconService", "task removed", new Object[0]);
        if (Build.VERSION.RELEASE.contains("4.4.1") || Build.VERSION.RELEASE.contains("4.4.2") || Build.VERSION.RELEASE.contains("4.4.3")) {
            ...
            LogManager.m14725d("BeaconService", "Setting a wakeup alarm to go off due to Android 4.4.2 service restarting bug.", new Object[0]);
        }
    }
    ...
    public void startRangingBeaconsInRegion(Region region, Callback callback) {
        synchronized (this.mScanHelper.getRangedRegionState()) {
            if (this.mScanHelper.getRangedRegionState().containsKey(region)) {
                LogManager.m14728i("BeaconService", "Already ranging that region -- will replace existing region.", new Object[0]);
            ...
            LogManager.m14725d("BeaconService", "Currently ranging %s regions.", Integer.valueOf(this.mScanHelper.getRangedRegionState().size()));
        }
    ...
    public void startMonitoringBeaconsInRegion(Region region, Callback callback) {
        LogManager.m14725d("BeaconService", "startMonitoring called", new Object[0]);
        this.mScanHelper.getMonitoringStatus().addRegion(region, callback);
        LogManager.m14725d("BeaconService", "Currently monitoring %s regions.", Integer.valueOf(this.mScanHelper.getMonitoringStatus().regionsCount()));
        this.mScanHelper.getCycledScanner().start();
    }

    public void stopMonitoringBeaconsInRegion(Region region) {
        LogManager.m14725d("BeaconService", "stopMonitoring called", new Object[0]);
