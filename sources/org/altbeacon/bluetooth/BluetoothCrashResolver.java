...
public class BluetoothCrashResolver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("android.bluetooth.adapter.action.DISCOVERY_FINISHED")) {
                if (BluetoothCrashResolver.this.recoveryInProgress) {
                    LogManager.m14725d("BluetoothCrashResolver", "Bluetooth discovery finished", new Object[0]);
                    BluetoothCrashResolver.this.finishRecovery();
                } else {
                    LogManager.m14725d("BluetoothCrashResolver", "Bluetooth discovery finished (external)", new Object[0]);
                }
            }
            if (action.equals("android.bluetooth.adapter.action.DISCOVERY_STARTED")) {
                if (BluetoothCrashResolver.this.recoveryInProgress) {
                    boolean unused = BluetoothCrashResolver.this.discoveryStartConfirmed = true;
                    LogManager.m14725d("BluetoothCrashResolver", "Bluetooth discovery started", new Object[0]);
                } else {
                    LogManager.m14725d("BluetoothCrashResolver", "Bluetooth discovery started (external)", new Object[0]);
                }
            }
            if (action.equals("android.bluetooth.adapter.action.STATE_CHANGED")) {
                ...
                if (intExtra != Integer.MIN_VALUE) {
                    switch (intExtra) {
                        case 10:
                            LogManager.m14725d("BluetoothCrashResolver", "Bluetooth state is OFF", new Object[0]);
                        ...
                        case 11:
                            ...
                            LogManager.m14725d("BluetoothCrashResolver", "Bluetooth state is TURNING_ON", new Object[0]);
                            return;
                        case 12:
                            LogManager.m14725d("BluetoothCrashResolver", "Bluetooth state is ON", new Object[0]);
                            LogManager.m14725d("BluetoothCrashResolver", "Bluetooth was turned off for %s milliseconds", Long.valueOf(BluetoothCrashResolver.this.lastBluetoothTurningOnTime - BluetoothCrashResolver.this.lastBluetoothOffTime));
                    ...
                    LogManager.m14725d("BluetoothCrashResolver", "Bluetooth state is ERROR", new Object[0]);
                }
            }
        }
    };
    ...
    public BluetoothCrashResolver(Context context2) {
        ...
        LogManager.m14725d("BluetoothCrashResolver", "constructed", new Object[0]);
        loadState();
    }
    ...
    public void start() {
        ...
        LogManager.m14725d("BluetoothCrashResolver", "started listening for BluetoothAdapter events", new Object[0]);
    }

    public void stop() {
        this.context.unregisterReceiver(this.receiver);
        LogManager.m14725d("BluetoothCrashResolver", "stopped listening for BluetoothAdapter events", new Object[0]);
        saveState();
    }
    ...
    public void notifyScannedDevice(BluetoothDevice bluetoothDevice, BluetoothAdapter.LeScanCallback leScanCallback) {
        ...
        if (size != size2 && size2 % 100 == 0) {
            LogManager.m14725d("BluetoothCrashResolver", "Distinct Bluetooth devices seen: %s", Integer.valueOf(this.distinctBluetoothAddresses.size()));
        }
        if (this.distinctBluetoothAddresses.size() > getCrashRiskDeviceCount() && !this.recoveryInProgress) {
            LogManager.m14729w("BluetoothCrashResolver", "Large number of Bluetooth devices detected: %s Proactively attempting to clear out address list to prevent a crash", Integer.valueOf(this.distinctBluetoothAddresses.size()));
            LogManager.m14729w("BluetoothCrashResolver", "Stopping LE Scan", new Object[0]);
    ...
    public void crashDetected() {
        if (Build.VERSION.SDK_INT < 18) {
            LogManager.m14725d("BluetoothCrashResolver", "Ignoring crashes before API 18, because BLE is unsupported.", new Object[0]);
            return;
        }
        LogManager.m14729w("BluetoothCrashResolver", "BluetoothService crash detected", new Object[0]);
        if (this.distinctBluetoothAddresses.size() > 0) {
            LogManager.m14725d("BluetoothCrashResolver", "Distinct Bluetooth devices seen at crash: %s", Integer.valueOf(this.distinctBluetoothAddresses.size()));
        }
        this.lastBluetoothCrashDetectionTime = SystemClock.elapsedRealtime();
        this.detectedCrashCount++;
        if (this.recoveryInProgress) {
            LogManager.m14725d("BluetoothCrashResolver", "Ignoring Bluetooth crash because recovery is already in progress.", new Object[0]);
        } else {
            startRecovery();
        }
        processStateChange();
    ...
    private void startRecovery() {
        ...
        LogManager.m14725d("BluetoothCrashResolver", "about to check if discovery is active", new Object[0]);
        if (!defaultAdapter.isDiscovering()) {
            LogManager.m14729w("BluetoothCrashResolver", "Recovery attempt started", new Object[0]);
            this.recoveryInProgress = true;
            this.discoveryStartConfirmed = false;
            LogManager.m14725d("BluetoothCrashResolver", "about to command discovery", new Object[0]);
            if (!defaultAdapter.startDiscovery()) {
                LogManager.m14729w("BluetoothCrashResolver", "Can't start discovery.  Is Bluetooth turned on?", new Object[0]);
            }
            LogManager.m14725d("BluetoothCrashResolver", "startDiscovery commanded.  isDiscovering()=%s", Boolean.valueOf(defaultAdapter.isDiscovering()));
            LogManager.m14725d("BluetoothCrashResolver", "We will be cancelling this discovery in %s milliseconds.", 5000);
            cancelDiscovery();
            return;
        }
        LogManager.m14729w("BluetoothCrashResolver", "Already discovering.  Recovery attempt abandoned.", new Object[0]);
    }

    /* access modifiers changed from: private */
    public void finishRecovery() {
        LogManager.m14729w("BluetoothCrashResolver", "Recovery attempt finished", new Object[0]);
        synchronized (this.distinctBluetoothAddresses) {
    ...
    private void saveState() {
        ...
        L_0x0091:
            ...
            org.altbeacon.beacon.logging.LogManager.m14729w(r3, r4, r5)     // Catch:{ all -> 0x008f }
        ...
        L_0x00a3:
            ...
            r0[r1] = r4
            org.altbeacon.beacon.logging.LogManager.m14725d(r2, r3, r0)
            return
        L_0x00b9:
    ...
    private void loadState() {
        ...
        L_0x0066:
            ...
            org.altbeacon.beacon.logging.LogManager.m14729w(r0, r5, r6)     // Catch:{ all -> 0x0064 }
        ...
        L_0x0081:
            ...
            org.altbeacon.beacon.logging.LogManager.m14725d(r0, r2, r1)
            return
        L_0x0095:
    ...
    private void cancelDiscovery() {
        try {
            ...
            if (!this.discoveryStartConfirmed) {
                LogManager.m14729w("BluetoothCrashResolver", "BluetoothAdapter.ACTION_DISCOVERY_STARTED never received.  Recovery may fail.", new Object[0]);
            }
            BluetoothAdapter defaultAdapter = BluetoothAdapter.getDefaultAdapter();
            if (defaultAdapter.isDiscovering()) {
                LogManager.m14725d("BluetoothCrashResolver", "Cancelling discovery", new Object[0]);
                defaultAdapter.cancelDiscovery();
                return;
            }
            LogManager.m14725d("BluetoothCrashResolver", "Discovery not running.  Won't cancel it", new Object[0]);
        } catch (InterruptedException unused) {
            LogManager.m14725d("BluetoothCrashResolver", "DiscoveryCanceller sleep interrupted.", new Object[0]);
        }
    }
}
