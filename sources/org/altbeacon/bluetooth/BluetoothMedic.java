...
public class BluetoothMedic {
    ...
    public BroadcastReceiver mBluetoothEventReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            LogManager.m14725d(BluetoothMedic.TAG, "Broadcast notification received.", new Object[0]);
            ...
            if (action.equalsIgnoreCase("onScanFailed")) {
                if (intent.getIntExtra(IronSourceConstants.EVENTS_ERROR_CODE, -1) == 2) {
                    ...
                    LogManager.m14725d(BluetoothMedic.TAG, "Detected a SCAN_FAILED_APPLICATION_REGISTRATION_FAILED.  We need to cycle bluetooth to recover", new Object[0]);
                ...
                LogManager.m14725d(BluetoothMedic.TAG, "Unknown event.", new Object[0]);
    ...
    public boolean runScanTest(final android.content.Context r10) {
        /*
            ...
            org.altbeacon.beacon.logging.LogManager.m14728i(r0, r3, r2)
        ...
        L_0x0026:
            ...
            org.altbeacon.beacon.logging.LogManager.m14725d(r10, r6, r5)
        ...
        L_0x003a:
            ...
            org.altbeacon.beacon.logging.LogManager.m14725d(r10, r3, r2)
        L_0x004e:
        ...
        L_0x0054:
            ...
            org.altbeacon.beacon.logging.LogManager.m14725d(r10, r2, r0)
        L_0x005d:
            java.lang.String r10 = TAG
            java.lang.Object[] r0 = new java.lang.Object[r1]
    ...
    public boolean runTransmitterTest(final Context context) {
        ...
        if (bluetoothAdapter != null) {
            ...
            if (bluetoothLeAdvertiser != null) {
                ...
                LogManager.m14728i(TAG, "Starting transmitter test", new Object[0]);
                bluetoothLeAdvertiser.startAdvertising(build, build2, new AdvertiseCallback() {
                    public void onStartSuccess(AdvertiseSettings advertiseSettings) {
                        super.onStartSuccess(advertiseSettings);
                        LogManager.m14728i(BluetoothMedic.TAG, "Transmitter test succeeded", new Object[0]);
                    ...
                    public void onStartFailure(int i) {
                        ...
                        LogManager.m14725d(access$000, "Sending onStartFailure broadcast with " + BluetoothMedic.this.mLocalBroadcastManager, new Object[0]);
                        ...
                        if (i == 4) {
                            ...
                            LogManager.m14729w(BluetoothMedic.TAG, "Transmitter test failed in a way we consider a test failure", new Object[0]);
                        ...
                        LogManager.m14728i(BluetoothMedic.TAG, "Transmitter test failed, but not in a way we consider a test failure", new Object[0]);
                    }
                });
            } else {
                LogManager.m14725d(TAG, "Cannot get advertiser", new Object[0]);
            }
            while (true) {
                if (this.mTransmitterTestResult != null) {
                    break;
                }
                LogManager.m14725d(TAG, "Waiting for transmitter test to complete...", new Object[0]);
                try {
                    Thread.sleep(1000);
                } catch (InterruptedException unused) {
                }
                if (System.currentTimeMillis() - currentTimeMillis > 5000) {
                    LogManager.m14725d(TAG, "Timeout running transmitter test", new Object[0]);
                    break;
                }
            }
        }
        LogManager.m14725d(TAG, "transmitter test complete", new Object[0]);
    ...
    public boolean cycleBluetoothIfNotTooSoon() {
        ...
        if (currentTimeMillis < 60000) {
            String str = TAG;
            LogManager.m14725d(str, "Not cycling bluetooth because we just did so " + currentTimeMillis + " milliseconds ago.", new Object[0]);
            return false;
        }
        this.mLastBluetoothPowerCycleTime = System.currentTimeMillis();
        LogManager.m14725d(TAG, "Power cycling bluetooth", new Object[0]);
        cycleBluetooth();
        return true;
    }
    ...
    private void cycleBluetooth() {
        LogManager.m14725d(TAG, "Power cycling bluetooth", new Object[0]);
        LogManager.m14725d(TAG, "Turning Bluetooth off.", new Object[0]);
        BluetoothAdapter bluetoothAdapter = this.mAdapter;
        if (bluetoothAdapter != null) {
            bluetoothAdapter.disable();
            this.mHandler.postDelayed(new Runnable() {
                public void run() {
                    LogManager.m14725d(BluetoothMedic.TAG, "Turning Bluetooth back on.", new Object[0]);
        ...
        LogManager.m14729w(TAG, "Cannot cycle bluetooth.  Manager is null.", new Object[0]);
    }
