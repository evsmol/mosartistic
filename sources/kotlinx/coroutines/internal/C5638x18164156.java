...
public final class C5638x18164156 extends Lambda implements Function1<Throwable, Throwable> {
    final /* synthetic */ Constructor $constructor$inlined;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C5638x18164156(Constructor constructor) {
        super(1);
    ...
    public final Throwable invoke(Throwable th) {
        ...
        try {
            ...
            if (newInstance != null) {
                ...
                th2.initCause(th);
                obj = Result.m31662constructorimpl(th2);
            ...
            obj = Result.m31662constructorimpl(ResultKt.createFailure(th3));
        }
    }
}
