...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements CancellableFlow<T>, MutableSharedFlow<T>, FusibleFlow<T> {
    ...
    public boolean tryEmit(T t) {
        ...
        while (i < length) {
            ...
            if (continuation != null) {
                ...
                continuation.resumeWith(Result.m31662constructorimpl(Unit.INSTANCE));
            }
        }
        return z;
    }
    ...
    private final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        synchronized (this) {
            if (tryEmitLocked(t)) {
                Result.Companion companion = Result.Companion;
                cancellableContinuation.resumeWith(Result.m31662constructorimpl(Unit.INSTANCE));
        ...
        while (i < length) {
            ...
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m31662constructorimpl(Unit.INSTANCE));
            }
        }
