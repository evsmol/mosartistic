        ...
        while (true) {
            ...
            if (obj != null && obj != StateFlowKt.PENDING) {
                if (obj == StateFlowKt.NONE) {
                    ...
                    ((CancellableContinuationImpl) obj).resumeWith(Result.m31662constructorimpl(Unit.INSTANCE));
                    return;
                }
            } else {
                return;
