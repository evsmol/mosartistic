...
class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final Pair<Integer, String> findAnyOf$StringsKt__StringsKt(CharSequence charSequence, Collection<String> collection, int i, boolean z, boolean z2) {
            ...
            if (charSequence instanceof String) {
                ...
                if ((step > 0 && first <= last) || (step < 0 && last <= first)) {
                    while (true) {
                        ...
                        if (str2 != null) {
                            return TuplesKt.m14544to(Integer.valueOf(first), str2);
                        }
                        if (first == last) {
                            break;
                        }
                ...
                if ((step2 > 0 && first2 <= last2) || (step2 < 0 && last2 <= first2)) {
                    while (true) {
                        ...
                        if (str4 != null) {
                            return TuplesKt.m14544to(Integer.valueOf(first2), str4);
                        }
                        if (first2 == last2) {
                            break;
                        }
        ...
        return TuplesKt.m14544to(Integer.valueOf(indexOf$default), str5);
    }
