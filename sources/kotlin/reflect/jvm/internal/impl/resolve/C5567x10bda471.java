...
final class C5567x10bda471 implements KotlinTypeChecker.TypeConstructorEquality {

    /* renamed from: $a */
    final /* synthetic */ CallableDescriptor f12945$a;
    final /* synthetic */ boolean $allowCopiesFromTheSameDeclaration;

    /* renamed from: $b */
    final /* synthetic */ CallableDescriptor f12946$b;

    C5567x10bda471(boolean z, CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2) {
        this.$allowCopiesFromTheSameDeclaration = z;
        this.f12945$a = callableDescriptor;
        this.f12946$b = callableDescriptor2;
    }
    ...
    public final boolean equals(TypeConstructor typeConstructor, TypeConstructor typeConstructor2) {
        ...
        final CallableDescriptor callableDescriptor = this.f12945$a;
        final CallableDescriptor callableDescriptor2 = this.f12946$b;
