...
public final class BinaryClassAnnotationAndConstantLoaderImpl$loadAnnotation$1 implements KotlinJvmBinaryClass.AnnotationArgumentVisitor {
    ...
    public KotlinJvmBinaryClass.AnnotationArrayArgumentVisitor visitArray(Name name) {
        Intrinsics.checkNotNullParameter(name, AppMeasurementSdk.ConditionalUserProperty.NAME);
        return new C5492xfa5093a1(this, name, this.this$0, this.$annotationClass, this.$annotationClassId, this.$result);
    }
    ...
    public KotlinJvmBinaryClass.AnnotationArgumentVisitor visitAnnotation(Name name, ClassId classId) {
        ...
        return new C5491xe59bb5e1(loadAnnotation, this, name, arrayList);
    }
