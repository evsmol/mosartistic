...
public final class JavaAnnotationTargetMapper {
    ...
    private static final Map<String, KotlinRetention> retentionNameList = MapsKt.mapOf(TuplesKt.m14544to("RUNTIME", KotlinRetention.RUNTIME), TuplesKt.m14544to("CLASS", KotlinRetention.BINARY), TuplesKt.m14544to("SOURCE", KotlinRetention.SOURCE));
    private static final Map<String, EnumSet<KotlinTarget>> targetNameLists = MapsKt.mapOf(TuplesKt.m14544to("PACKAGE", EnumSet.noneOf(KotlinTarget.class)), TuplesKt.m14544to("TYPE", EnumSet.of(KotlinTarget.CLASS, KotlinTarget.FILE)), TuplesKt.m14544to("ANNOTATION_TYPE", EnumSet.of(KotlinTarget.ANNOTATION_CLASS)), TuplesKt.m14544to("TYPE_PARAMETER", EnumSet.of(KotlinTarget.TYPE_PARAMETER)), TuplesKt.m14544to("FIELD", EnumSet.of(KotlinTarget.FIELD)), TuplesKt.m14544to("LOCAL_VARIABLE", EnumSet.of(KotlinTarget.LOCAL_VARIABLE)), TuplesKt.m14544to("PARAMETER", EnumSet.of(KotlinTarget.VALUE_PARAMETER)), TuplesKt.m14544to("CONSTRUCTOR", EnumSet.of(KotlinTarget.CONSTRUCTOR)), TuplesKt.m14544to("METHOD", EnumSet.of(KotlinTarget.FUNCTION, KotlinTarget.PROPERTY_GETTER, KotlinTarget.PROPERTY_SETTER)), TuplesKt.m14544to("TYPE_USE", EnumSet.of(KotlinTarget.TYPE)));
