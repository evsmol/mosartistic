...
public final class LazyJavaPackageFragment extends PackageFragmentDescriptorImpl {
    ...
    /* renamed from: c */
    public final LazyJavaResolverContext f12935c;
    /* access modifiers changed from: private */
    public final JavaPackage jPackage;
    private final NotNullLazyValue partToFacade$delegate;
    private final JvmPackageScope scope = new JvmPackageScope(this.f12935c, this.jPackage, this);
    private final NotNullLazyValue<List<FqName>> subPackages = this.f12935c.getStorageManager().createRecursionTolerantLazyValue(new LazyJavaPackageFragment$subPackages$1(this), CollectionsKt.emptyList());
    ...
    public LazyJavaPackageFragment(LazyJavaResolverContext lazyJavaResolverContext, JavaPackage javaPackage) {
        ...
        this.f12935c = childForClassOrPackage$default;
        ...
        if (this.f12935c.getComponents().getJavaTypeEnhancementState().getDisabledDefaultAnnotations()) {
            annotations2 = Annotations.Companion.getEMPTY();
        } else {
            annotations2 = LazyJavaAnnotationsKt.resolveAnnotations(this.f12935c, this.jPackage);
        }
        this.annotations = annotations2;
        this.partToFacade$delegate = this.f12935c.getStorageManager().createLazyValue(new LazyJavaPackageFragment$partToFacade$2(this));
    }
    ...
    public String toString() {
        return "Lazy Java package fragment: " + getFqName() + " of module " + this.f12935c.getComponents().getModule();
    }
