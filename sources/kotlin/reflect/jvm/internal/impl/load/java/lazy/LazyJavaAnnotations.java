...
public final class LazyJavaAnnotations implements Annotations {
    ...
    /* renamed from: c */
    public final LazyJavaResolverContext f12927c;
    ...
    public LazyJavaAnnotations(LazyJavaResolverContext lazyJavaResolverContext, JavaAnnotationOwner javaAnnotationOwner, boolean z) {
        ...
        this.f12927c = lazyJavaResolverContext;
    ...
    public AnnotationDescriptor findAnnotation(FqName fqName) {
        ...
        return annotationDescriptor == null ? JavaAnnotationMapper.INSTANCE.findMappedJavaAnnotation(fqName, this.annotationOwner, this.f12927c) : annotationDescriptor;
    }

    public Iterator<AnnotationDescriptor> iterator() {
        return SequencesKt.filterNotNull(SequencesKt.plus(SequencesKt.map(CollectionsKt.asSequence(this.annotationOwner.getAnnotations()), this.annotationDescriptors), JavaAnnotationMapper.INSTANCE.findMappedJavaAnnotation(StandardNames.FqNames.deprecated, this.annotationOwner, this.f12927c))).iterator();
    }
