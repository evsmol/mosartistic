...
public final class LazyJavaTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    ...
    /* renamed from: c */
    private final LazyJavaResolverContext f12939c;
    ...
    private final List<KotlinType> computeNotEnhancedBounds() {
        ...
        if (upperBounds.isEmpty()) {
            SimpleType anyType = this.f12939c.getModule().getBuiltIns().getAnyType();
            Intrinsics.checkNotNullExpressionValue(anyType, "c.module.builtIns.anyType");
            SimpleType nullableAnyType = this.f12939c.getModule().getBuiltIns().getNullableAnyType();
        ...
        for (JavaClassifierType transformJavaType : iterable) {
            arrayList.add(this.f12939c.getTypeResolver().transformJavaType(transformJavaType, JavaTypeResolverKt.toAttributes$default(TypeUsage.COMMON, false, this, 1, (Object) null)));
        }
    ...
    public List<KotlinType> processBoundsWithoutCycles(List<? extends KotlinType> list) {
        ...
        return this.f12939c.getComponents().getSignatureEnhancement().enhanceTypeParameterBounds(this, list, this.f12939c);
    }
}
