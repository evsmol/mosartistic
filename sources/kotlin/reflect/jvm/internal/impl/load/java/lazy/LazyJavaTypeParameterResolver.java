...
public final class LazyJavaTypeParameterResolver implements TypeParameterResolver {
    ...
    /* renamed from: c */
    public final LazyJavaResolverContext f12929c;
    /* access modifiers changed from: private */
    public final DeclarationDescriptor containingDeclaration;
    private final MemoizedFunctionToNullable<JavaTypeParameter, LazyJavaTypeParameterDescriptor> resolve = this.f12929c.getStorageManager().createMemoizedFunctionWithNullableValues(new LazyJavaTypeParameterResolver$resolve$1(this));
    /* access modifiers changed from: private */
    ...
    public LazyJavaTypeParameterResolver(LazyJavaResolverContext lazyJavaResolverContext, DeclarationDescriptor declarationDescriptor, JavaTypeParameterListOwner javaTypeParameterListOwner, int i) {
        ...
        this.f12929c = lazyJavaResolverContext;
    ...
    public TypeParameterDescriptor resolveTypeParameter(JavaTypeParameter javaTypeParameter) {
        ...
        return invoke == null ? this.f12929c.getTypeParameterResolver().resolveTypeParameter(javaTypeParameter) : invoke;
    }
}
