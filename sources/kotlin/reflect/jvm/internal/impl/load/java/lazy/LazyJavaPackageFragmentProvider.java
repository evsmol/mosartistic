...
public final class LazyJavaPackageFragmentProvider implements PackageFragmentProviderOptimized {
    ...
    /* renamed from: c */
    public final LazyJavaResolverContext f12928c;
    ...
    public LazyJavaPackageFragmentProvider(JavaResolverComponents javaResolverComponents) {
        ...
        this.f12928c = lazyJavaResolverContext;
    ...
    private final LazyJavaPackageFragment getPackageFragment(FqName fqName) {
        JavaPackage findPackage = this.f12928c.getComponents().getFinder().findPackage(fqName);
        if (findPackage == null) {
            return null;
        }
    ...
    public boolean isEmpty(FqName fqName) {
        Intrinsics.checkNotNullParameter(fqName, "fqName");
        return this.f12928c.getComponents().getFinder().findPackage(fqName) == null;
    }
    ...
    public String toString() {
        return Intrinsics.stringPlus("LazyJavaPackageFragmentProvider of module ", this.f12928c.getComponents().getModule());
    }
}
