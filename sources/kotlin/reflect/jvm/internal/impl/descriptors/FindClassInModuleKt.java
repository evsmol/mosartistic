...
public final class FindClassInModuleKt {
    ...
    public static final ClassDescriptor findNonGenericClassAcrossDependencies(ModuleDescriptor moduleDescriptor, ClassId classId, NotFoundClasses notFoundClasses) {
        ...
        return notFoundClasses.getClass(classId, SequencesKt.toList(SequencesKt.map(SequencesKt.generateSequence(classId, C5417x24bfe126.INSTANCE), C5418x24bfe127.INSTANCE)));
    }
        ...
        if (resolutionAnchorIfAny == null) {
            ...
            if (contributedClassifier2 != null) {
                ...
                while (true) {
                    ...
                    Intrinsics.checkNotNullExpressionValue(next2, AppMeasurementSdk.ConditionalUserProperty.NAME);
            ...
            for (Name next3 : pathSegments3.subList(1, pathSegments3.size())) {
                ...
                Intrinsics.checkNotNullExpressionValue(next3, AppMeasurementSdk.ConditionalUserProperty.NAME);
