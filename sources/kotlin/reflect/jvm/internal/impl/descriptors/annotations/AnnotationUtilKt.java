...
public final class AnnotationUtilKt {
    ...
    public static final AnnotationDescriptor createDeprecatedAnnotation(KotlinBuiltIns kotlinBuiltIns, String str, String str2, String str3) {
        ...
        BuiltInAnnotationDescriptor builtInAnnotationDescriptor = new BuiltInAnnotationDescriptor(kotlinBuiltIns, StandardNames.FqNames.replaceWith, MapsKt.mapOf(TuplesKt.m14544to(REPLACE_WITH_EXPRESSION_NAME, new StringValue(str2)), TuplesKt.m14544to(REPLACE_WITH_IMPORTS_NAME, new ArrayValue(CollectionsKt.emptyList(), new C5424xf14e0c1a(kotlinBuiltIns)))));
        ...
        return new BuiltInAnnotationDescriptor(kotlinBuiltIns, fqName, MapsKt.mapOf(TuplesKt.m14544to(DEPRECATED_MESSAGE_NAME, new StringValue(str)), TuplesKt.m14544to(DEPRECATED_REPLACE_WITH_NAME, new AnnotationValue(builtInAnnotationDescriptor)), TuplesKt.m14544to(name, new EnumValue(classId, identifier))));
    }
