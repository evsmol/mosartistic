...
public enum KotlinTarget {
    ...
    static {
        ...
        USE_SITE_MAPPING = MapsKt.mapOf(TuplesKt.m14544to(AnnotationUseSiteTarget.CONSTRUCTOR_PARAMETER, VALUE_PARAMETER), TuplesKt.m14544to(AnnotationUseSiteTarget.FIELD, FIELD), TuplesKt.m14544to(AnnotationUseSiteTarget.PROPERTY, PROPERTY), TuplesKt.m14544to(AnnotationUseSiteTarget.FILE, FILE), TuplesKt.m14544to(AnnotationUseSiteTarget.PROPERTY_GETTER, PROPERTY_GETTER), TuplesKt.m14544to(AnnotationUseSiteTarget.PROPERTY_SETTER, PROPERTY_SETTER), TuplesKt.m14544to(AnnotationUseSiteTarget.RECEIVER, VALUE_PARAMETER), TuplesKt.m14544to(AnnotationUseSiteTarget.SETTER_PARAMETER, VALUE_PARAMETER), TuplesKt.m14544to(AnnotationUseSiteTarget.PROPERTY_DELEGATE_FIELD, FIELD));
    }
