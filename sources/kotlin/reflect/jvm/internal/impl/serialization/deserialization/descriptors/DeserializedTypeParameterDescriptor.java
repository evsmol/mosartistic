...
public final class DeserializedTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    ...
    /* renamed from: c */
    public final DeserializationContext f12956c;
    ...
    public List<KotlinType> resolveUpperBounds() {
        List<ProtoBuf.Type> upperBounds = ProtoTypeTableUtilKt.upperBounds(this.proto, this.f12956c.getTypeTable());
        ...
        TypeDeserializer typeDeserializer = this.f12956c.getTypeDeserializer();
