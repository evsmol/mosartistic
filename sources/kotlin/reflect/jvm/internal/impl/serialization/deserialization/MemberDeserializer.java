...
public final class MemberDeserializer {
    ...
    /* renamed from: c */
    public final DeserializationContext f12951c;
    ...
    public MemberDeserializer(DeserializationContext deserializationContext) {
        ...
        this.f12951c = deserializationContext;
        this.annotationDeserializer = new AnnotationDeserializer(deserializationContext.getComponents().getModuleDescriptor(), this.f12951c.getComponents().getNotFoundClasses());
    }
    ...
    public final PropertyDescriptor loadProperty(ProtoBuf.Property property) {
        ...
        DeclarationDescriptor containingDeclaration = this.f12951c.getContainingDeclaration();
        ...
        Name name = NameResolverUtilKt.getName(this.f12951c.getNameResolver(), property.getName());
        ...
        DeserializedPropertyDescriptor deserializedPropertyDescriptor2 = new DeserializedPropertyDescriptor(containingDeclaration, (PropertyDescriptor) null, annotations2, modality, descriptorVisibility, booleanValue, name, memberKind, booleanValue2, booleanValue3, booleanValue4, booleanValue5, bool6.booleanValue(), property, this.f12951c.getNameResolver(), this.f12951c.getTypeTable(), this.f12951c.getVersionRequirementTable(), this.f12951c.getContainerSource());
        DeserializationContext deserializationContext = this.f12951c;
        ...
        KotlinType type = childContext$default.getTypeDeserializer().type(ProtoTypeTableUtilKt.returnType(property4, this.f12951c.getTypeTable()));
        ...
        ProtoBuf.Type receiverType = ProtoTypeTableUtilKt.receiverType(property4, this.f12951c.getTypeTable());
        ...
        if (bool16.booleanValue()) {
            deserializedPropertyDescriptor3.setCompileTimeInitializer(this.f12951c.getStorageManager().createNullableLazyValue(new MemberDeserializer$loadProperty$3(this, property4, deserializedPropertyDescriptor3)));
        }
    ...
    public final SimpleFunctionDescriptor loadFunction(ProtoBuf.Function function) {
        ...
        if (Intrinsics.areEqual((Object) DescriptorUtilsKt.getFqNameSafe(this.f12951c.getContainingDeclaration()).child(NameResolverUtilKt.getName(this.f12951c.getNameResolver(), function.getName())), (Object) SuspendFunctionTypeUtilKt.KOTLIN_SUSPEND_BUILT_IN_FUNCTION_FQ_NAME)) {
            versionRequirementTable = VersionRequirementTable.Companion.getEMPTY();
        } else {
            versionRequirementTable = this.f12951c.getVersionRequirementTable();
        }
        DeserializedSimpleFunctionDescriptor deserializedSimpleFunctionDescriptor = new DeserializedSimpleFunctionDescriptor(this.f12951c.getContainingDeclaration(), (SimpleFunctionDescriptor) null, annotations2, NameResolverUtilKt.getName(this.f12951c.getNameResolver(), function.getName()), ProtoEnumFlagsUtilsKt.memberKind(ProtoEnumFlags.INSTANCE, Flags.MEMBER_KIND.get(flags)), function, this.f12951c.getNameResolver(), this.f12951c.getTypeTable(), versionRequirementTable, this.f12951c.getContainerSource(), (SourceElement) null, 1024, (DefaultConstructorMarker) null);
        DeserializationContext deserializationContext = this.f12951c;
        ...
        ProtoBuf.Type receiverType = ProtoTypeTableUtilKt.receiverType(function2, this.f12951c.getTypeTable());
        if (receiverType == null) {
            receiverParameterDescriptor = null;
        } else {
        ...
        KotlinType type = childContext$default.getTypeDeserializer().type(ProtoTypeTableUtilKt.returnType(function2, this.f12951c.getTypeTable()));
        ...
        Pair<CallableDescriptor.UserDataKey<?>, Object> deserializeContractFromFunction = this.f12951c.getComponents().getContractDeserializer().deserializeContractFromFunction(function2, deserializedSimpleFunctionDescriptor2, this.f12951c.getTypeTable(), childContext$default.getTypeDeserializer());
    ...
    public final TypeAliasDescriptor loadTypeAlias(ProtoBuf.TypeAlias typeAlias) {
        ...
        for (ProtoBuf.Annotation annotation : iterable) {
            ...
            arrayList.add(annotationDeserializer2.deserializeAnnotation(annotation, this.f12951c.getNameResolver()));
        }
        DeserializedTypeAliasDescriptor deserializedTypeAliasDescriptor = new DeserializedTypeAliasDescriptor(this.f12951c.getStorageManager(), this.f12951c.getContainingDeclaration(), companion.create((List) arrayList), NameResolverUtilKt.getName(this.f12951c.getNameResolver(), typeAlias.getName()), ProtoEnumFlagsUtilsKt.descriptorVisibility(ProtoEnumFlags.INSTANCE, Flags.VISIBILITY.get(typeAlias.getFlags())), typeAlias, this.f12951c.getNameResolver(), this.f12951c.getTypeTable(), this.f12951c.getVersionRequirementTable(), this.f12951c.getContainerSource());
        List<ProtoBuf.TypeParameter> typeParameterList = typeAlias.getTypeParameterList();
        Intrinsics.checkNotNullExpressionValue(typeParameterList, "proto.typeParameterList");
        DeserializationContext childContext$default = DeserializationContext.childContext$default(this.f12951c, deserializedTypeAliasDescriptor, typeParameterList, (NameResolver) null, (TypeTable) null, (VersionRequirementTable) null, (BinaryVersion) null, 60, (Object) null);
        deserializedTypeAliasDescriptor.initialize(childContext$default.getTypeDeserializer().getOwnTypeParameters(), childContext$default.getTypeDeserializer().simpleType(ProtoTypeTableUtilKt.underlyingType(typeAlias2, this.f12951c.getTypeTable()), false), childContext$default.getTypeDeserializer().simpleType(ProtoTypeTableUtilKt.expandedType(typeAlias2, this.f12951c.getTypeTable()), false));
    ...
    public final ClassConstructorDescriptor loadConstructor(ProtoBuf.Constructor constructor, boolean z) {
        ...
        ClassDescriptor classDescriptor = (ClassDescriptor) this.f12951c.getContainingDeclaration();
        MessageLite messageLite = constructor2;
        DeserializedClassConstructorDescriptor deserializedClassConstructorDescriptor = r1;
        DeserializedClassConstructorDescriptor deserializedClassConstructorDescriptor2 = new DeserializedClassConstructorDescriptor(classDescriptor, (ConstructorDescriptor) null, getAnnotations(messageLite, constructor.getFlags(), AnnotatedCallableKind.FUNCTION), z, CallableMemberDescriptor.Kind.DECLARATION, constructor, this.f12951c.getNameResolver(), this.f12951c.getTypeTable(), this.f12951c.getVersionRequirementTable(), this.f12951c.getContainerSource(), (SourceElement) null, 1024, (DefaultConstructorMarker) null);
        MemberDeserializer memberDeserializer = DeserializationContext.childContext$default(this.f12951c, deserializedClassConstructorDescriptor, CollectionsKt.emptyList(), (NameResolver) null, (TypeTable) null, (VersionRequirementTable) null, (BinaryVersion) null, 60, (Object) null).getMemberDeserializer();
    ...
    private final Annotations getAnnotations(MessageLite messageLite, int i, AnnotatedCallableKind annotatedCallableKind) {
        ...
        return new NonEmptyDeserializedAnnotations(this.f12951c.getStorageManager(), new MemberDeserializer$getAnnotations$1(this, messageLite, annotatedCallableKind));
    }
    ...
    private final Annotations getPropertyFieldAnnotations(ProtoBuf.Property property, boolean z) {
        ...
        return new NonEmptyDeserializedAnnotations(this.f12951c.getStorageManager(), new MemberDeserializer$getPropertyFieldAnnotations$1(this, z, property));
    }
    ...
    private final Annotations getReceiverParameterAnnotations(MessageLite messageLite, AnnotatedCallableKind annotatedCallableKind) {
        return new DeserializedAnnotations(this.f12951c.getStorageManager(), new MemberDeserializer$getReceiverParameterAnnotations$1(this, messageLite, annotatedCallableKind));
    }
    ...
    private final java.util.List<kotlin.reflect.jvm.internal.impl.descriptors.ValueParameterDescriptor> valueParameters(java.util.List<kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf.ValueParameter> r26, kotlin.reflect.jvm.internal.impl.protobuf.MessageLite r27, kotlin.reflect.jvm.internal.impl.serialization.deserialization.AnnotatedCallableKind r28) {
        /*
            r25 = this;
            r7 = r25
            kotlin.reflect.jvm.internal.impl.serialization.deserialization.DeserializationContext r0 = r7.f12951c
        ...
        L_0x008e:
            ...
            kotlin.reflect.jvm.internal.impl.serialization.deserialization.DeserializationContext r1 = r7.f12951c
            ...
            goto L_0x00f6
        L_0x00ec:
            kotlin.reflect.jvm.internal.impl.serialization.deserialization.DeserializationContext r2 = r7.f12951c
    ...
    public final ProtoContainer asProtoContainer(DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor instanceof PackageFragmentDescriptor) {
            return new ProtoContainer.Package(((PackageFragmentDescriptor) declarationDescriptor).getFqName(), this.f12951c.getNameResolver(), this.f12951c.getTypeTable(), this.f12951c.getContainerSource());
        }
