...
public final class TypeDeserializer {
    ...
    /* renamed from: c */
    public final DeserializationContext f12953c;
    private final Function1<Integer, ClassifierDescriptor> classifierDescriptors;
    private final String containerPresentableName;
    private final String debugName;
    private final TypeDeserializer parent;
    private final Function1<Integer, ClassifierDescriptor> typeAliasDescriptors = this.f12953c.getStorageManager().createMemoizedFunctionWithNullableValues(new TypeDeserializer$typeAliasDescriptors$1(this));
    ...
    public TypeDeserializer(DeserializationContext deserializationContext, TypeDeserializer typeDeserializer, List<ProtoBuf.TypeParameter> list, String str, String str2) {
        ...
        this.f12953c = deserializationContext;
        ...
        if (list.isEmpty()) {
            ...
            for (ProtoBuf.TypeParameter next : list) {
                linkedHashMap.put(Integer.valueOf(next.getId()), new DeserializedTypeParameterDescriptor(this.f12953c, next, i));
                i++;
            }
            map = linkedHashMap;
        }
    ...
    public final KotlinType type(ProtoBuf.Type type) {
        ...
        String string = this.f12953c.getNameResolver().getString(type.getFlexibleTypeCapabilitiesId());
        SimpleType simpleType$default = simpleType$default(this, type, false, 2, (Object) null);
        ProtoBuf.Type flexibleUpperBound = ProtoTypeTableUtilKt.flexibleUpperBound(type, this.f12953c.getTypeTable());
        Intrinsics.checkNotNull(flexibleUpperBound);
        return this.f12953c.getComponents().getFlexibleTypeDeserializer().create(type, string, simpleType$default, simpleType$default(this, flexibleUpperBound, false, 2, (Object) null));
    }
    ...
    public final SimpleType simpleType(ProtoBuf.Type type, boolean z) {
        ...
        DeserializedAnnotations deserializedAnnotations = new DeserializedAnnotations(this.f12953c.getStorageManager(), new TypeDeserializer$simpleType$annotations$1(this, type));
        ...
        ProtoBuf.Type abbreviatedType = ProtoTypeTableUtilKt.abbreviatedType(type, this.f12953c.getTypeTable());
        ...
        return this.f12953c.getComponents().getPlatformDependentTypeTransformer().transformPlatformType(NameResolverUtilKt.getClassId(this.f12953c.getNameResolver(), type.getClassName()), simpleType2);
    }
    ...
    private static final List<ProtoBuf.Type.Argument> simpleType$collectAllArguments(ProtoBuf.Type type, TypeDeserializer typeDeserializer) {
        ...
        ProtoBuf.Type outerType = ProtoTypeTableUtilKt.outerType(type, typeDeserializer.f12953c.getTypeTable());
    ...
    private static final ClassDescriptor typeConstructor$notFoundClass(TypeDeserializer typeDeserializer, ProtoBuf.Type type, int i) {
        ClassId classId = NameResolverUtilKt.getClassId(typeDeserializer.f12953c.getNameResolver(), i);
        List mutableList = SequencesKt.toMutableList(SequencesKt.map(SequencesKt.generateSequence(type, new C5582x131ab842(typeDeserializer)), C5583x131ab843.INSTANCE));
        int count = SequencesKt.count(SequencesKt.generateSequence(classId, C5581x1c22db09.INSTANCE));
        while (mutableList.size() < count) {
            mutableList.add(0);
        }
        return typeDeserializer.f12953c.getComponents().getNotFoundClasses().getClass(classId, mutableList);
    }
    ...
    private final TypeConstructor typeConstructor(ProtoBuf.Type type) {
        ...
        if (type.hasClassName()) {
            ...
            String string = this.f12953c.getNameResolver().getString(type.getTypeParameterName());
            ...
            if (typeParameterDescriptor == null) {
                TypeConstructor createErrorTypeConstructor2 = ErrorUtils.createErrorTypeConstructor("Deserialized type parameter " + string + " in " + this.f12953c.getContainingDeclaration());
    ...
    private final SimpleType transformRuntimeFunctionTypeToSuspendFunction(KotlinType kotlinType) {
        ...
        DeclarationDescriptor containingDeclaration = this.f12953c.getContainingDeclaration();
    ...
    public final ClassifierDescriptor computeClassifierDescriptor(int i) {
        ClassId classId = NameResolverUtilKt.getClassId(this.f12953c.getNameResolver(), i);
        if (classId.isLocal()) {
            return this.f12953c.getComponents().deserializeClass(classId);
        }
        return FindClassInModuleKt.findClassifierAcrossModuleDependencies(this.f12953c.getComponents().getModuleDescriptor(), classId);
    }

    private final SimpleType computeLocalClassifierReplacementType(int i) {
        if (NameResolverUtilKt.getClassId(this.f12953c.getNameResolver(), i).isLocal()) {
            return this.f12953c.getComponents().getLocalClassifierTypeSettings().getReplacementTypeForLocalClassifiers();
        }
        return null;
    }
    ...
    public final ClassifierDescriptor computeTypeAliasDescriptor(int i) {
        ...
        return FindClassInModuleKt.findTypeAliasAcrossModuleDependencies(this.f12953c.getComponents().getModuleDescriptor(), classId);
    }
    ...
    private final TypeProjection typeArgument(TypeParameterDescriptor typeParameterDescriptor, ProtoBuf.Type.Argument argument) {
        if (argument.getProjection() != ProtoBuf.Type.Argument.Projection.STAR) {
            ...
            ProtoBuf.Type type = ProtoTypeTableUtilKt.type(argument, this.f12953c.getTypeTable());
            if (type == null) {
            ...
            return new StarProjectionForAbsentTypeParameter(this.f12953c.getComponents().getModuleDescriptor().getBuiltIns());
        } else {
