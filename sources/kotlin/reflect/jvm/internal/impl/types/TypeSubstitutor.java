...
public class TypeSubstitutor {
        ...
        if (type instanceof TypeWithEnhancement) {
            ...
            if (projectedTypeForConflictedTypeWithUnsafeVariance == null && FlexibleTypesKt.isFlexible(type) && !TypeCapabilitiesKt.isCustomTypeVariable(type)) {
                ...
                if (!CapturedTypeConstructorKt.isCaptured(type)) {
                    int i3 = C56102.f12957x4790888d[conflictType.ordinal()];
                    if (i3 == 1) {
    ...
    static /* synthetic */ class C56102 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f12957x4790888d     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f12957x4790888d     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlin.reflect.jvm.internal.impl.types.TypeSubstitutor.C56102.<clinit>():void");
        }
    }
    ...
    private static Annotations filterOutUnsafeVariance(Annotations annotations) {
        ...
        if (annotations.hasAnnotation(StandardNames.FqNames.unsafeVariance)) {
            return new FilteredAnnotations(annotations, new Function1<FqName, Boolean>() {
                private static /* synthetic */ void $$$reportNull$$$0(int i) {
                    throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", new Object[]{AppMeasurementSdk.ConditionalUserProperty.NAME, "kotlin/reflect/jvm/internal/impl/types/TypeSubstitutor$1", "invoke"}));
                }
    ...
    private List<TypeProjection> substituteTypeArguments(List<TypeParameterDescriptor> list, List<TypeProjection> list2, int i) throws SubstitutionException {
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            ...
            int i3 = C56102.f12957x4790888d[conflictType(typeParameterDescriptor.getVariance(), unsafeSubstitute.getProjectionKind()).ordinal()];
            if (i3 == 1 || i3 == 2) {
