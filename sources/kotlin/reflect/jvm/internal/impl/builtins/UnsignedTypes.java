...
public final class UnsignedTypes {
    ...
    private static final HashMap<UnsignedArrayType, Name> unsignedArrayTypeToArrayCall = MapsKt.hashMapOf(TuplesKt.m14544to(UnsignedArrayType.UBYTEARRAY, Name.identifier("ubyteArrayOf")), TuplesKt.m14544to(UnsignedArrayType.USHORTARRAY, Name.identifier("ushortArrayOf")), TuplesKt.m14544to(UnsignedArrayType.UINTARRAY, Name.identifier("uintArrayOf")), TuplesKt.m14544to(UnsignedArrayType.ULONGARRAY, Name.identifier("ulongArrayOf")));
